...
- Expanded the IDE-grade command-surface test to include the base Outline commands, not only project-index/navigation commands.
- Updated docs to remove user-facing duplicate spellings.
- Extended language_validation_check to guard canonical command names and stale docs.
