Pass1432 implements project-scale end-to-end editor integration validation.

Added package:
  Editor.Ada_End_To_End_Editor_Integration_Validation_Pass1432

Added AUnit package:
  Test_Ada_End_To_End_Editor_Integration_Validation_Pass1432
