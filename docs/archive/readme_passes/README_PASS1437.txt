...
This pass performs the first destructive legacy-code removal after the project-scale closure.
...
Core_Suite was updated to remove Test_Ada_Repair_Gated_Diagnostic_Provenance_Pass1151 and to register Test_Ada_Legacy_Code_Removal_Pass1437.
