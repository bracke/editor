# Editor pass705 — Attribute grammar depth

This pass deepens the token-cursor grammar for Ada attribute references while preserving the language-intelligence invariants.
