...
## current-line indentation commands

adds two narrow Edit commands for active-buffer current-line indentation only:

| Stable name | Label | Category | behavior |
| --- | --- | --- | --- |
...
### pass 180 visible-range semantic rebuild
...
### pass 182 completeness: language index lifecycle safety
...
### pass 185 open-buffer project-index priority
...
### pass 186 profile-aware `outline.goto-body` / `outline.goto-spec`
...
### pass 187 profiled callable target safety
...
## pass 188 semantic scope retention
...
### pass 189 semantic scope-range safety
...
### pass 190 scoped semantic bounded-name safety
...
### pass 193 unique indexed navigation targets
...
### pass 196 overflow-safe indexed Outline commands
...
## pass 200 completeness: body/spec command target revalidation
...
### pass 201 declaration navigation availability
...
### pass 202 normalized indexed navigation execution
