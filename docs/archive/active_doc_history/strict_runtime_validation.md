...
# Historical Strict Runtime Validation Notes

This file is retained as historical pass evidence. Current release workflow is
in `docs/release/RELEASE_CHECKLIST.md`.
