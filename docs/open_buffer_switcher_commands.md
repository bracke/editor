...
developer reference for the Open Buffer Switcher command surface. Descriptors remain authoritative; this document is a compact maintenance artifact kept synchronized by tests.
