...
generic sample container. Current feature-panel-backed workflows include Outline,
...
- product commands must route through the Executor instead of mutating render
  rows directly;
- hidden/internal test data must not leak into command palette labels,
...
The release checks guard against reintroducing removed sample feature-panel
