...
Phase 165 freezes the synchronous command-facing diagnostic-line ingestion path.
...
Command surface status: Phase 165 keeps diagnostic-line ingestion helper-owned.
