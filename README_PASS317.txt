...
It also adds structured declaration child nodes for subprogram profiles and function result subtypes so subprogram-family declarations now expose name/profile/result/mode metadata in the syntax tree.  The phase579 language validation guard and AUnit declaration-grammar coverage were extended accordingly.
