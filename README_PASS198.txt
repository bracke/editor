Phase 579 pass 198 — documentation/validation consistency completeness pass
...
- Extended tools/phase579_language_validation_check.adb to reject stale local-only/safe-skip documentation wording.
