Editor phase 579 IDE-grade Outline / semantic-colouring language-model pass 197
...
Changes
- Added tools/phase579_language_validation_check.adb.
...
- Strict mode: EDITOR_REQUIRE_PHASE579_LANGUAGE_VALIDATION=1 requires gprbuild, builds tests/tests.gpr, and runs tests/bin/tests.
