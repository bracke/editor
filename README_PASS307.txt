Phase 579 pass 307 — compact embedded control-flow statement nodes
...
- Extended `phase579_language_validation_check` to guard the compact embedded control-flow node conversion and its test coverage.
