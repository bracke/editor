...
package body Test_Ada_Array_Container_Indexing_Vertical_Slice_Legality_Pass1312 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Array_Container_Indexing_Vertical_Slice_Legality_Pass1312");
   end Name;
   ...
   begin
      ...
      Assert (AI.Count_Status (Results, AI.Legality_Limited_View_Barrier) = 1,
...
end Test_Ada_Array_Container_Indexing_Vertical_Slice_Legality_Pass1312;
