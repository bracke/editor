...
with Editor.Ada_Legality.Representation.Interfacing_Import_Export_Legality;

package body Test_Ada_Legality.Representation.Interfacing_Import_Export_Legality is

   package IEL renames Editor.Ada_Legality.Representation.Interfacing_Import_Export_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Representation.Interfacing_Import_Export_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Interfacing_Import_Export_Legality;
