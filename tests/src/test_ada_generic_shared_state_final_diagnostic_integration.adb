...
package body Test_Ada_Generic_Shared_State_Final_Diagnostic_Integration is
   ...
   package I renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Diagnostics;
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final diagnostic integration");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Diagnostic_Integration;
