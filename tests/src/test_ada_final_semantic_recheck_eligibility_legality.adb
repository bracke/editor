...
package body Test_Ada_Final_Semantic_Recheck_Eligibility_Legality is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Recheck_Eligibility_Legality");
   end Name;
...
end Test_Ada_Final_Semantic_Recheck_Eligibility_Legality;
