...
package body Test_Ada_RM_Coverage_Matrix_Audit_Pass1338 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Coverage_Matrix_Audit_Pass1338");
   end Name;
...
end Test_Ada_RM_Coverage_Matrix_Audit_Pass1338;
