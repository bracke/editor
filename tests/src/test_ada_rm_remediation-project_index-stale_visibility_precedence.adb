...
with Editor.Ada_RM_Remediation.Project_Index.Stale_Visibility_Precedence;

package body Test_Ada_RM_Remediation.Project_Index.Stale_Visibility_Precedence is

   package Audit renames Editor.Ada_RM_Remediation.Project_Index.Stale_Visibility_Precedence;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Project_Index.Stale_Visibility_Precedence");
      Row.Candidate_Case := To_Unbounded_String ("Case 1384");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1384 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1384 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1384 should close the project-index/open-buffer duplicate-unit gap");
...
end Test_Ada_RM_Remediation.Project_Index.Stale_Visibility_Precedence;
