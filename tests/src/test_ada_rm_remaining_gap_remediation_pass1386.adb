...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1386;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1386 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1386;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1386");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1386");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1386");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1386 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1386 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1386 should close the cancellation/budget/final-verdict gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1386;
