...
package body Test_Ada_Overload_Generic_Shared_State_RM_Edge_Completion_Legality_Pass1246 is
   ...
   begin
      return AUnit.Format ("Ada overload generic shared-state RM edge completion legality pass1246");
   end Name;
...
end Test_Ada_Overload_Generic_Shared_State_RM_Edge_Completion_Legality_Pass1246;
