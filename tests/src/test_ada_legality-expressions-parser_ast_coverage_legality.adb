...
with Editor.Ada_Legality.Expressions.Parser_AST_Coverage_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Parser_AST_Coverage_Legality is

   package PC renames Editor.Ada_Legality.Expressions.Parser_AST_Coverage_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Parser_AST_Coverage_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Parser_AST_Coverage_Legality;
