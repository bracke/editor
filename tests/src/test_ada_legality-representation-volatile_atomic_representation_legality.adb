...
package body Test_Ada_Legality.Representation.Volatile_Atomic_Representation_Legality is

   package Registration renames AUnit.Test_Cases.Registration;
   package C renames Editor.Ada_Legality.Representation.Volatile_Atomic_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Ada volatile/atomic representation consumer legality");
   end Name;
...
end Test_Ada_Legality.Representation.Volatile_Atomic_Representation_Legality;
