...
package body Test_Ada_Generic_Shared_State_Final_Recheck_Convergence_Legality_Pass1243 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final recheck convergence legality pass1243");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Recheck_Convergence_Legality_Pass1243;
