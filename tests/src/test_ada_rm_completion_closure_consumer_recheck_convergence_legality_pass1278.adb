...
package body Test_Ada_RM_Completion_Closure_Consumer_Recheck_Convergence_Legality_Pass1278 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer recheck convergence pass1278");
   end Name;
...
end Test_Ada_RM_Completion_Closure_Consumer_Recheck_Convergence_Legality_Pass1278;
