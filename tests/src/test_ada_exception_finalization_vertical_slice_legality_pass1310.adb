...
package body Test_Ada_Exception_Finalization_Vertical_Slice_Legality_Pass1310 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Exception_Finalization_Vertical_Slice_Legality_Pass1310");
   end Name;
...
end Test_Ada_Exception_Finalization_Vertical_Slice_Legality_Pass1310;
