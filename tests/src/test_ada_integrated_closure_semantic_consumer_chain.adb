...
package body Test_Ada_Integrated_Closure_Semantic_Consumer_Chain is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_Semantic_Consumer_Chain");
   end Name;
...
end Test_Ada_Integrated_Closure_Semantic_Consumer_Chain;
