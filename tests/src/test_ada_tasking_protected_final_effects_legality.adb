...
package body Test_Ada_Tasking_Protected_Final_Effects_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_Final_Effects_Legality");
   end Name;
   ...
   begin
      ...
      Assert (Final.Elaboration_Error_Count (Model) = 1, "expected one elaboration/object-state blocker");
...
end Test_Ada_Tasking_Protected_Final_Effects_Legality;
