...
package body Test_Ada_Legality.Dataflow.State_Review_Eligibility_Legality is
   ...
   begin
      return AUnit.Format ("Ada shared-state recheck eligibility legality");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert (Recheck.View_Blocked_Count (Model) = 2, "view blockers should remain view-specific");
         Assert (Recheck.Generic_Blocked_Count (Model) = 1, "generic blocker should remain generic-specific");
         Assert (Recheck.State_Visibility_Blocked_Count (Model) = 0,
                 "state visibility blockers are covered by view-specific blockers here");
...
end Test_Ada_Legality.Dataflow.State_Review_Eligibility_Legality;
