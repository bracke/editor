...
with Editor.Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate;

package body Test_Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate is

   package Audit renames Editor.Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate");
      Row.Candidate_Case := To_Unbounded_String ("Case 1368");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1368 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1368 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1368 should close the selected generic aggregate gap");
...
end Test_Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate;
