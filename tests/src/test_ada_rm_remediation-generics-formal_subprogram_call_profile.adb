...
package body Test_Ada_RM_Remediation.Generics.Formal_Subprogram_Call_Profile is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1422 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1422 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1422 should close the generic formal subprogram call gap");
...
end Test_Ada_RM_Remediation.Generics.Formal_Subprogram_Call_Profile;
