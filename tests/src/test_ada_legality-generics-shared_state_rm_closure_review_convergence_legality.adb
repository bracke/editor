...
package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Review_Convergence_Legality is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion recheck convergence");
   end Name;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Review_Convergence_Legality;
