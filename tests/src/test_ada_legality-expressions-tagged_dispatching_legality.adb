...
with Editor.Ada_Legality.Expressions.Tagged_Dispatching_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Tagged_Dispatching_Legality is

   package TD renames Editor.Ada_Legality.Expressions.Tagged_Dispatching_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Tagged_Dispatching_Legality");
   end Name;
   ...
   begin
      ...
      Add_Dispatch (Model, 6, TD.Dispatch_Interface_Implementation,
                    ...
                    Parent_Type_Kind => TD.Type_Interface,
      ...
      Assert
        (TD.Count_Status (Results, TD.Legality_Interface_Not_Implemented) = 1,
...
end Test_Ada_Legality.Expressions.Tagged_Dispatching_Legality;
