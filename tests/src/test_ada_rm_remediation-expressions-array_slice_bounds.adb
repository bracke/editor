...
with Editor.Ada_RM_Remediation.Expressions.Array_Slice_Bounds;

package body Test_Ada_RM_Remediation.Expressions.Array_Slice_Bounds is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Array_Slice_Bounds;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Array_Slice_Bounds");
      Row.Candidate_Case := To_Unbounded_String ("Case 1406");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1406 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1406 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1406 should close the array slice/index constraint gap");
...
end Test_Ada_RM_Remediation.Expressions.Array_Slice_Bounds;
