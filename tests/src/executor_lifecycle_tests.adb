...
with Editor.Executor.Lifecycle_Tests;
with Editor.Fonts.Init;

procedure Executor_Lifecycle_Tests is
   function Suite return Access_Test_Suite is
      Ret : constant Access_Test_Suite := new Test_Suite;
   begin
      Ret.Add_Test (new Editor.Executor.Lifecycle_Tests.Lifecycle_Test_Case);
      return Ret;
   end Suite;
