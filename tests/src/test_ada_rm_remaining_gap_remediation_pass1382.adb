...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1382 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1382");
   end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1382;
