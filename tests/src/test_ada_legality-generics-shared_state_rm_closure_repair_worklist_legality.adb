...
package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Repair_Worklist_Legality is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion remediation worklist");
   end Name;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Repair_Worklist_Legality;
