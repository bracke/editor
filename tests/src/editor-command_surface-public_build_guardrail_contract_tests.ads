...
package Editor.Command_Surface.Public_Build_Guardrail_Contract_Tests is

   type Public_Build_Guardrail_Contract_Test_Case is new AUnit.Test_Cases.Test_Case with null record;
