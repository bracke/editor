...
package body Test_Ada_Ada2022_Expression_Type_Resolution_Vertical_Slice_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Ada2022_Expression_Type_Resolution_Vertical_Slice_Legality");
   end Name;
...
end Test_Ada_Ada2022_Expression_Type_Resolution_Vertical_Slice_Legality;
