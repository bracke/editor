...
with Editor.Ada_Legality.Tasking.Repair_Protected_AST_Repair;
...
package body Test_Ada_Tasking_Protected_AST_Repair_Legality is
   ...
   package Task_AST renames Editor.Ada_Legality.Tasking.Repair_Protected_AST_Repair;
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_AST_Repair_Legality");
   end Name;
