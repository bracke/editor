...
package body Test_Ada_Flow_Refinement_Vertical_Slice_Legality_Pass1334 is
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Flow_Refinement_Vertical_Slice_Legality_Pass1334");
   end Name;
...
end Test_Ada_Flow_Refinement_Vertical_Slice_Legality_Pass1334;
