...
package body Test_Ada_Exception_Finalization_Generic_Shared_State_Final_Legality is
   ...
   begin
      return AUnit.Format ("Ada exception/finalization generic shared-state final legality");
   end Name;
...
end Test_Ada_Exception_Finalization_Generic_Shared_State_Final_Legality;
