...
package body Test_Ada_RM_Remediation.Final_Readiness.Incremental_Snapshot_Invalidation is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1361 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1361 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Final_Readiness.Incremental_Snapshot_Invalidation;
