...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1379 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1379");
   end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1379;
