...
with Editor.Ada_Phase579_End_To_End_Editor_Integration_Validation_Pass1432;

package body Test_Ada_Phase579_End_To_End_Editor_Integration_Validation is
   package Integration renames Editor.Ada_Phase579_End_To_End_Editor_Integration_Validation_Pass1432;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Phase579_End_To_End_Editor_Integration_Validation");
   end Name;
   ...
   begin
      Assert (Feed_Item.Status = Status, "unexpected pass1432 integration status");
      Assert (Feed_Item.Result_Class = Result_Class,
              "unexpected pass1432 integration result class");
...
end Test_Ada_Phase579_End_To_End_Editor_Integration_Validation;
