...
package body Test_Ada_AST_Coverage_Repair_Gate_Application is
   ...
   begin
      return AUnit.Format ("Test_Ada_AST_Coverage_Repair_Gate_Application");
   end Name;
...
end Test_Ada_AST_Coverage_Repair_Gate_Application;
