...
package body Test_Ada_Legality.Accessibility.RM_Closure_Closure_Legality is

   package R renames Editor.Ada_Legality.Accessibility.RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada accessibility RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Accessibility.RM_Closure_Closure_Legality;
