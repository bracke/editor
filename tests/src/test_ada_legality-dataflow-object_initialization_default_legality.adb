...
with Editor.Ada_Legality.Dataflow.Object_Initialization_Default_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Dataflow.Object_Initialization_Default_Legality is

   package OI renames Editor.Ada_Legality.Dataflow.Object_Initialization_Default_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Object_Initialization_Default_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Object_Initialization_Default_Legality;
