...
package body Test_Ada_Generic_Shared_State_RM_Completion_Stabilized_Closure_Legality is
   ...
   package Z renames Editor.Ada_Generic_Shared_State_Remediation.RM_Completion_Closure;
...
end Test_Ada_Generic_Shared_State_RM_Completion_Stabilized_Closure_Legality;
