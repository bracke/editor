...
package body Test_Ada_RM_Remediation.Final_Readiness.Frozen_Remaining_Inventory is
...
end Test_Ada_RM_Remediation.Final_Readiness.Frozen_Remaining_Inventory;
