...
package body Test_Ada_Widened_Legality_Coverage_Gate_Enforcement is
   ...
   begin
      return AUnit.Format ("Test_Ada_Widened_Legality_Coverage_Gate_Enforcement");
   end Name;
...
end Test_Ada_Widened_Legality_Coverage_Gate_Enforcement;
