...
package body Test_Ada_RM_Remediation.Expressions.Decimal_Fixed_Point_Attributes is
...
end Test_Ada_RM_Remediation.Expressions.Decimal_Fixed_Point_Attributes;
