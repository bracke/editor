...
package body Test_Ada_Coverage_Proven_Generic_Shared_State_AST_Repair_Legality_Pass1249 is

   package T renames Editor.Ada_Coverage_Proven_Generic_Shared_State_AST_Repair_Legality;
   ...
   begin
      return AUnit.Format ("Ada coverage-proven generic/shared-state AST repair legality pass1249");
   end Name;
...
end Test_Ada_Coverage_Proven_Generic_Shared_State_AST_Repair_Legality_Pass1249;
