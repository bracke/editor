...
package body Test_Ada_RM_Remediation.Tagged_Types.Classwide_Membership_Conversion is
   ...
   use type Audit.Remediation_Model;
     ...
     begin
        Assert (Item.Status = Status, "unexpected case 1408 status");
        Assert (Audit.Expected_For_Status (Item.Status) = Expected,
                "unexpected case 1408 precision classification");
     end Expect_Status;
     ...
     begin
        ...
        Assert (Audit.Gap_Remediated (Results), "case 1408 should close the class-wide membership dispatching gap");
...
end Test_Ada_RM_Remediation.Tagged_Types.Classwide_Membership_Conversion;
