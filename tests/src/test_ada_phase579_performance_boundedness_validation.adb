...
package body Test_Ada_Phase579_Performance_Boundedness_Validation is
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Performance_Boundedness_Validation");
   end Name;
...
end Test_Ada_Phase579_Performance_Boundedness_Validation;
