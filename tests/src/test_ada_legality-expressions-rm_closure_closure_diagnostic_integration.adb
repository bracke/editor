...
package body Test_Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration is
   ...
   package D renames Editor.Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration;
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer diagnostic integration");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration;
