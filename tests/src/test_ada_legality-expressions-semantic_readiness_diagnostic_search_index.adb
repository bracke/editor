...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index");
   end Name;
   ...
   begin
      ...
      Assert (Final_Index.Stale_Rejected_Count (Model) = 2,
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index;
