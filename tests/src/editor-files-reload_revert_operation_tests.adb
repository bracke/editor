...
package body Editor.Files.Reload_Revert_Operation_Tests is
   ...
   begin
      ...
      S.Buffer_Lifecycle.Reopen_Candidate_Path := To_Unbounded_String (Editor.Test_Temp.Path ("unrelated-reopen.txt"));
      ...
      Assert (S.Buffer_Lifecycle.Has_Reopen_Candidate
        and then To_String (S.Buffer_Lifecycle.Reopen_Candidate_Path) = Editor.Test_Temp.Path ("unrelated-reopen.txt"),
