...
package body Test_Ada_Representation_Operational_AST_Repair_Legality_Pass1176 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Representation_Operational_AST_Repair_Legality_Pass1176");
   end Name;
...
end Test_Ada_Representation_Operational_AST_Repair_Legality_Pass1176;
