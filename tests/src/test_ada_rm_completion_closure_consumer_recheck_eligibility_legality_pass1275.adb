...
package body Test_Ada_RM_Completion_Closure_Consumer_Recheck_Eligibility_Legality_Pass1275 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer recheck eligibility pass1275");
   end Name;
...
end Test_Ada_RM_Completion_Closure_Consumer_Recheck_Eligibility_Legality_Pass1275;
