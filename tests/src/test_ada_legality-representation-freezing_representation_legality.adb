...
with Editor.Ada_Legality.Representation.Freezing_Representation_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Representation.Freezing_Representation_Legality is

   package FRL renames Editor.Ada_Legality.Representation.Freezing_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Freezing_Representation_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Freezing_Representation_Legality;
