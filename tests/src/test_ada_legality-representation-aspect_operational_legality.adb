...
with Editor.Ada_Legality.Representation.Aspect_Operational_Legality;

package body Test_Ada_Legality.Representation.Aspect_Operational_Legality is

   package RA renames Editor.Ada_Legality.Representation.Aspect_Operational_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Aspect_Operational_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Aspect_Operational_Legality;
