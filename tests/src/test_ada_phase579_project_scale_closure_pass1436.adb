...
with Editor.Ada_Phase579_Project_Scale_Closure_Pass1436;

package body Test_Ada_Phase579_Project_Scale_Closure_Pass1436 is
   package Close renames Editor.Ada_Phase579_Project_Scale_Closure_Pass1436;
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Project_Scale_Closure_Pass1436");
   end Name;
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1436 closure status");
      Assert (Item.Result_Class = Result_Class,
              "unexpected pass1436 closure result class");
   ...
   begin
      Close.Add_Row (Input, Base_Row
        (1, Close.Area_Release_Readiness,
         "release readiness validation pass1431 closed"));
      Close.Add_Row (Input, Base_Row
        (2, Close.Area_End_To_End_Integration,
         "end-to-end editor integration validation pass1432 closed"));
      Close.Add_Row (Input, Base_Row
        (3, Close.Area_Real_Ada_Corpus,
         "real Ada corpus validation pass1430 closed"));
      Close.Add_Row (Input, Base_Row
        (4, Close.Area_Performance_Boundedness,
         "performance and boundedness validation pass1434 closed"));
      Close.Add_Row (Input, Base_Row
        (5, Close.Area_Diagnostic_Quality,
         "diagnostic quality validation pass1435 closed"));
      Close.Add_Row (Input, Base_Row
        (6, Close.Area_Architecture_Cleanup,
         "architecture cleanup pass1429 closed"));
      Close.Add_Row (Input, Base_Row
        (7, Close.Area_Documentation_Handoff,
         "documentation and handoff pass1433 closed"));
   ...
   begin
      ...
      Assert (Close.Phase579_Project_Scale_Closed (Model),
              "Phase 579 project-scale closure should be complete");
   ...
   begin
      Row := Base_Row (20, Close.Area_Architecture_Cleanup,
                       "reopens Remaining_* gap after pass1428");
      ...
      Assert (not Close.Phase579_Project_Scale_Closed (Model),
   ...
   begin
      Register_Routine (T, Test_Project_Scale_Closure_Accepts_Frozen_Seven_Items'Access,
                        "pass1436 accepts the frozen seven project-scale validation items");
      Register_Routine (T, Test_Project_Item_Test_Documentation_And_Consumer_Rejections'Access,
                        "pass1436 rejects project item, test, documentation, and consumer defects");
      Register_Routine (T, Test_Reopened_Gap_And_Speculative_Work_Rejections'Access,
                        "pass1436 rejects reopened gaps and speculative work without evidence");
      Register_Routine (T, Test_Stale_And_Missing_Closure_Evidence'Access,
                        "pass1436 rejects stale or missing closure evidence");
   end Register_Tests;

end Test_Ada_Phase579_Project_Scale_Closure_Pass1436;
