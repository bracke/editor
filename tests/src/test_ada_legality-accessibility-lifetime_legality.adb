...
package body Test_Ada_Legality.Accessibility.Lifetime_Legality is

   package AL renames Editor.Ada_Legality.Accessibility.Repair.Lifetime;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Accessibility.Lifetime_Legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Lifetime_Legality;
