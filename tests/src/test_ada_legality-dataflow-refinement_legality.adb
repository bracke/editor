...
with Editor.Ada_Legality.Dataflow.Refinement_Legality;

package body Test_Ada_Legality.Dataflow.Refinement_Legality is

   package FRL renames Editor.Ada_Legality.Dataflow.Refinement_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Dataflow.Refinement_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Refinement_Legality;
