...
package body Test_Ada_Selected_Name_Attribute_Vertical_Slice_Legality_Pass1316 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Selected_Name_Attribute_Vertical_Slice_Legality_Pass1316");
   end Name;
...
end Test_Ada_Selected_Name_Attribute_Vertical_Slice_Legality_Pass1316;
