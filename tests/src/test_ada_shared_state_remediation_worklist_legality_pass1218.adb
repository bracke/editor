...
package body Test_Ada_Shared_State_Remediation_Worklist_Legality_Pass1218 is
   ...
   begin
      return AUnit.Format ("Ada shared-state remediation worklist legality pass1218");
   end Name;
...
end Test_Ada_Shared_State_Remediation_Worklist_Legality_Pass1218;
