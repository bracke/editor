...
package body Test_Ada_Representation_Tasking_Elaboration_Flow_Consumer_Legality_Pass1159 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Representation_Tasking_Elaboration_Flow_Consumer_Legality_Pass1159");
   end Name;
...
end Test_Ada_Representation_Tasking_Elaboration_Flow_Consumer_Legality_Pass1159;
