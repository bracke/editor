...
package body Test_Ada_RM_Completion_Closure_Consumer_Stabilization_Gate_Legality_Pass1279 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer stabilization gate pass1279");
   end Name;
...
end Test_Ada_RM_Completion_Closure_Consumer_Stabilization_Gate_Legality_Pass1279;
