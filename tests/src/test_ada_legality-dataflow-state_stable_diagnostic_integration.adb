...
package body Test_Ada_Legality.Dataflow.State_Stable_Diagnostic_Integration is
   ...
   package DI renames Editor.Ada_Legality.Dataflow.State_Stable_Diagnostic_Integration;
   ...
   begin
      return AUnit.Format ("Ada shared-state stabilized diagnostic integration");
   end Name;
...
end Test_Ada_Legality.Dataflow.State_Stable_Diagnostic_Integration;
