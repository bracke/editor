...
package body Test_Ada_Generic_Instance_Body_Semantic_Replay_Pass1140 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Instance_Body_Semantic_Replay_Pass1140");
   end Name;
...
end Test_Ada_Generic_Instance_Body_Semantic_Replay_Pass1140;
