...
with Editor.Executor.Navigation_Tests;
with Editor.Fonts.Init;

procedure Executor_Navigation_Tests is
   function Suite return Access_Test_Suite is
      Ret : constant Access_Test_Suite := new Test_Suite;
   begin
      Ret.Add_Test (new Editor.Executor.Navigation_Tests.Navigation_Test_Case);
      return Ret;
   end Suite;
