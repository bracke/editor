...
package body Editor.Recent_Projects.Tests is
   ...
   begin
      ...
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("editor"), "editor", 10);
      ...
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("database"), "database", 20);
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("editor"), "editor2", 30);
   ...
   is
      ...
      Config : constant Editor.Recent_Projects.Recent_Project_Config :=
        (Max_Entries => 2);
   begin
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("a"), "a", 1, Config);
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("b"), "b", 2, Config);
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("c"), "c", 3, Config);
      Assert (Editor.Recent_Projects.Count (List) = 2,
      ...
      Editor.Recent_Projects.Remove (List, Editor.Test_Temp.Path ("c/"));
      Assert (Editor.Recent_Projects.Count (List) = 1,
              "Remove must delete a matching normalized path");
      Editor.Recent_Projects.Remove (List, Editor.Test_Temp.Path ("missing"));
      Assert (Editor.Recent_Projects.Count (List) = 1,
   ...
   begin
      ...
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("editor"), "editor", 123);
      Editor.Recent_Projects.Add_Or_Promote (List, Editor.Test_Temp.Path ("database"), "database", 124);
   ...
   begin
      ...
      Write_Text
        (Malformed,
         ...
         Editor.Test_Temp.Path ("editor|name=editor|opened=44") & ASCII.LF);
   ...
   begin
      ...
      Editor.Recent_Projects.Add_Or_Promote
        (List, Editor.Test_Temp.Path ("editor"), "editor", 213);
      Editor.Recent_Projects.Save_To_File (List, Path, Status);
      Assert (Status = Editor.Recent_Projects.Recent_Project_Ok,
   ...
   begin
      ...
      Editor.Recent_Projects.Add_Or_Promote
        (S.Project_Runtime.Recent_Projects, Editor.Test_Temp.Path ("editor-project"), "editor-", 576);
   ...
   begin
      Remove_If_Exists (Path);
      Editor.Recent_Projects.Add_Or_Promote
        (List, Editor.Test_Temp.Path ("editor-"), "editor-", 559);
      Editor.Recent_Projects.Save_To_File (List, Path, Status);
      Assert (Status = Editor.Recent_Projects.Recent_Project_Ok,
   ...
   begin
      ...
      Editor.Recent_Projects.Add_Or_Promote
        (List, Editor.Test_Temp.Path ("|bad"), "bad", 1);
      Assert (Editor.Recent_Projects.Count (List) = 0,
      ...
      Write_Text
        (Path,
         "editor-recent-projects-version=1" & ASCII.LF &
         "[projects]" & ASCII.LF &
         Editor.Test_Temp.Path ("ok|name=ok|opened=2") & ASCII.LF &
         Editor.Test_Temp.Path ("|bad|name=bad|opened=3") & ASCII.LF);
      Editor.Recent_Projects.Load_From_File (Path, Loaded, Status);
      Assert (Status = Editor.Recent_Projects.Recent_Project_Partial_Load,
   ...
   begin
      Editor.Recent_Projects.Add_Or_Promote
        (List, Editor.Test_Temp.Path ("row"), "row", 559);
      ...
      Assert (Ada.Strings.Fixed.Index (To_String (Label), Editor.Test_Temp.Path ("row")) > 0,
