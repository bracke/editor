...
package body Test_Ada_Object_Flow_Accessibility_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Object_Flow_Accessibility_Consumer_Legality");
   end Name;
...
end Test_Ada_Object_Flow_Accessibility_Consumer_Legality;
