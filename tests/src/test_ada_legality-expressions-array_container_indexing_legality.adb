...
with Editor.Ada_Legality.Expressions.Array_Container_Indexing_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Array_Container_Indexing_Legality is

   package AI renames Editor.Ada_Legality.Expressions.Array_Container_Indexing_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Array_Container_Indexing_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Array_Container_Indexing_Legality;
