...
package body Test_Ada_Final_Semantic_Diagnostic_Search_Index is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Diagnostic_Search_Index");
   end Name;
...
end Test_Ada_Final_Semantic_Diagnostic_Search_Index;
