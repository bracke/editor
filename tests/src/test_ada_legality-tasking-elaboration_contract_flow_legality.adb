...
with AUnit;
with Editor.Ada_Legality.Elaboration.Contract_Flow_Legality;
...
package body Test_Ada_Legality.Tasking.Elaboration_Contract_Flow_Legality is

   package Elab_Contract renames Editor.Ada_Legality.Elaboration.Contract_Flow_Legality;
   ...
   package Task_Elab renames Editor.Ada_Legality.Tasking.Repair_Elaboration_Contract_Flow;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Tasking.Elaboration_Contract_Flow_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Elaboration_Contract_Flow_Legality;
