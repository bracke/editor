...
package body Test_Ada_Generic_Replay_Nested_Cycle_Closure_Legality_Pass1190 is
   ...
   begin
      return Format ("Test_Ada_Generic_Replay_Nested_Cycle_Closure_Legality_Pass1190");
   end Name;
...
end Test_Ada_Generic_Replay_Nested_Cycle_Closure_Legality_Pass1190;
