...
package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Review_Eligibility_Legality is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion recheck eligibility");
   end Name;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Review_Eligibility_Legality;
