...
with Editor.Ada_RM_Remediation.Visibility.Private_Child_Renaming;

package body Test_Ada_RM_Remediation.Visibility.Private_Child_Renaming is

   package Audit renames Editor.Ada_RM_Remediation.Visibility.Private_Child_Renaming;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Visibility.Private_Child_Renaming");
      Row.Candidate_Case := To_Unbounded_String ("Case 1371");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1371 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1371 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1371 should close the selected private-child renaming visibility gap");
...
end Test_Ada_RM_Remediation.Visibility.Private_Child_Renaming;
