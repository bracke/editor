...
package body Test_Ada_Phase579_Diagnostic_Quality_Validation is
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Diagnostic_Quality_Validation");
   end Name;
...
end Test_Ada_Phase579_Diagnostic_Quality_Validation;
