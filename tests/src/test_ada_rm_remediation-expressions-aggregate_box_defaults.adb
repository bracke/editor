...
with Editor.Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults;

package body Test_Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults");
      Row.Candidate_Case := To_Unbounded_String ("Case 1401");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1401 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1401 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1401 should close the aggregate/box/default gap");
...
end Test_Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults;
