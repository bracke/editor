...
package body Test_Ada_Expression_Control_Target_AST_Repair_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Expression_Control_Target_AST_Repair_Legality");
   end Name;
...
end Test_Ada_Expression_Control_Target_AST_Repair_Legality;
