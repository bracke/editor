...
package body Test_Ada_Legality.Expressions.RM_Closure_Closure_Repair_Worklist_Legality is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer remediation worklist");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Closure_Closure_Repair_Worklist_Legality;
