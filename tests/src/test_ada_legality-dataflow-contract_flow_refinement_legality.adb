...
package body Test_Ada_Legality.Dataflow.Contract_Flow_Refinement_Legality is
   ...
   package Flow_Consumers renames Editor.Ada_Legality.Dataflow.Flow_Refinement_Integration_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Contract_Flow_Refinement_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Contract_Flow_Refinement_Legality;
