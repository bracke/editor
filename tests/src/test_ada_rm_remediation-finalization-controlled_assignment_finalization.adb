...
package body Test_Ada_RM_Remediation.Finalization.Controlled_Assignment_Finalization is
...
end Test_Ada_RM_Remediation.Finalization.Controlled_Assignment_Finalization;
