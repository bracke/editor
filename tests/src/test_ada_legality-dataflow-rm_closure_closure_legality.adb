...
package body Test_Ada_Legality.Dataflow.RM_Closure_Closure_Legality is

   package R renames Editor.Ada_Legality.Dataflow.RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada dataflow RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Dataflow.RM_Closure_Closure_Legality;
