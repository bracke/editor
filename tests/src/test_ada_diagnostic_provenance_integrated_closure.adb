...
package body Test_Ada_Diagnostic_Provenance_Integrated_Closure is
   ...
   begin
      return AUnit.Format ("Test_Ada_Diagnostic_Provenance_Integrated_Closure");
   end Name;
...
end Test_Ada_Diagnostic_Provenance_Integrated_Closure;
