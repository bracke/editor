...
package body Test_Ada_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1169 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1169");
   end Name;
...
end Test_Ada_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1169;
