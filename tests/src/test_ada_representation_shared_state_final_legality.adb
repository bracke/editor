...
package body Test_Ada_Representation_Shared_State_Final_Legality is
   ...
   begin
      return Format ("Test_Ada_Representation_Shared_State_Final_Legality");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert (R.Shared_State_Error_Count (Model) = 4, "shared-state blockers should be counted");
         Assert
...
end Test_Ada_Representation_Shared_State_Final_Legality;
