...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1400;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1400 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1400;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1400");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1400");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1400");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1400 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1400 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1400 should close the membership/range/predicate gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1400;
