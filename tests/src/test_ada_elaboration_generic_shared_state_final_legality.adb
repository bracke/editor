...
package body Test_Ada_Elaboration_Generic_Shared_State_Final_Legality is
   ...
   begin
      return AUnit.Format ("Ada elaboration generic shared-state final legality");
   end Name;
...
end Test_Ada_Elaboration_Generic_Shared_State_Final_Legality;
