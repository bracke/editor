...
package body Test_Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality is
   ...
   package AC renames Editor.Ada_Legality.Accessibility.Scope_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
