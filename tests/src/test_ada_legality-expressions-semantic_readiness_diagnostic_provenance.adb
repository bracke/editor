...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Provenance is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Provenance");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Provenance;
