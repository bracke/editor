...
package body Test_Ada_Final_Semantic_Remediation_Diagnostic_Integration_Pass1202 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Remediation_Diagnostic_Integration_Pass1202");
   end Name;
...
end Test_Ada_Final_Semantic_Remediation_Diagnostic_Integration_Pass1202;
