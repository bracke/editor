...
package body Test_Ada_Accessibility_Scope_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Accessibility_Scope_Consumer_Legality");
   end Name;
...
end Test_Ada_Accessibility_Scope_Consumer_Legality;
