...
package body Test_Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality is

   package ECP renames Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
   ...
   package CPD renames Editor.Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality");
   end Name;
...
end Test_Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
