...
with Editor.Ada_RM_Remediation.Expressions.Enumeration_Attributes;

package body Test_Ada_RM_Remediation.Expressions.Enumeration_Attributes is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Enumeration_Attributes;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Enumeration_Attributes");
      Row.Candidate_Case := To_Unbounded_String ("Case 1376");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1376 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1376 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1376 should close the selected enumeration attribute gap");
...
end Test_Ada_RM_Remediation.Expressions.Enumeration_Attributes;
