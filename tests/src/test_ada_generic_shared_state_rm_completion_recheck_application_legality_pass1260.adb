...
package body Test_Ada_Generic_Shared_State_RM_Completion_Recheck_Application_Legality_Pass1260 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion recheck application pass1260");
   end Name;
...
end Test_Ada_Generic_Shared_State_RM_Completion_Recheck_Application_Legality_Pass1260;
