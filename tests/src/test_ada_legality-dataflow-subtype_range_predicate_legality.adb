...
with Editor.Ada_Legality.Dataflow.Subtype_Range_Predicate_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Dataflow.Subtype_Range_Predicate_Legality is

   package SR renames Editor.Ada_Legality.Dataflow.Subtype_Range_Predicate_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Subtype_Range_Predicate_Legality");
   end Name;
   ...
   begin
      ...
      Assert
        (SR.Count_Status (Results, SR.Legality_Indeterminate) = 1,
...
end Test_Ada_Legality.Dataflow.Subtype_Range_Predicate_Legality;
