...
package body Test_Ada_Generic_Instance_Body_Semantic_Expansion_Pass1125 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Instance_Body_Semantic_Expansion_Pass1125");
   end Name;
...
end Test_Ada_Generic_Instance_Body_Semantic_Expansion_Pass1125;
