...
package body Test_Ada_Coverage_Proven_Generic_Shared_State_AST_Repair_Legality is
...
end Test_Ada_Coverage_Proven_Generic_Shared_State_AST_Repair_Legality;
