...
package body Test_Ada_AST_Coverage_Repair_Legality_Pass1147 is
   ...
   begin
      return AUnit.Format ("Test_Ada_AST_Coverage_Repair_Legality_Pass1147");
   end Name;
...
end Test_Ada_AST_Coverage_Repair_Legality_Pass1147;
