...
package body Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Consumer_Legality_Pass1284 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge stabilized closure consumer legality pass1284");
   end Name;
   ...
   begin
      ...
      Assert
        (Consumer.Count_By_Status
           (Model, Consumer.Remaining_RM_Edge_Stabilized_Consumer_Accepted_Current) = 1,
         "accepted remaining edge should consume current stabilized closure evidence");
