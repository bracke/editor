...
with Editor.Ada_Legality.Tasking.Iterator_Loop_Parallel_Legality;

package body Test_Ada_Legality.Tasking.Iterator_Loop_Parallel_Legality is

   package ILP renames Editor.Ada_Legality.Tasking.Iterator_Loop_Parallel_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Tasking.Iterator_Loop_Parallel_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Iterator_Loop_Parallel_Legality;
