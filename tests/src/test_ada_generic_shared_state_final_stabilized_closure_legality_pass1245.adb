...
package body Test_Ada_Generic_Shared_State_Final_Stabilized_Closure_Legality_Pass1245 is
   ...
   package Z renames Editor.Ada_Generic_Shared_State_Final_Stabilized_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final stabilized closure legality pass1245");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Stabilized_Closure_Legality_Pass1245;
