...
package body Test_Ada_Predicate_Generic_Shared_State_Final_Legality_Pass1237 is
   ...
   begin
      return AUnit.Format ("Ada predicate generic shared-state final legality pass1237");
   end Name;
...
end Test_Ada_Predicate_Generic_Shared_State_Final_Legality_Pass1237;
