...
package body Test_Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality;
