...
package body Test_Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality is

   package Final renames Editor.Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality;
   ...
   package Tasking renames Editor.Ada_Legality.Tasking.Repair_Protected_Final_Effects;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality;
