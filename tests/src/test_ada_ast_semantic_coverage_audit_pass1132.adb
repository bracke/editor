...
package body Test_Ada_AST_Semantic_Coverage_Audit_Pass1132 is
   ...
   begin
      return AUnit.Format ("Test_Ada_AST_Semantic_Coverage_Audit_Pass1132");
   end Name;
...
end Test_Ada_AST_Semantic_Coverage_Audit_Pass1132;
