...
with Editor.Ada_RM_Remediation.Elaboration.Categorization_Restriction_Policy;

package body Test_Ada_RM_Remediation.Elaboration.Categorization_Restriction_Policy is

   package Audit renames Editor.Ada_RM_Remediation.Elaboration.Categorization_Restriction_Policy;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Elaboration.Categorization_Restriction_Policy");
      Row.Candidate_Case := To_Unbounded_String ("Case 1379");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1379 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1379 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1379 should close the selected policy/allocator gap");
...
end Test_Ada_RM_Remediation.Elaboration.Categorization_Restriction_Policy;
