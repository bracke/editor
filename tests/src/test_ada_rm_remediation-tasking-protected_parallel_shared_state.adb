...
with Editor.Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State;

package body Test_Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State is

   package Audit renames Editor.Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State");
   ...
   begin
      ...
      Assert (Audit.Count (Results) = 4, "balanced case 1348 rows counted");
...
end Test_Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State;
