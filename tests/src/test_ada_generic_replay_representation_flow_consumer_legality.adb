...
package body Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality");
   end Name;
...
end Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality;
