...
with Editor.Ada_Legality.Generics.Body_Replay_Substitution_Legality;

package body Test_Ada_Legality.Generics.Body_Replay_Substitution_Legality is

   package GR renames Editor.Ada_Legality.Generics.Body_Replay_Substitution_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Generics.Body_Replay_Substitution_Legality");
   end Name;
...
end Test_Ada_Legality.Generics.Body_Replay_Substitution_Legality;
