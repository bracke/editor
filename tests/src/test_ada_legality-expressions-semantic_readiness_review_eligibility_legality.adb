...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Eligibility_Legality is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Eligibility_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Eligibility_Legality;
