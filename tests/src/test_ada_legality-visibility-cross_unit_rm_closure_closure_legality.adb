...
package body Test_Ada_Legality.Visibility.Cross_Unit_RM_Closure_Closure_Legality is

   package R renames Editor.Ada_Legality.Visibility.Cross_Unit_RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada cross-unit RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Visibility.Cross_Unit_RM_Closure_Closure_Legality;
