...
with Editor.Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure;

package body Test_Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure is

   package Audit renames Editor.Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure");
...
end Test_Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure;
