...
package body Test_Ada_Exception_Finalization_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Exception_Finalization_Legality");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert (EFL.Raise_Error_Count (Model) = 5,
...
end Test_Ada_Exception_Finalization_Legality;
