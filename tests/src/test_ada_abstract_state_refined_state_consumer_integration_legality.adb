...
package body Test_Ada_Abstract_State_Refined_State_Consumer_Integration_Legality is
...
end Test_Ada_Abstract_State_Refined_State_Consumer_Integration_Legality;
