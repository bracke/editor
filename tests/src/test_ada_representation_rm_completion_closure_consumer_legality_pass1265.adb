...
package body Test_Ada_Representation_RM_Completion_Closure_Consumer_Legality_Pass1265 is
   ...
   begin
      return AUnit.Format ("Ada representation RM-completion closure consumer pass1265");
   end Name;
...
end Test_Ada_Representation_RM_Completion_Closure_Consumer_Legality_Pass1265;
