...
package body Test_Ada_Overload_Shared_State_RM_Edge_Legality_Pass1213 is
   ...
   begin
      return Format ("Test_Ada_Overload_Shared_State_RM_Edge_Legality_Pass1213");
   end Name;
...
end Test_Ada_Overload_Shared_State_RM_Edge_Legality_Pass1213;
