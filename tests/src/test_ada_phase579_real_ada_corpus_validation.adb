...
package body Test_Ada_Phase579_Real_Ada_Corpus_Validation is
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Phase579_Real_Ada_Corpus_Validation");
   end Name;
...
end Test_Ada_Phase579_Real_Ada_Corpus_Validation;
