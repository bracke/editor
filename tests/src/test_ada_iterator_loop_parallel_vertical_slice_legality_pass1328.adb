...
package body Test_Ada_Iterator_Loop_Parallel_Vertical_Slice_Legality_Pass1328 is
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Iterator_Loop_Parallel_Vertical_Slice_Legality_Pass1328");
   end Name;
...
end Test_Ada_Iterator_Loop_Parallel_Vertical_Slice_Legality_Pass1328;
