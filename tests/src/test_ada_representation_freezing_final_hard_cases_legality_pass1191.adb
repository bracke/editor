...
package body Test_Ada_Representation_Freezing_Final_Hard_Cases_Legality_Pass1191 is
   ...
   begin
      return Format ("Test_Ada_Representation_Freezing_Final_Hard_Cases_Legality_Pass1191");
   end Name;
...
end Test_Ada_Representation_Freezing_Final_Hard_Cases_Legality_Pass1191;
