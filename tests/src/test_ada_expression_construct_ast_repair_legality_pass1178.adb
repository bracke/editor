...
package body Test_Ada_Expression_Construct_AST_Repair_Legality_Pass1178 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Expression_Construct_AST_Repair_Legality_Pass1178");
   end Name;
...
end Test_Ada_Expression_Construct_AST_Repair_Legality_Pass1178;
