...
package body Test_Ada_Dataflow_Definite_Initialization_Consumer_Legality_Pass1165 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Dataflow_Definite_Initialization_Consumer_Legality_Pass1165");
   end Name;
   ...
   begin
      ...
      Assert (DIC.Count_Kind (Model, DGL.Dataflow_Context_Subprogram) = 5,
...
end Test_Ada_Dataflow_Definite_Initialization_Consumer_Legality_Pass1165;
