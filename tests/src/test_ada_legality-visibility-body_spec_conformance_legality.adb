...
with Editor.Ada_Legality.Visibility.Body_Spec_Conformance_Legality;

package body Test_Ada_Legality.Visibility.Body_Spec_Conformance_Legality is

   package BC renames Editor.Ada_Legality.Visibility.Body_Spec_Conformance_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Visibility.Body_Spec_Conformance_Legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Body_Spec_Conformance_Legality;
