...
package body Test_Ada_RM_Remediation.Elaboration.Configuration_Restriction_Policy is
...
end Test_Ada_RM_Remediation.Elaboration.Configuration_Restriction_Policy;
