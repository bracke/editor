...
package body Test_Ada_Control_Flow_Legality_Pass1102 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Control_Flow_Legality_Pass1102");
   end Name;
...
end Test_Ada_Control_Flow_Legality_Pass1102;
