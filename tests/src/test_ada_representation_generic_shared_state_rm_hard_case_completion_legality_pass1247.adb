...
package body Test_Ada_Representation_Generic_Shared_State_RM_Hard_Case_Completion_Legality_Pass1247 is
   ...
   begin
      return AUnit.Format ("Ada representation generic shared-state RM hard-case completion legality pass1247");
   end Name;
...
end Test_Ada_Representation_Generic_Shared_State_RM_Hard_Case_Completion_Legality_Pass1247;
