...
package body Test_Ada_Legality.Elaboration.Graph_Final_Legality is

   package Final renames Editor.Ada_Legality.Elaboration.Graph_Final_Legality;
   ...
   package Elab renames Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
   ...
   package Tasking renames Editor.Ada_Legality.Tasking.Repair_Contract_Predicate_Dataflow;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Elaboration.Graph_Final_Legality");
   end Name;
...
end Test_Ada_Legality.Elaboration.Graph_Final_Legality;
