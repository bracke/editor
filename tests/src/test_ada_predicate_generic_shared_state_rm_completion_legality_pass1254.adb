...
package body Test_Ada_Predicate_Generic_Shared_State_RM_Completion_Legality_Pass1254 is
   ...
   begin
      return AUnit.Format ("Ada predicate generic shared-state RM completion legality pass1254");
   end Name;
...
end Test_Ada_Predicate_Generic_Shared_State_RM_Completion_Legality_Pass1254;
