...
package body Test_Ada_Remaining_RM_Edge_Recheck_Convergence_Legality_Pass1289 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge recheck convergence legality pass1289");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Recheck_Convergence_Legality_Pass1289;
