...
package body Test_Ada_Final_Semantic_Stabilized_Closure_Legality_Pass1209 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Stabilized_Closure_Legality_Pass1209");
   end Name;
