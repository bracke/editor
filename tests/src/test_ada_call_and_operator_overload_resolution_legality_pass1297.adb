...
package body Test_Ada_Call_And_Operator_Overload_Resolution_Legality_Pass1297 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Call_And_Operator_Overload_Resolution_Legality_Pass1297");
   end Name;
...
end Test_Ada_Call_And_Operator_Overload_Resolution_Legality_Pass1297;
