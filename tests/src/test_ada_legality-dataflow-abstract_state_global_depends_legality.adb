...
with Editor.Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality;

package body Test_Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality is

   package AS renames Editor.Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality;
