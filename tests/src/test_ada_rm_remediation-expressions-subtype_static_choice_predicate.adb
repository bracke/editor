...
with Editor.Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate;

package body Test_Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate");
...
end Test_Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate;
