...
package body Test_Ada_Legality.Expressions.Overload_Type_Final_RM_Legality is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Overload_Type_Final_RM_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Overload_Type_Final_RM_Legality;
