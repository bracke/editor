...
package body Test_Ada_Freezing_Representation_Vertical_Slice_Legality_Pass1299 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Freezing_Representation_Vertical_Slice_Legality_Pass1299");
   end Name;
   ...
   begin
      ...
      Add_Clause (Clauses, 3, 3, 129933, FRL.Clause_Alignment, Order => 45,
                  In_Generic_Template => True);
...
end Test_Ada_Freezing_Representation_Vertical_Slice_Legality_Pass1299;
