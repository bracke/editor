...
with Editor.Ada_Legality.Expressions.Assignment_Conversion_Legality;

package body Test_Ada_Legality.Expressions.Assignment_Conversion_Legality is

   package AC renames Editor.Ada_Legality.Expressions.Assignment_Conversion_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Expressions.Assignment_Conversion_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Assignment_Conversion_Legality;
