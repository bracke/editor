...
with Editor.Ada_Legality.Tasking.Repair_Protected_Precision;

package body Test_Ada_Tasking_Protected_Precision_Legality is

   package TPL renames Editor.Ada_Legality.Tasking.Repair_Protected_Precision;
   ...
   package BTL renames Editor.Ada_Legality.Tasking.Repair_Protected_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_Precision_Legality");
   end Name;
...
end Test_Ada_Tasking_Protected_Precision_Legality;
