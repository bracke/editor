...
package body Test_Ada_Staticness_Range_Predicate_Legality_Pass1110 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Staticness_Range_Predicate_Legality_Pass1110");
   end Name;
...
end Test_Ada_Staticness_Range_Predicate_Legality_Pass1110;
