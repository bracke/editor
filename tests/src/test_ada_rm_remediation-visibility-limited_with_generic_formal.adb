...
with Editor.Ada_RM_Remediation.Visibility.Limited_With_Generic_Formal;

package body Test_Ada_RM_Remediation.Visibility.Limited_With_Generic_Formal is

   package Audit renames Editor.Ada_RM_Remediation.Visibility.Limited_With_Generic_Formal;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Visibility.Limited_With_Generic_Formal");
...
end Test_Ada_RM_Remediation.Visibility.Limited_With_Generic_Formal;
