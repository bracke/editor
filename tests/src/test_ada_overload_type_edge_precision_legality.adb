...
package body Test_Ada_Overload_Type_Edge_Precision_Legality is
   ...
   begin
      return Format ("Test_Ada_Overload_Type_Edge_Precision_Legality");
   end Name;
...
end Test_Ada_Overload_Type_Edge_Precision_Legality;
