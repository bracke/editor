...
package body Test_Ada_Overload_Preference_Legality_Pass1126 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Overload_Preference_Legality_Pass1126");
   end Name;
...
end Test_Ada_Overload_Preference_Legality_Pass1126;
