...
package body Test_Ada_Tasking_Protected_Deep_Edge_Legality_Pass1193 is
   ...
   begin
      return Format ("Test_Ada_Tasking_Protected_Deep_Edge_Legality_Pass1193");
   end Name;
...
end Test_Ada_Tasking_Protected_Deep_Edge_Legality_Pass1193;
