...
package body Test_Ada_Dataflow_Global_Depends_Legality_Pass1123 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Dataflow_Global_Depends_Legality_Pass1123");
   end Name;
...
end Test_Ada_Dataflow_Global_Depends_Legality_Pass1123;
