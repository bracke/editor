...
package body Test_Ada_Generic_Shared_State_Final_Recheck_Eligibility_Legality_Pass1241 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final recheck eligibility legality pass1241");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Recheck_Eligibility_Legality_Pass1241;
