...
package body Test_Ada_Contract_Aspect_Legality_Pass1112 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Contract_Aspect_Legality_Pass1112");
   end Name;
...
end Test_Ada_Contract_Aspect_Legality_Pass1112;
