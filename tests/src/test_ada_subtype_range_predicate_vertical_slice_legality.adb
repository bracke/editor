...
package body Test_Ada_Subtype_Range_Predicate_Vertical_Slice_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Subtype_Range_Predicate_Vertical_Slice_Legality");
   end Name;
...
end Test_Ada_Subtype_Range_Predicate_Vertical_Slice_Legality;
