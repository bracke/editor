...
with Editor.Ada_RM_Remediation.Expressions.String_Array_Constraints;

package body Test_Ada_RM_Remediation.Expressions.String_Array_Constraints is
   package Audit renames Editor.Ada_RM_Remediation.Expressions.String_Array_Constraints;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.String_Array_Constraints");
      Row.Candidate_Case := To_Unbounded_String ("Case 1415");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1415 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1415 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1415 should close the array/string wide-wide character gap");
...
end Test_Ada_RM_Remediation.Expressions.String_Array_Constraints;
