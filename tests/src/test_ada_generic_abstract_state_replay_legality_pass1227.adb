...
package body Test_Ada_Generic_Abstract_State_Replay_Legality_Pass1227 is
   ...
   begin
      return AUnit.Format ("Ada generic abstract-state replay legality pass1227");
   end Name;
...
end Test_Ada_Generic_Abstract_State_Replay_Legality_Pass1227;
