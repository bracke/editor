...
package body Test_Ada_Elaboration_Contract_Flow_Consumer_Legality_Pass1157 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Contract_Flow_Consumer_Legality_Pass1157");
   end Name;
...
end Test_Ada_Elaboration_Contract_Flow_Consumer_Legality_Pass1157;
