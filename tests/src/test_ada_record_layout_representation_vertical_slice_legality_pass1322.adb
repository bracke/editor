...
package body Test_Ada_Record_Layout_Representation_Vertical_Slice_Legality_Pass1322 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Record_Layout_Representation_Vertical_Slice_Legality_Pass1322");
   end Name;
...
end Test_Ada_Record_Layout_Representation_Vertical_Slice_Legality_Pass1322;
