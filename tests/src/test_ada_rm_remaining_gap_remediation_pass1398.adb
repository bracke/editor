...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1398;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1398 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1398;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1398");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1398");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1398");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1398 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1398 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1398 should close the conditional expression expected type gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1398;
