...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Feed is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Feed");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Feed;
