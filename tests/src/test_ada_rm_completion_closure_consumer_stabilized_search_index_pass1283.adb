...
package body Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Search_Index_Pass1283 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer stabilized search index pass1283");
   end Name;
   ...
   begin
      ...
      Assert (Search.Error_Count (Model) >= 5,
...
end Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Search_Index_Pass1283;
