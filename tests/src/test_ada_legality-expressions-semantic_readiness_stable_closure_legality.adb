...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Stable_Closure_Legality is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Stable_Closure_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Stable_Closure_Legality;
