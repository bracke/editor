...
with Editor.Ada_Legality.Expressions.Contract_Aspect_Legality;

package body Test_Ada_Legality.Expressions.Contract_Aspect_Legality is

   package CAL renames Editor.Ada_Legality.Expressions.Contract_Aspect_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Expressions.Contract_Aspect_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Contract_Aspect_Legality;
