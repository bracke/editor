...
package body Test_Ada_Semantic_Coverage_Gates_Pass1134 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Semantic_Coverage_Gates_Pass1134");
   end Name;
...
end Test_Ada_Semantic_Coverage_Gates_Pass1134;
