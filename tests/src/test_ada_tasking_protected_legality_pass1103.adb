...
package body Test_Ada_Tasking_Protected_Legality_Pass1103 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_Legality_Pass1103");
   end Name;
...
end Test_Ada_Tasking_Protected_Legality_Pass1103;
