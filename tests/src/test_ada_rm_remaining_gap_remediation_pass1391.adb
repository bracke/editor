...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1391;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1391 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1391;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1391");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1391");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1391");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1391 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1391 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1391 should close the modular type size/operator gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1391;
