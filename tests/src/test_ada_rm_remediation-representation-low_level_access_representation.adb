...
package body Test_Ada_RM_Remediation.Representation.Low_Level_Access_Representation is
...
end Test_Ada_RM_Remediation.Representation.Low_Level_Access_Representation;
