...
with Editor.Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality;
with Editor.Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality is
   ...
   package Gen_Rep renames Editor.Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality;
   ...
   package Rep_Flow renames Editor.Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality;
   use type Rep_Flow.Representation_Tasking_Row_Id;
   use type Rep_Flow.Representation_Tasking_Context_Kind;
   use type Rep_Flow.Representation_Tasking_Status;
   use type Rep_Flow.Representation_Tasking_Context_Info;
   use type Rep_Flow.Representation_Tasking_Info;
   use type Rep_Flow.Representation_Tasking_Context_Model;
   use type Rep_Flow.Representation_Tasking_Set;
   use type Rep_Flow.Representation_Tasking_Model;

   function Name (T : Test_Case) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality");
   end Name;
   ...
   begin
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116001);
      C.Generic_Source_Node := Editor.Ada_Syntax_Tree.Node_Id (116101);
      C.Instance_Node := Editor.Ada_Syntax_Tree.Node_Id (116201);
      ...
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (1);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Legal_Representation_Clause_Accepted;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116002);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (2);
      C.Replay_Status := Replay.Replay_Legal_Representation_Freezing;
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (2);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Refined_Global_Missing_Write;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116003);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (3);
      C.Replay_Status := Replay.Replay_Legal_Representation_Freezing;
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (3);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Refined_Depends_Missing_Edge;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116004);
      ...
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (4);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Call_Effect_Not_Propagated;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116005);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (5);
      C.Replay_Status := Replay.Replay_Legal_Representation_Freezing;
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (5);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Coverage_Feedback_Blocker;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116006);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (6);
      C.Replay_Status := Replay.Replay_Representation_Freezing_Error;
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (6);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Legal_Generic_Instance_Effect_Accepted;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116007);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (7);
      C.Replay_Status := Replay.Replay_Legal_Representation_Freezing;
      C.Representation_Flow_Row := Rep_Flow.Representation_Tasking_Row_Id (7);
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Base_Tasking_Effect_Error;
      C.Representation_Flow_Matches := 1;
      ...
      C.Node := Editor.Ada_Syntax_Tree.Node_Id (116008);
      C.Instance_Name := To_Unbounded_String ("I");
      C.Replay_Row := Replay.Replay_Row_Id (8);
      C.Replay_Status := Replay.Replay_Legal_Representation_Freezing;
      C.Representation_Flow_Row := Rep_Flow.No_Representation_Tasking_Row;
      C.Representation_Flow_Status := Rep_Flow.Representation_Tasking_Not_Checked;
      C.Representation_Flow_Matches := 0;
   ...
   begin
      Assert (Gen_Rep.Row_Count (Model) = 8, "expected eight generic replay representation-flow rows");
      Assert (Gen_Rep.Legal_Count (Model) = 1, "only accepted representation replay should remain legal");
      Assert (Gen_Rep.Count_Status (Model, Gen_Rep.Generic_Replay_Representation_Refined_Global_Missing_Write) = 1,
              "generic replay must consume missing Refined_Global write blocker");
      Assert (Gen_Rep.Count_Status (Model, Gen_Rep.Generic_Replay_Representation_Refined_Depends_Missing_Edge) = 1,
              "generic replay must consume missing Refined_Depends edge blocker");
      ...
      Assert (Gen_Rep.Count_Status (Model, Gen_Rep.Generic_Replay_Representation_Replay_Representation_Error) = 1,
              "base replay representation errors must dominate legal representation-flow rows");
      ...
      Assert (Gen_Rep.Count_Status (Model, Gen_Rep.Generic_Replay_Representation_Missing_Representation_Flow_Row) = 1,
              "generic replay without representation-flow row must not remain confident");
      Assert (Gen_Rep.Replay_Error_Count (Model) = 1, "expected one base replay blocker");
      Assert (Gen_Rep.Global_Error_Count (Model) = 1, "expected one Refined_Global blocker");
      Assert (Gen_Rep.Depends_Error_Count (Model) = 1, "expected one Refined_Depends blocker");
   ...
   procedure Test_Queries (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Row   : constant Gen_Rep.Generic_Replay_Representation_Info :=
        Gen_Rep.First_For_Node (Model, Editor.Ada_Syntax_Tree.Node_Id (116004));
   ...
   begin
      Register_Routine (T, Test_Statuses'Access, "generic replay consumes representation-flow blockers");
      Register_Routine (T, Test_Queries'Access, "generic replay representation-flow lookups preserve blockers");
   end Register_Tests;

end Test_Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality;
