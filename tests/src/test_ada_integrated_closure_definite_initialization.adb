...
package body Test_Ada_Integrated_Closure_Definite_Initialization is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_Definite_Initialization");
   end Name;
...
end Test_Ada_Integrated_Closure_Definite_Initialization;
