...
package body Test_Ada_Interfacing_Import_Export_Vertical_Slice_Legality is
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Interfacing_Import_Export_Vertical_Slice_Legality");
   end Name;
...
end Test_Ada_Interfacing_Import_Export_Vertical_Slice_Legality;
