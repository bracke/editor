...
package body Test_Ada_RM_Remediation.Expressions.Fixed_Point_Conversion is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1375 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1375 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1375 should close the selected fixed-point conversion gap");
...
end Test_Ada_RM_Remediation.Expressions.Fixed_Point_Conversion;
