...
package body Editor.Configuration_Audit.Tests is
   ...
   begin
      ...
      Install_Project (S, Editor.Test_Temp.Path ("editor-a"), "editor-a");
      ...
      Editor.Recent_Projects.Add_Or_Promote
        (S.Project_Runtime.Recent_Projects, Editor.Test_Temp.Path ("editor-a"), "editor-a", 108);
   ...
   begin
      ...
      Assert (Ada.Strings.Fixed.Index (To_String (Settings_Text), Editor.Test_Temp.Path ("editor-")) = 0,
      ...
      Assert (Ada.Strings.Fixed.Index (To_String (Keybindings_Text), Editor.Test_Temp.Path ("editor-")) = 0,
   ...
   begin
      ...
      Editor.Buffers.Global_Add_File_Buffer
        (Editor.Test_Temp.Path ("editor-/selected.adb"), "selected.adb", "procedure Selected is begin null; end;", Id);
   ...
   begin
      ...
      Target.Buffer_Id := 77;
      Target.Has_Buffer := True;
      Target.Path := To_Unbounded_String (Editor.Test_Temp.Path ("editor-/reload.adb"));
   ...
   begin
      ...
      S.Buffer_Lifecycle.File_Conflict_Prompt_Path := To_Unbounded_String (Editor.Test_Temp.Path ("editor-/conflicted.adb"));
   ...
   begin
      ...
      S.Buffer_Lifecycle.File_Info.Path := To_Unbounded_String (Editor.Test_Temp.Path ("editor-/preserved.adb"));
