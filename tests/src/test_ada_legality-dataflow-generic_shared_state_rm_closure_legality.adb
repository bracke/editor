...
package body Test_Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality is

   package Registration renames AUnit.Test_Cases.Registration;
   package C renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
...
end Test_Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
