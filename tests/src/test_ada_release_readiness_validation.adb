...
with Editor.Ada_Release_Readiness_Validation;

package body Test_Ada_Release_Readiness_Validation is
   package Ready renames Editor.Ada_Release_Readiness_Validation;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Release_Readiness_Validation");
   end Name;
   ...
   begin
      ...
      Row.Expected_Package_Name := To_Unbounded_String
        ("Editor.Ada_Release_Readiness_Validation");
   ...
   begin
      Assert (Feed_Item.Status = Status, "unexpected readiness status");
      Assert (Feed_Item.Result_Class = Result_Class,
              "unexpected readiness class");
   ...
   begin
      Ready.Add_Row (Input, Base_Row
        (1, Ready.Surface_Source_Package,
         "release readiness source package is present"));
      Ready.Add_Row (Input, Base_Row
        (2, Ready.Surface_Test_Package,
         "release readiness AUnit package is present"));
      Ready.Add_Row (Input, Base_Row
        (3, Ready.Surface_Readme,
         "release readiness documentation is present"));
      Ready.Add_Row (Input, Base_Row
        (4, Ready.Surface_Suite_Registration,
         "release readiness suite registration is present once"));
      Ready.Add_Row (Input, Base_Row
        (5, Ready.Surface_Release_Documentation,
         "release readiness documentation agrees with source and tests"));
      Ready.Add_Row (Input, Base_Row
        (6, Ready.Surface_Final_Remaining_Gap_Closure,
         "case 1428 finite Remaining edge closure remains frozen"));
      Ready.Add_Row (Input, Base_Row
   ...
   begin
      ...
      Row := Base_Row
        (11, Ready.Surface_Test_Package,
         "test package is not registered in active suite");
      Row.Registered_In_Suite := False;
      Ready.Add_Row (Input, Row);

      Row := Base_Row
        (12, Ready.Surface_Suite_Registration,
         "test package registered twice in active suite");
      Row.Duplicate_Suite_Registration := True;
      Ready.Add_Row (Input, Row);
   ...
   begin
      ...
      Row := Base_Row
        (22, Ready.Surface_Final_Remaining_Gap_Closure,
         "new Remaining edge appears after case 1428 closure");
   ...
   begin
      ...
      Ready.Add_Row (Input, Base_Row
        (33, Ready.Surface_Readme,
         "release readiness documentation is present"));
      Ready.Add_Row (Input, Base_Row
        (34, Ready.Surface_Suite_Registration,
         "release readiness suite registration is present once"));
      Ready.Add_Row (Input, Base_Row
...
end Test_Ada_Release_Readiness_Validation;
