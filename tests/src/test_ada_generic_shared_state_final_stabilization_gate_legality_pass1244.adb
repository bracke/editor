...
package body Test_Ada_Generic_Shared_State_Final_Stabilization_Gate_Legality_Pass1244 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final stabilization gate legality pass1244");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Stabilization_Gate_Legality_Pass1244;
