...
package body Test_Ada_Discriminant_Generic_Shared_State_Final_Legality_Pass1234 is
   ...
   begin
      return AUnit.Format ("Ada discriminant/generic shared-state final legality pass1234");
   end Name;
...
end Test_Ada_Discriminant_Generic_Shared_State_Final_Legality_Pass1234;
