...
package body Test_Ada_Exception_Finalization_RM_Completion_Closure_Consumer_Legality_Pass1271 is
   ...
   begin
      return AUnit.Format ("Ada exception/finalization RM-completion closure consumer pass1271");
   end Name;
...
end Test_Ada_Exception_Finalization_RM_Completion_Closure_Consumer_Legality_Pass1271;
