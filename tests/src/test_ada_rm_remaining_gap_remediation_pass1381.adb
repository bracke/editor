...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1381;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1381 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1381;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1381");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1381");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1381");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1381 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1381 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1381 should close the selected controlled assignment/finalization gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1381;
