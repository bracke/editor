...
package body Test_Ada_Overload_RM_Edge_Legality_Pass1141 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Overload_RM_Edge_Legality_Pass1141");
   end Name;
...
end Test_Ada_Overload_RM_Edge_Legality_Pass1141;
