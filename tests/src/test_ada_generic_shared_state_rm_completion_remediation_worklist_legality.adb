...
package body Test_Ada_Generic_Shared_State_RM_Completion_Remediation_Worklist_Legality is
...
end Test_Ada_Generic_Shared_State_RM_Completion_Remediation_Worklist_Legality;
