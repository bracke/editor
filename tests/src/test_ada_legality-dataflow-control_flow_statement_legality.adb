...
with Editor.Ada_Legality.Dataflow.Control_Flow_Statement_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Dataflow.Control_Flow_Statement_Legality is

   package CF renames Editor.Ada_Legality.Dataflow.Control_Flow_Statement_Legality;
   use type CF.Flow_Id;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Control_Flow_Statement_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Control_Flow_Statement_Legality;
