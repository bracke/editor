...
with Editor.Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts;

package body Test_Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts is

   package Audit renames Editor.Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts");
...
end Test_Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts;
