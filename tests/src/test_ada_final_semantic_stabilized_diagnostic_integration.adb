...
package body Test_Ada_Final_Semantic_Stabilized_Diagnostic_Integration is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Stabilized_Diagnostic_Integration");
   end Name;
...
end Test_Ada_Final_Semantic_Stabilized_Diagnostic_Integration;
