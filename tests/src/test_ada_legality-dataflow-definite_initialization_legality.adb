...
package body Test_Ada_Legality.Dataflow.Definite_Initialization_Legality is

   package DIC renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Legality;
   ...
   package IOF renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Definite_Initialization_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Definite_Initialization_Legality;
