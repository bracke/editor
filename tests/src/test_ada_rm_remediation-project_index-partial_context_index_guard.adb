...
package body Test_Ada_RM_Remediation.Project_Index.Partial_Context_Index_Guard is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1387 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1387 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1387 should close the recovered-context/project-index gap");
...
end Test_Ada_RM_Remediation.Project_Index.Partial_Context_Index_Guard;
