...
package body Test_Ada_Legality.Elaboration.RM_Closure_Closure_Legality is

   package R renames Editor.Ada_Legality.Elaboration.RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada elaboration RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Elaboration.RM_Closure_Closure_Legality;
