...
package body Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Diagnostic_Provenance is
...
end Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Diagnostic_Provenance;
