...
with Editor.Ada_Legality.Expressions.Numeric_Static_Expression_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Numeric_Static_Expression_Legality is

   package NS renames Editor.Ada_Legality.Expressions.Numeric_Static_Expression_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Numeric_Static_Expression_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Numeric_Static_Expression_Legality;
