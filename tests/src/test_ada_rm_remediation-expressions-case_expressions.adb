...
package body Test_Ada_RM_Remediation.Expressions.Case_Expressions is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1399 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1399 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1399 should close the case expression others coverage gap");
...
end Test_Ada_RM_Remediation.Expressions.Case_Expressions;
