...
package body Test_Ada_Integrated_Closure_AST_Coverage_Pass1133 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_AST_Coverage_Pass1133");
   end Name;
...
end Test_Ada_Integrated_Closure_AST_Coverage_Pass1133;
