...
package body Test_Ada_RM_Remediation.Finalization.Controlled_Discriminant_Finalization is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1421 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1421 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1421 should close the controlled finalized discriminant component gap");
...
end Test_Ada_RM_Remediation.Finalization.Controlled_Discriminant_Finalization;
