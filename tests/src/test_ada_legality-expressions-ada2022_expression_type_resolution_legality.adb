...
with Editor.Ada_Legality.Expressions.Ada2022_Expression_Type_Resolution_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Ada2022_Expression_Type_Resolution_Legality is

   package ER renames Editor.Ada_Legality.Expressions.Ada2022_Expression_Type_Resolution_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Ada2022_Expression_Type_Resolution_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Ada2022_Expression_Type_Resolution_Legality;
