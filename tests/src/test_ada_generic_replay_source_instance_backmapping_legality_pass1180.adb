...
package body Test_Ada_Generic_Replay_Source_Instance_Backmapping_Legality_Pass1180 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Replay_Source_Instance_Backmapping_Legality_Pass1180");
   end Name;
...
end Test_Ada_Generic_Replay_Source_Instance_Backmapping_Legality_Pass1180;
