...
package body Test_Ada_Generic_Shared_State_Final_Recheck_Application_Legality_Pass1242 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final recheck application legality pass1242");
   end Name;
...
end Test_Ada_Generic_Shared_State_Final_Recheck_Application_Legality_Pass1242;
