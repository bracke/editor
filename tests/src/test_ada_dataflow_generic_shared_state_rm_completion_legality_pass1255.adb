...
package body Test_Ada_Dataflow_Generic_Shared_State_RM_Completion_Legality_Pass1255 is
   ...
   begin
      return AUnit.Format ("Ada dataflow generic shared-state RM completion legality pass1255");
   end Name;
...
end Test_Ada_Dataflow_Generic_Shared_State_RM_Completion_Legality_Pass1255;
