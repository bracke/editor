...
package body Test_Ada_Final_Semantic_Recheck_Application_Legality_Pass1206 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Recheck_Application_Legality_Pass1206");
   end Name;
...
end Test_Ada_Final_Semantic_Recheck_Application_Legality_Pass1206;
