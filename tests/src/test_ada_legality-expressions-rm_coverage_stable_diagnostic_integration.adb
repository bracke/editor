...
package body Test_Ada_Legality.Expressions.RM_Coverage_Stable_Diagnostic_Integration is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge stabilized diagnostic integration");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Coverage_Stable_Diagnostic_Integration;
