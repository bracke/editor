...
package body Test_Ada_Remaining_RM_Edge_Recheck_Eligibility_Legality_Pass1287 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge recheck eligibility legality pass1287");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Recheck_Eligibility_Legality_Pass1287;
