...
package body Test_Ada_Phase579_Architecture_Cleanup is
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Architecture_Cleanup");
   end Name;
   ...
   begin
      ...
      Row := Base_Row
        (10, Cleanup.Surface_Test_Harness,
         "Test_Ada_Phase579_Architecture_Cleanup",
         "tests/src/test_ada_phase579_architecture_cleanup.ads");
      Row.Is_Production_Surface := False;
...
end Test_Ada_Phase579_Architecture_Cleanup;
