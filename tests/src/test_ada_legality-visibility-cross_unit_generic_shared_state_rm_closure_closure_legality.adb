...
package body Test_Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality is

   package T renames Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada cross-unit generic/shared-state RM completion closure legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
