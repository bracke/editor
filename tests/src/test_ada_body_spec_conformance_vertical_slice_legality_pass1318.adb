...
package body Test_Ada_Body_Spec_Conformance_Vertical_Slice_Legality_Pass1318 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Body_Spec_Conformance_Vertical_Slice_Legality_Pass1318");
   end Name;
...
end Test_Ada_Body_Spec_Conformance_Vertical_Slice_Legality_Pass1318;
