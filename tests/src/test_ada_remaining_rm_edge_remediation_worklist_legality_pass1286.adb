...
package body Test_Ada_Remaining_RM_Edge_Remediation_Worklist_Legality_Pass1286 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge remediation worklist legality pass1286");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Remediation_Worklist_Legality_Pass1286;
