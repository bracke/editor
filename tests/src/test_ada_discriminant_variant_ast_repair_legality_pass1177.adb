...
package body Test_Ada_Discriminant_Variant_AST_Repair_Legality_Pass1177 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Discriminant_Variant_AST_Repair_Legality_Pass1177");
   end Name;
...
end Test_Ada_Discriminant_Variant_AST_Repair_Legality_Pass1177;
