...
package body Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Diagnostic_Provenance_Pass1293 is
   ...
   package Stable_Prov renames Editor.Ada_RM_Completion_Closure_Consumer_Stabilized_Diagnostic_Provenance;
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge stabilized closure diagnostic provenance pass1293");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Diagnostic_Provenance_Pass1293;
