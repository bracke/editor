...
package body Test_Ada_RM_Remediation.Project_Index.Separate_Body_Private_View is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1373 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1373 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1373 should close the selected body-stub elaboration private-view gap");
...
end Test_Ada_RM_Remediation.Project_Index.Separate_Body_Private_View;
