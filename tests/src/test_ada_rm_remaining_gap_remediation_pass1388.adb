...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1388;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1388 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1388;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1388");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1388");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1388");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1388 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1388 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1388 should close the delta-aggregate/discriminant update gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1388;
