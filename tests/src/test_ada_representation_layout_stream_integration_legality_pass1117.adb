...
package body Test_Ada_Representation_Layout_Stream_Integration_Legality_Pass1117 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Representation_Layout_Stream_Integration_Legality_Pass1117");
   end Name;
