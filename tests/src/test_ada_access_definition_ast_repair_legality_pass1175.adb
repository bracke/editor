...
package body Test_Ada_Access_Definition_AST_Repair_Legality_Pass1175 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Access_Definition_AST_Repair_Legality_Pass1175");
   end Name;
...
end Test_Ada_Access_Definition_AST_Repair_Legality_Pass1175;
