...
package body Test_Ada_Exception_Finalization_Generic_Shared_State_RM_Completion_Legality is
...
end Test_Ada_Exception_Finalization_Generic_Shared_State_RM_Completion_Legality;
