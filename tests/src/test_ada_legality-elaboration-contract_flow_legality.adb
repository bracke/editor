...
with Editor.Ada_Legality.Dataflow.Contract_Flow_Refinement_Legality;
with Editor.Ada_Legality.Elaboration.Contract_Flow_Legality;
with Editor.Ada_Elaboration_Graph_Closure_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Elaboration.Contract_Flow_Legality is

   package Contract_Flow renames Editor.Ada_Legality.Dataflow.Contract_Flow_Refinement_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Elaboration.Contract_Flow_Legality");
   end Name;
...
end Test_Ada_Legality.Elaboration.Contract_Flow_Legality;
