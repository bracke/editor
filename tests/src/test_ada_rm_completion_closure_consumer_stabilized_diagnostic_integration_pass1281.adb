...
package body Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Diagnostic_Integration_Pass1281 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer stabilized diagnostic integration pass1281");
   end Name;
   ...
   begin
      ...
      Assert
        (D.Count_Status (Diagnostics, D.RM_Closure_Consumer_Stabilized_Diagnostic_Withheld_Accepted_Current) = 1,
         "accepted-current stabilized closure status should be preserved");
...
end Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Diagnostic_Integration_Pass1281;
