...
package body Test_Ada_Integrated_Closure_Coverage_Gates is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_Coverage_Gates");
   end Name;
...
end Test_Ada_Integrated_Closure_Coverage_Gates;
