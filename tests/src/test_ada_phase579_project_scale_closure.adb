...
package body Test_Ada_Phase579_Project_Scale_Closure is
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Project_Scale_Closure");
   end Name;
...
end Test_Ada_Phase579_Project_Scale_Closure;
