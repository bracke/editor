...
package body Test_Ada_RM_Remediation.Diagnostics.Blocker_Source_Span_Precision is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1364 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1364 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Diagnostics.Blocker_Source_Span_Precision;
