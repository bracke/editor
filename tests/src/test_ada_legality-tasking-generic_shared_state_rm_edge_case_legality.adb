...
package body Test_Ada_Legality.Tasking.Generic_Shared_State_RM_Edge_Case_Legality is

   package T renames Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure;
...
end Test_Ada_Legality.Tasking.Generic_Shared_State_RM_Edge_Case_Legality;
