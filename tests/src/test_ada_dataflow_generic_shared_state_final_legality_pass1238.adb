...
package body Test_Ada_Dataflow_Generic_Shared_State_Final_Legality_Pass1238 is
   ...
   begin
      return AUnit.Format ("Ada dataflow generic shared-state final legality pass1238");
   end Name;
...
end Test_Ada_Dataflow_Generic_Shared_State_Final_Legality_Pass1238;
