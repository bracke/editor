...
package body Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Closure_Legality_Pass1280 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer stabilized closure pass1280");
   end Name;
...
end Test_Ada_RM_Completion_Closure_Consumer_Stabilized_Closure_Legality_Pass1280;
