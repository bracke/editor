...
package body Test_Ada_Predicate_Invariant_Use_Site_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Predicate_Invariant_Use_Site_Legality");
   end Name;
...
end Test_Ada_Predicate_Invariant_Use_Site_Legality;
