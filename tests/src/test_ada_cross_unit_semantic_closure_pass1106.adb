...
package body Test_Ada_Cross_Unit_Semantic_Closure_Pass1106 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Cross_Unit_Semantic_Closure_Pass1106");
   end Name;
...
end Test_Ada_Cross_Unit_Semantic_Closure_Pass1106;
