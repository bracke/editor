...
package body Test_Ada_Library_Unit_Subunit_Vertical_Slice_Legality_Pass1331 is
   ...
   begin
      return AUnit.Format ("Ada library unit subunit vertical slice legality pass1331");
   end Name;
...
end Test_Ada_Library_Unit_Subunit_Vertical_Slice_Legality_Pass1331;
