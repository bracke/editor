...
package body Test_Ada_Representation_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1170 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Representation_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1170");
   end Name;
...
end Test_Ada_Representation_Tasking_Contract_Predicate_Dataflow_Consumer_Legality_Pass1170;
