...
with Editor.Ada_Legality.Visibility.Renaming_Alias_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Visibility.Renaming_Alias_Legality is

   package RA renames Editor.Ada_Legality.Visibility.Renaming_Alias_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Visibility.Renaming_Alias_Legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Renaming_Alias_Legality;
