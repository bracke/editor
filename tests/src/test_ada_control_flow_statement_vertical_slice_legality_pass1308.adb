...
package body Test_Ada_Control_Flow_Statement_Vertical_Slice_Legality_Pass1308 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Control_Flow_Statement_Vertical_Slice_Legality_Pass1308");
   end Name;
...
end Test_Ada_Control_Flow_Statement_Vertical_Slice_Legality_Pass1308;
