...
package body Test_Ada_Shared_State_Recheck_Application_Legality_Pass1220 is
   ...
   begin
      return AUnit.Format ("Ada shared-state recheck application legality pass1220");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert
           (Apply.Count_By_Status (Model, Apply.Shared_State_Recheck_Application_Withheld_View_Barrier) = 1,
            "view barrier should remain distinct at application");
         Assert
         ...
         Assert
           (Apply.Count_By_Status (Model, Apply.Shared_State_Recheck_Application_Withheld_State_Visibility) = 1,
            "state visibility should remain distinct at application");
         Assert
...
end Test_Ada_Shared_State_Recheck_Application_Legality_Pass1220;
