...
package body Test_Ada_Generic_Body_Replay_Substitution_Vertical_Slice_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Body_Replay_Substitution_Vertical_Slice_Legality");
   end Name;
...
end Test_Ada_Generic_Body_Replay_Substitution_Vertical_Slice_Legality;
