...
package body Test_Ada_Enumeration_Representation_Vertical_Slice_Legality_Pass1323 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Enumeration_Representation_Vertical_Slice_Legality_Pass1323");
   end Name;
...
end Test_Ada_Enumeration_Representation_Vertical_Slice_Legality_Pass1323;
