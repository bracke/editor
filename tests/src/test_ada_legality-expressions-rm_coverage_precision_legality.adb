...
package body Test_Ada_Legality.Expressions.RM_Coverage_Precision_Legality is

   package R renames Editor.Ada_Legality.Expressions.RM_Coverage_Precision_Legality;
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge precision legality");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Coverage_Precision_Legality;
