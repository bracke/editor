...
package body Test_Ada_Diagnostic_Quick_Fix_Overload_Ranking_Pass1074 is

   function Name (T : Test_Case) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Test_Ada_Diagnostic_Quick_Fix_Overload_Ranking_Pass1074");
   end Name;
...
end Test_Ada_Diagnostic_Quick_Fix_Overload_Ranking_Pass1074;
