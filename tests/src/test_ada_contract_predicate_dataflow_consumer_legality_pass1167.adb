...
package body Test_Ada_Contract_Predicate_Dataflow_Consumer_Legality_Pass1167 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Contract_Predicate_Dataflow_Consumer_Legality_Pass1167");
   end Name;
...
end Test_Ada_Contract_Predicate_Dataflow_Consumer_Legality_Pass1167;
