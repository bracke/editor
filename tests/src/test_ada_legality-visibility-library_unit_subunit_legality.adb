...
with Editor.Ada_Legality.Visibility.Library_Unit_Subunit_Legality;

package body Test_Ada_Legality.Visibility.Library_Unit_Subunit_Legality is

   package LUS renames Editor.Ada_Legality.Visibility.Library_Unit_Subunit_Legality;
...
end Test_Ada_Legality.Visibility.Library_Unit_Subunit_Legality;
