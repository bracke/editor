...
with Editor.Ada_Legality.Generics.Contract_Body_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Generics.Contract_Body_Legality is

   package GCL renames Editor.Ada_Legality.Generics.Contract_Body_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Generics.Contract_Body_Legality");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert (GCL.First_For_Node
                 ...
                 GCL.Generic_Legal_Defaulted_Formal_Object,
                 "formal package/subprogram contracts and defaulted formals should match under substitution");
         Assert (GCL.First_For_Node
...
end Test_Ada_Legality.Generics.Contract_Body_Legality;
