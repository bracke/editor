...
package body Test_Ada_Abstract_State_Refined_State_Legality_Pass1211 is
   ...
   begin
      return Format ("Test_Ada_Abstract_State_Refined_State_Legality_Pass1211");
   end Name;
...
end Test_Ada_Abstract_State_Refined_State_Legality_Pass1211;
