...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1373;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1373 is

   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1373;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1373");
   end Name;
   ...
   begin
      Row.Id := Id;
      Row.Gap := Audit.Remaining_Body_Stub_Elaboration_Private_View_Edge;
      ...
      Row.Source_File := To_Unbounded_String ("src/body-stub-elaboration-private-view.adb");
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1373");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1373");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1373 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1373 precision classification");
   end Expect_Status;

   procedure Test_Body_Stub_Elaboration_Private_View_Gap_Remediated
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1373 should close the selected body-stub elaboration private-view gap");
   ...
   end Test_Body_Stub_Elaboration_Private_View_Gap_Remediated;

   procedure Test_Body_Stub_Elaboration_Private_View_Rejections
   ...
   begin
      ...
      Expect_Status (Results, 15, Audit.Status_Illegal_Renamed_Type_View_Mismatch,
                     Precision.Class_Illegal);
   end Test_Body_Stub_Elaboration_Private_View_Rejections;
   ...
   begin
      Register_Routine
        (T, Test_Body_Stub_Elaboration_Private_View_Gap_Remediated'Access,
         "private child body stub elaboration private view gap remediated");
      Register_Routine
        (T, Test_Body_Stub_Elaboration_Private_View_Rejections'Access,
         "body stub elaboration private view rejections");
      Register_Routine
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1373;
