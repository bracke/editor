...
package body Test_Ada_Representation_Generic_Shared_State_Final_Legality is
   ...
   begin
      return AUnit.Format ("Ada representation generic shared-state final legality");
   end Name;
...
end Test_Ada_Representation_Generic_Shared_State_Final_Legality;
