...
package body Test_Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality is

   package DIF renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
   ...
   package Obj_Flow renames Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
