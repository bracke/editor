...
with Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order;
with Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure;
...
with Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index;
with Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Gate_Legality;
with Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Closure_Legality;
...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Provenance_Search is
   ...
   package Final_Index renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index;
   ...
   package Trace renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure;
   ...
   package Remediate renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order;
   ...
   package Gate renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Gate_Legality;
   ...
   package Closure renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Closure_Legality;
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Provenance_Search");
   end Name;
   ...
   begin
      ...
      Assert (Remed_Prov.Query_Count (Trace_Linked) = 4,
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Provenance_Search;
