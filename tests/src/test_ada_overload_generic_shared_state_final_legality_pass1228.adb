...
package body Test_Ada_Overload_Generic_Shared_State_Final_Legality_Pass1228 is
   ...
   begin
      return AUnit.Format ("Ada overload generic shared-state final legality pass1228");
   end Name;
...
end Test_Ada_Overload_Generic_Shared_State_Final_Legality_Pass1228;
