...
package body Test_Ada_Elaboration_Graph_Closure_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Graph_Closure_Legality");
   end Name;
...
end Test_Ada_Elaboration_Graph_Closure_Legality;
