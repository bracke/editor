...
package body Test_Ada_RM_Completion_Closure_Consumer_Remediation_Worklist_Legality is
...
end Test_Ada_RM_Completion_Closure_Consumer_Remediation_Worklist_Legality;
