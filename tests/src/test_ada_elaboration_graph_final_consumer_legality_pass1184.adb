...
package body Test_Ada_Elaboration_Graph_Final_Consumer_Legality_Pass1184 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Graph_Final_Consumer_Legality_Pass1184");
   end Name;
   ...
   begin
      ...
      Assert (Final.Count_Status (Model, Final.Final_Elaboration_Representation_Freezing_Blocker) = 1,
              "representation/freezing blockers must be preserved");
      ...
      Assert (Final.Representation_Error_Count (Model) = 2, "expected representation-family blockers");
      Assert (Final.Tasking_Error_Count (Model) = 1, "expected one direct tasking consumer blocker");
...
end Test_Ada_Elaboration_Graph_Final_Consumer_Legality_Pass1184;
