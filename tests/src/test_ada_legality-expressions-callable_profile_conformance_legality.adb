...
with Editor.Ada_Legality.Expressions.Callable_Profile_Conformance_Legality;

package body Test_Ada_Legality.Expressions.Callable_Profile_Conformance_Legality is

   package PL renames Editor.Ada_Legality.Expressions.Callable_Profile_Conformance_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Callable_Profile_Conformance_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Callable_Profile_Conformance_Legality;
