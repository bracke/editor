...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order;
