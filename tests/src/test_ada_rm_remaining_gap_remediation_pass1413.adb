...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1413;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1413 is
   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1413;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1413");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1413");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1413");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1413 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1413 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1413 should close the imported preelaborate elaboration gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1413;
