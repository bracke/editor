...
with Editor.Ada_Legality.Visibility.Context_Clause_With_Use_Legality;

package body Test_Ada_Legality.Visibility.Context_Clause_With_Use_Legality is

   package CCL renames Editor.Ada_Legality.Visibility.Context_Clause_With_Use_Legality;
   ...
   begin
      return AUnit.Format ("Ada context clause with/use vertical slice legality");
   end Name;
   ...
   begin
      ...
      Add_Unit (Units, 3, "B.Limited", CCL.Unit_Package_Spec,
      ...
      Add_Clause (Clauses, 3, "with B", CCL.Clause_With,
                  Context => 1, Target_Unit => 3, Cycle => True);
      Results := CCL.Build (Units, Types, Clauses);
...
end Test_Ada_Legality.Visibility.Context_Clause_With_Use_Legality;
