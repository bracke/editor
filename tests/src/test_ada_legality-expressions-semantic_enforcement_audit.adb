...
package body Test_Ada_Legality.Expressions.Semantic_Enforcement_Audit is

   package Audit renames Editor.Ada_Legality.Expressions.Semantic_Enforcement_Audit;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Semantic_Enforcement_Audit");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Enforcement_Audit;
