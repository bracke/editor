...
package body Test_Ada_Legality.Tasking.Representation_Tasking_Contract_Predicate_Dataflow_Legality is
   ...
   package Rep_Task_CPD renames Editor.Ada_Legality.Tasking.Representation_Tasking_Contract_Predicate_Dataflow_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Tasking.Representation_Tasking_Contract_Predicate_Dataflow_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Representation_Tasking_Contract_Predicate_Dataflow_Legality;
