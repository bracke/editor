...
with Editor.Ada_Legality.Tasking.Repair_Elaboration_Contract_Flow;

package body Test_Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality is
   ...
   package Rep_Task renames Editor.Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality;
   ...
   package Task_Flow renames Editor.Ada_Legality.Tasking.Repair_Elaboration_Contract_Flow;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality;
