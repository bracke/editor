...
with Editor.Ada_Legality.Tasking.Interface_Synchronized_Legality;

package body Test_Ada_Legality.Tasking.Interface_Synchronized_Legality is

   package ISL renames Editor.Ada_Legality.Tasking.Interface_Synchronized_Legality;
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Legality.Tasking.Interface_Synchronized_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Interface_Synchronized_Legality;
