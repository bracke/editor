...
package body Test_Ada_Definite_Initialization_Flow_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Definite_Initialization_Flow_Legality");
   end Name;
...
end Test_Ada_Definite_Initialization_Flow_Legality;
