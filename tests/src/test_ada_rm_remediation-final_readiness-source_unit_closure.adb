...
with Editor.Ada_RM_Remediation.Final_Readiness.Source_Unit_Closure;

package body Test_Ada_RM_Remediation.Final_Readiness.Source_Unit_Closure is

   package Audit renames Editor.Ada_RM_Remediation.Final_Readiness.Source_Unit_Closure;
   ...
   begin
      ...
      Row.Name := To_Unbounded_String
        ("case 1359 source-shaped source-unit semantic closure row");
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Final_Readiness.Source_Unit_Closure");
      return Row;
   end Base_Row;
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1359 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1359 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Final_Readiness.Source_Unit_Closure;
