...
package body Test_Ada_Legality.Dataflow.State_Review_Convergence_Legality is
   ...
   begin
      return AUnit.Format ("Ada shared-state recheck convergence legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.State_Review_Convergence_Legality;
