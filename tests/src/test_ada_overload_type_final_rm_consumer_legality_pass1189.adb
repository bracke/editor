...
package body Test_Ada_Overload_Type_Final_RM_Consumer_Legality_Pass1189 is
   ...
   begin
      return Format ("Test_Ada_Overload_Type_Final_RM_Consumer_Legality_Pass1189");
   end Name;
...
end Test_Ada_Overload_Type_Final_RM_Consumer_Legality_Pass1189;
