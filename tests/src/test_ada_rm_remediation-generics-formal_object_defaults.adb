...
with Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults;

package body Test_Ada_RM_Remediation.Generics.Formal_Object_Defaults is

     package Audit renames Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults;
   ...
   use type Audit.Remediation_Model;
     ...
     begin
        ...
        Row.Candidate_Implementing_Package :=
          To_Unbounded_String ("Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults");
        Row.Candidate_Case := To_Unbounded_String ("Case 1410");
     ...
     begin
        Assert (Item.Status = Status, "unexpected case 1410 status");
        Assert (Audit.Expected_For_Status (Item.Status) = Expected,
                "unexpected case 1410 precision classification");
     end Expect_Status;
     ...
     begin
        ...
        Assert (Audit.Gap_Remediated (Results), "case 1410 should close the generic default object predicate gap");
...
end Test_Ada_RM_Remediation.Generics.Formal_Object_Defaults;
