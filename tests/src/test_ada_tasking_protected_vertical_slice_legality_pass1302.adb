...
package body Test_Ada_Tasking_Protected_Vertical_Slice_Legality_Pass1302 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_Vertical_Slice_Legality_Pass1302");
   end Name;
...
end Test_Ada_Tasking_Protected_Vertical_Slice_Legality_Pass1302;
