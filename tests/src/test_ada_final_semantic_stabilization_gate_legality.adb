...
package body Test_Ada_Final_Semantic_Stabilization_Gate_Legality is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Stabilization_Gate_Legality");
   end Name;
...
end Test_Ada_Final_Semantic_Stabilization_Gate_Legality;
