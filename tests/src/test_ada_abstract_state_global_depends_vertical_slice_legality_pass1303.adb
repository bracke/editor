...
package body Test_Ada_Abstract_State_Global_Depends_Vertical_Slice_Legality_Pass1303 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Abstract_State_Global_Depends_Vertical_Slice_Legality_Pass1303");
   end Name;
   ...
   begin
      ...
      Add_State (States, 2, AS.State_Constituent, "Invisible_Constituent",
                 Parent => 1, Constituent => True, Visible => False);
...
end Test_Ada_Abstract_State_Global_Depends_Vertical_Slice_Legality_Pass1303;
