...
package body Test_Ada_Accessibility_Master_Scope_Final_Consumer_Legality_Pass1183 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Accessibility_Master_Scope_Final_Consumer_Legality_Pass1183");
   end Name;
   ...
   begin
      ...
      Assert (Final.Lifetime_Error_Count (Model) = 6, "expected six lifetime-family blockers");
...
end Test_Ada_Accessibility_Master_Scope_Final_Consumer_Legality_Pass1183;
