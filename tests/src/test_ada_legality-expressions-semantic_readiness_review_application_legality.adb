...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Application_Legality is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Application_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Review_Application_Legality;
