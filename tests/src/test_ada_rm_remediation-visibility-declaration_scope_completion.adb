...
with Editor.Ada_RM_Remediation.Visibility.Declaration_Scope_Completion;

package body Test_Ada_RM_Remediation.Visibility.Declaration_Scope_Completion is

   package Audit renames Editor.Ada_RM_Remediation.Visibility.Declaration_Scope_Completion;
   ...
   begin
      ...
      Row.Context := Context;
      Row.Name := To_Unbounded_String ("case 1354 source-shaped row");
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Visibility.Declaration_Scope_Completion");
      return Row;
   end Base_Row;
   ...
   begin
      Assert (Feed_Item.Status = Status, "unexpected case 1354 status");
      Assert (Audit.Expected_For_Status (Feed_Item.Status) = Expected,
              "unexpected case 1354 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Visibility.Declaration_Scope_Completion;
