...
with Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master;

package body Test_Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master is

     package Audit renames Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master;
   ...
   use type Audit.Remediation_Model;
     ...
     begin
        ...
        Row.Candidate_Implementing_Package :=
          To_Unbounded_String ("Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master");
        Row.Candidate_Case := To_Unbounded_String ("Case 1409");
     ...
     begin
        Assert (Item.Status = Status, "unexpected case 1409 status");
        Assert (Audit.Expected_For_Status (Item.Status) = Expected,
                "unexpected case 1409 precision classification");
     end Expect_Status;
     ...
     begin
        ...
        Assert (Audit.Gap_Remediated (Results), "case 1409 should close the access parameter allocator master gap");
...
end Test_Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master;
