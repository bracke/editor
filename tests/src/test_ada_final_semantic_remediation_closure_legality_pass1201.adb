...
package body Test_Ada_Final_Semantic_Remediation_Closure_Legality_Pass1201 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Remediation_Closure_Legality_Pass1201");
   end Name;
...
end Test_Ada_Final_Semantic_Remediation_Closure_Legality_Pass1201;
