...
with Editor.Ada_Legality.Tasking.Repair_Protected;

package body Test_Ada_Legality.Tasking.Protected_Legality is

   package TP renames Editor.Ada_Legality.Tasking.Repair_Protected;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Tasking.Protected_Legality");
   end Name;
...
end Test_Ada_Legality.Tasking.Protected_Legality;
