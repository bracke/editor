...
package body Test_Ada_Generic_Shared_State_RM_Completion_Diagnostic_Integration_Pass1256 is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion diagnostic integration pass1256");
   end Name;
...
end Test_Ada_Generic_Shared_State_RM_Completion_Diagnostic_Integration_Pass1256;
