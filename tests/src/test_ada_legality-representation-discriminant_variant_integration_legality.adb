...
package body Test_Ada_Legality.Representation.Discriminant_Variant_Integration_Legality is

   package Consumer renames Editor.Ada_Legality.Representation.Discriminant_Variant_Integration_Legality;
   ...
   package Disc_Generic renames Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Discriminant_Variant_Integration_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Discriminant_Variant_Integration_Legality;
