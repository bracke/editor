...
package body Test_Ada_Renaming_Alias_Vertical_Slice_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Renaming_Alias_Vertical_Slice_Legality");
   end Name;
...
end Test_Ada_Renaming_Alias_Vertical_Slice_Legality;
