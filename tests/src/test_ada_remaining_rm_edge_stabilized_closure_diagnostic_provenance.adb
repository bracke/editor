...
package body Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Diagnostic_Provenance is
...
end Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Diagnostic_Provenance;
