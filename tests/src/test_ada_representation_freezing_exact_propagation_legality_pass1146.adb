...
package body Test_Ada_Representation_Freezing_Exact_Propagation_Legality_Pass1146 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Representation_Freezing_Exact_Propagation_Legality_Pass1146");
   end Name;
