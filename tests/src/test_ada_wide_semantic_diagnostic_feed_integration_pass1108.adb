...
package body Test_Ada_Wide_Semantic_Diagnostic_Feed_Integration_Pass1108 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Wide_Semantic_Diagnostic_Feed_Integration_Pass1108");
   end Name;
...
end Test_Ada_Wide_Semantic_Diagnostic_Feed_Integration_Pass1108;
