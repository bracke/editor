...
package body Test_Ada_Diagnostic_Provenance_Overload_Ranking_Pass1073 is

   function Name (T : Test_Case) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Test_Ada_Diagnostic_Provenance_Overload_Ranking_Pass1073");
   end Name;
...
end Test_Ada_Diagnostic_Provenance_Overload_Ranking_Pass1073;
