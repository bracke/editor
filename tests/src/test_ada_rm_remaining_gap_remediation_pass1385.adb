...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1385 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1385");
   end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1385;
