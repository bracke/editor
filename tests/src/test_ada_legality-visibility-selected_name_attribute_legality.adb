...
with Editor.Ada_Legality.Visibility.Selected_Name_Attribute_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Visibility.Selected_Name_Attribute_Legality is

   package SA renames Editor.Ada_Legality.Visibility.Selected_Name_Attribute_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Visibility.Selected_Name_Attribute_Legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Selected_Name_Attribute_Legality;
