...
package body Test_Ada_Integrated_Semantic_Diagnostic_Feed_Pass1119 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Semantic_Diagnostic_Feed_Pass1119");
   end Name;
...
end Test_Ada_Integrated_Semantic_Diagnostic_Feed_Pass1119;
