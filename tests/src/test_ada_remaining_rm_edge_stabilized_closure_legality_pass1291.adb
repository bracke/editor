...
package body Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Legality_Pass1291 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge stabilized closure legality pass1291");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Stabilized_Closure_Legality_Pass1291;
