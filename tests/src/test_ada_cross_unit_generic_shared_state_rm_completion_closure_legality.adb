...
package body Test_Ada_Cross_Unit_Generic_Shared_State_RM_Completion_Closure_Legality is
...
end Test_Ada_Cross_Unit_Generic_Shared_State_RM_Completion_Closure_Legality;
