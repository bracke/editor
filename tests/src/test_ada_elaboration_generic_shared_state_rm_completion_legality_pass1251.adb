...
package body Test_Ada_Elaboration_Generic_Shared_State_RM_Completion_Legality_Pass1251 is
   ...
   begin
      return AUnit.Format ("Ada elaboration generic shared-state RM completion legality pass1251");
   end Name;
...
end Test_Ada_Elaboration_Generic_Shared_State_RM_Completion_Legality_Pass1251;
