...
with Editor.Command_Surface.Build_Surface_Tests;
with Editor.Command_Surface.Lifecycle_Surface_Tests;
with Editor.Command_Surface.Product_Surface_Tests;
with Editor.Command_Surface.Public_Build_Freeze_Tests;
with Editor.Command_Surface.Public_Build_Guardrail_Tests;
with Editor.Command_Surface.Public_Build_Guardrail_Contract_Tests;
with Editor.Command_Surface.Public_Build_Guardrail_Manifest_Tests;
with Editor.Command_Surface.Public_Build_Input_Tests;
with Editor.Command_Surface.Public_Build_Surface_Tests;
with Editor.Command_Surface.Route_Audit_Tests;
...
package body Editor_UI_Suite is
   ...
   begin
      ...
      Ret.Add_Test (new Editor.Command_Surface.Build_Surface_Tests.Build_Surface_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Lifecycle_Surface_Tests.Lifecycle_Surface_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Product_Surface_Tests.Product_Surface_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Freeze_Tests.Public_Build_Freeze_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Guardrail_Tests.Public_Build_Guardrail_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Guardrail_Contract_Tests.Public_Build_Guardrail_Contract_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Guardrail_Manifest_Tests.Public_Build_Guardrail_Manifest_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Input_Tests.Public_Build_Input_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Public_Build_Surface_Tests.Public_Build_Surface_Test_Case);
      Ret.Add_Test (new Editor.Command_Surface.Route_Audit_Tests.Route_Audit_Test_Case);
