...
with Editor.Ada_Legality.Representation.Discriminant_Variant_Record_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Representation.Discriminant_Variant_Record_Legality is

   package DV renames Editor.Ada_Legality.Representation.Discriminant_Variant_Record_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Discriminant_Variant_Record_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Discriminant_Variant_Record_Legality;
