...
package body Test_Ada_Integrated_Closure_Refined_Global_Depends_Pass1154 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_Refined_Global_Depends_Pass1154");
   end Name;
...
end Test_Ada_Integrated_Closure_Refined_Global_Depends_Pass1154;
