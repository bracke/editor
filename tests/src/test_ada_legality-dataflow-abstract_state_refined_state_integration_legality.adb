...
package body Test_Ada_Legality.Dataflow.Abstract_State_Refined_State_Integration_Legality is

   package Registration renames AUnit.Test_Cases.Registration;
   package C renames Editor.Ada_Legality.Dataflow.Abstract_State_Refined_State_Integration_Legality;
   ...
   begin
      return AUnit.Format ("Ada abstract/refined state consumer integration legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Abstract_State_Refined_State_Integration_Legality;
