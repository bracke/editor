...
package body Test_Ada_Phase579_Documentation_Handoff is
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Documentation_Handoff");
   end Name;
...
end Test_Ada_Phase579_Documentation_Handoff;
