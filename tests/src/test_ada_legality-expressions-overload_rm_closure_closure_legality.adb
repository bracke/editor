...
package body Test_Ada_Legality.Expressions.Overload_RM_Closure_Closure_Legality is

   package O renames Editor.Ada_Legality.Expressions.Overload_RM_Closure_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada overload RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Expressions.Overload_RM_Closure_Closure_Legality;
