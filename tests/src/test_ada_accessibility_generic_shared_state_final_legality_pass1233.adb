...
package body Test_Ada_Accessibility_Generic_Shared_State_Final_Legality_Pass1233 is
   ...
   begin
      return AUnit.Format ("Ada accessibility/generic shared-state final legality pass1233");
   end Name;
...
end Test_Ada_Accessibility_Generic_Shared_State_Final_Legality_Pass1233;
