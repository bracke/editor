...
package body Test_Ada_Dispatching_Global_Refinement_Legality_Pass1226 is
   ...
   begin
      return AUnit.Format ("Ada dispatching Global/Depends refinement legality pass1226");
   end Name;
...
end Test_Ada_Dispatching_Global_Refinement_Legality_Pass1226;
