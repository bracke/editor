...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality is
   ...
   package Gate renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality;
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality;
