...
package body Test_Ada_Shared_State_Stabilized_Closure_Legality_Pass1223 is
   ...
   begin
      return AUnit.Format ("Ada shared-state stabilized closure legality pass1223");
   end Name;
...
end Test_Ada_Shared_State_Stabilized_Closure_Legality_Pass1223;
