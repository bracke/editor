...
package body Test_Ada_Legality.Dataflow.Generic_Shared_State_Final_Repair_Worklist_Legality is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state final remediation worklist legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Generic_Shared_State_Final_Repair_Worklist_Legality;
