...
package body Test_Ada_Legality.Accessibility.Scope_Legality is
   ...
   package Disc_Gen renames Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Accessibility.Scope_Legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Scope_Legality;
