...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1389 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1389");
   end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1389;
