...
with Editor.Ada_Legality.Elaboration.Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Elaboration.Legality is

   package EL renames Editor.Ada_Legality.Elaboration.Legality;
   use type EL.Unit_Id;
   use type EL.Edge_Id;
   use type EL.Call_Id;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Elaboration.Legality");
   end Name;
...
end Test_Ada_Legality.Elaboration.Legality;
