...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1410 is
   ...
   use type Audit.Remediation_Model;
     ...
     begin
        return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1410");
     end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1410;
