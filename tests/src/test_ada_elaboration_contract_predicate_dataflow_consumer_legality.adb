...
package body Test_Ada_Elaboration_Contract_Predicate_Dataflow_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Contract_Predicate_Dataflow_Consumer_Legality");
   end Name;
...
end Test_Ada_Elaboration_Contract_Predicate_Dataflow_Consumer_Legality;
