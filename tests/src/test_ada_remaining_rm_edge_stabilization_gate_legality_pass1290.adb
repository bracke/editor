...
package body Test_Ada_Remaining_RM_Edge_Stabilization_Gate_Legality_Pass1290 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge stabilization gate legality pass1290");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Stabilization_Gate_Legality_Pass1290;
