...
package body Test_Ada_Definite_Initialization_Object_Flow_Consumer_Legality_Pass1164 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Definite_Initialization_Object_Flow_Consumer_Legality_Pass1164");
   end Name;
...
end Test_Ada_Definite_Initialization_Object_Flow_Consumer_Legality_Pass1164;
