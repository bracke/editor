...
with Editor.Ada_RM_Remediation.Expressions.Loop_Range_Iterator;

package body Test_Ada_RM_Remediation.Expressions.Loop_Range_Iterator is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Loop_Range_Iterator;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Loop_Range_Iterator");
      Row.Candidate_Case := To_Unbounded_String ("Case 1405");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1405 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1405 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1405 should close the discrete loop/iterator range gap");
...
end Test_Ada_RM_Remediation.Expressions.Loop_Range_Iterator;
