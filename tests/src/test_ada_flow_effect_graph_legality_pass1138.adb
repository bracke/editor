...
package body Test_Ada_Flow_Effect_Graph_Legality_Pass1138 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Flow_Effect_Graph_Legality_Pass1138");
   end Name;
...
end Test_Ada_Flow_Effect_Graph_Legality_Pass1138;
