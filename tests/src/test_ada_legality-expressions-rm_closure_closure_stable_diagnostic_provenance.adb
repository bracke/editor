...
package body Test_Ada_Legality.Expressions.RM_Closure_Closure_Stable_Diagnostic_Provenance is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer stabilized diagnostic provenance");
   end Name;
   ...
   begin
      ...
      Assert (Prov.Error_Count (Model) >= 4,
...
end Test_Ada_Legality.Expressions.RM_Closure_Closure_Stable_Diagnostic_Provenance;
