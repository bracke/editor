...
package body Editor.Syntax_Semantics.Generic_Cross_Unit_Tests is


   overriding function Name (T : Generic_Cross_Unit_Test_Case) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Editor.Syntax_Semantics.Generic_Cross_Unit");
   end Name;

   overriding procedure Register_Tests (T : in out Generic_Cross_Unit_Test_Case) is
