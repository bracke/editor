...
package body Test_Ada_RM_Remediation.Calls.Access_Subprogram_Defaulted_Formals is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1404 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1404 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1404 should close the access-subprogram/convention/default gap");
...
end Test_Ada_RM_Remediation.Calls.Access_Subprogram_Defaulted_Formals;
