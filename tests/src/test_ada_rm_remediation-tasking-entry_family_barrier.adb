...
package body Test_Ada_RM_Remediation.Tasking.Entry_Family_Barrier is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1418 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1418 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1418 should close the entry-family barrier/index gap");
...
end Test_Ada_RM_Remediation.Tasking.Entry_Family_Barrier;
