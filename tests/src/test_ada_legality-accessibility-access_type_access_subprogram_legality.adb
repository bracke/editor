...
with Editor.Ada_Legality.Accessibility.Access_Type_Access_Subprogram_Legality;

package body Test_Ada_Legality.Accessibility.Access_Type_Access_Subprogram_Legality is

   package AL renames Editor.Ada_Legality.Accessibility.Access_Type_Access_Subprogram_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Accessibility.Access_Type_Access_Subprogram_Legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Access_Type_Access_Subprogram_Legality;
