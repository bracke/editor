...
package body Test_Ada_Refined_Global_Depends_Conformance_Legality_Pass1153 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Refined_Global_Depends_Conformance_Legality_Pass1153");
   end Name;
...
end Test_Ada_Refined_Global_Depends_Conformance_Legality_Pass1153;
