...
package body Test_Ada_Contract_Flow_Refinement_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Contract_Flow_Refinement_Consumer_Legality");
   end Name;
...
end Test_Ada_Contract_Flow_Refinement_Consumer_Legality;
