...
with Editor.Ada_RM_Gap_Burn_Down_Pass1363;

package body Test_Ada_RM_Gap_Burn_Down_Pass1363 is

   package Audit renames Editor.Ada_RM_Gap_Burn_Down_Pass1363;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Gap_Burn_Down_Pass1363");
   end Name;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Gap_Burn_Down_Pass1363");
      return Row;
   end Base_Row;
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1363 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1363 classification");
   end Expect_Status;
   ...
   begin
      ...
      Row := Base_Row
        (3, Precision.Class_Legal, Audit.Source_Open_Buffer,
...
end Test_Ada_RM_Gap_Burn_Down_Pass1363;
