...
with Editor.Ada_Legality.Accessibility.Scope_Legality;
...
package body Test_Ada_Legality.Accessibility.Master_Scope_Final_Legality is

   package Final renames Editor.Ada_Legality.Accessibility.Master_Scope_Final_Legality;
   ...
   package Scope renames Editor.Ada_Legality.Accessibility.Scope_Legality;
   ...
   package Flow renames Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Accessibility.Master_Scope_Final_Legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Master_Scope_Final_Legality;
