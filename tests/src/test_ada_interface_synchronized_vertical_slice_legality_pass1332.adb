...
package body Test_Ada_Interface_Synchronized_Vertical_Slice_Legality_Pass1332 is
   ...
   begin
      return AUnit.Format
        ("Test_Ada_Interface_Synchronized_Vertical_Slice_Legality_Pass1332");
   end Name;
...
end Test_Ada_Interface_Synchronized_Vertical_Slice_Legality_Pass1332;
