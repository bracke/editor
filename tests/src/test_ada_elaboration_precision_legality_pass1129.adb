...
package body Test_Ada_Elaboration_Precision_Legality_Pass1129 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Precision_Legality_Pass1129");
   end Name;
...
end Test_Ada_Elaboration_Precision_Legality_Pass1129;
