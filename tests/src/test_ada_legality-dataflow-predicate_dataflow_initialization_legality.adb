...
package body Test_Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality is

   package PDC renames Editor.Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality;
