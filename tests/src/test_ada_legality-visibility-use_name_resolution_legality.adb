...
with Editor.Ada_Legality.Visibility.Use_Name_Resolution_Legality;

package body Test_Ada_Legality.Visibility.Use_Name_Resolution_Legality is

   package VN renames Editor.Ada_Legality.Visibility.Use_Name_Resolution_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Visibility.Use_Name_Resolution_Legality");
   end Name;
...
end Test_Ada_Legality.Visibility.Use_Name_Resolution_Legality;
