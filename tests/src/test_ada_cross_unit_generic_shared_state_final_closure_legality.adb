...
package body Test_Ada_Cross_Unit_Generic_Shared_State_Final_Closure_Legality is
   ...
   begin
      return AUnit.Format ("Ada cross-unit generic shared-state final closure legality");
   end Name;
...
end Test_Ada_Cross_Unit_Generic_Shared_State_Final_Closure_Legality;
