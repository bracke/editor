...
package body Test_Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit is

   package Audit renames Editor.Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit;
