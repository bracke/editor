...
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Eligibility;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Application;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Convergence;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Stabilization;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Closure;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Stable_Closure_Legality is

   package D renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
   ...
   package Diag renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
   ...
   package W renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist;
   ...
   package R renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Eligibility;
   ...
   package A renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Application;
   ...
   package C renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Convergence;
   ...
   package S renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Stabilization;
   ...
   package Z renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Closure;
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion stabilized closure");
   end Name;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Stable_Closure_Legality;
