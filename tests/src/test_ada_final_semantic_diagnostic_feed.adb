...
package body Test_Ada_Final_Semantic_Diagnostic_Feed is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Diagnostic_Feed");
   end Name;
...
end Test_Ada_Final_Semantic_Diagnostic_Feed;
