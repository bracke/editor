...
package body Test_Ada_Remaining_RM_Edge_Recheck_Application_Legality_Pass1288 is
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge recheck application legality pass1288");
   end Name;
...
end Test_Ada_Remaining_RM_Edge_Recheck_Application_Legality_Pass1288;
