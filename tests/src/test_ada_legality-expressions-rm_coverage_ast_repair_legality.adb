...
with Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Search_Index;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.RM_Coverage_AST_Repair_Legality is

   package Repair renames Editor.Ada_Legality.Expressions.RM_Coverage_AST_Repair_Legality;
   ...
   package Search renames Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Search_Index;
   ...
   begin
      return AUnit.Format ("Ada remaining RM edge coverage-proven AST repair legality");
   end Name;
...
end Test_Ada_Legality.Expressions.RM_Coverage_AST_Repair_Legality;
