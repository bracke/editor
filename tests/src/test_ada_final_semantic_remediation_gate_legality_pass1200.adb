...
package body Test_Ada_Final_Semantic_Remediation_Gate_Legality_Pass1200 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Remediation_Gate_Legality_Pass1200");
   end Name;
...
end Test_Ada_Final_Semantic_Remediation_Gate_Legality_Pass1200;
