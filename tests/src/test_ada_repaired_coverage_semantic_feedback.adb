...
package body Test_Ada_Repaired_Coverage_Semantic_Feedback is
   ...
   begin
      return AUnit.Format ("Test_Ada_Repaired_Coverage_Semantic_Feedback");
   end Name;
...
end Test_Ada_Repaired_Coverage_Semantic_Feedback;
