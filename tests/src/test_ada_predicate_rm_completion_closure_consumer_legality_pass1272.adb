...
package body Test_Ada_Predicate_RM_Completion_Closure_Consumer_Legality_Pass1272 is

   package R renames Editor.Ada_Predicate_RM_Completion_Closure_Consumer_Legality;
   ...
   begin
      return AUnit.Format ("Ada predicate/invariant RM-completion closure consumer pass1272");
   end Name;
...
end Test_Ada_Predicate_RM_Completion_Closure_Consumer_Legality_Pass1272;
