...
with Editor.Ada_RM_Remediation.Visibility.Cross_Unit_Context_Closure;

package body Test_Ada_RM_Remediation.Visibility.Cross_Unit_Context_Closure is

   package Audit renames Editor.Ada_RM_Remediation.Visibility.Cross_Unit_Context_Closure;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Visibility.Cross_Unit_Context_Closure");
...
end Test_Ada_RM_Remediation.Visibility.Cross_Unit_Context_Closure;
