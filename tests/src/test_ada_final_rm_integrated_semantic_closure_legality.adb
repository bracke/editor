...
package body Test_Ada_Final_RM_Integrated_Semantic_Closure_Legality is
   ...
   begin
      return AUnit.Format ("Ada final RM integrated semantic closure legality");
   end Name;
...
end Test_Ada_Final_RM_Integrated_Semantic_Closure_Legality;
