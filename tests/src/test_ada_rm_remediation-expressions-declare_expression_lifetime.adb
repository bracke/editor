...
package body Test_Ada_RM_Remediation.Expressions.Declare_Expression_Lifetime is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1395 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1395 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1395 should close the declare expression object lifetime gap");
...
end Test_Ada_RM_Remediation.Expressions.Declare_Expression_Lifetime;
