...
package body Test_Ada_Renaming_Alias_Visibility_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Renaming_Alias_Visibility_Legality");
   end Name;
   ...
   begin
      ...
      begin
         ...
         Assert (RAV.Count_Renamed_Kind (Model, RAV.Renamed_Entity_Package) = 2,
...
end Test_Ada_Renaming_Alias_Visibility_Legality;
