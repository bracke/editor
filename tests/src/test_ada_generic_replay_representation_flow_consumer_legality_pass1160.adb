...
package body Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality_Pass1160 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality_Pass1160");
   end Name;
...
end Test_Ada_Generic_Replay_Representation_Flow_Consumer_Legality_Pass1160;
