...
package body Test_Ada_Predicate_Dataflow_Initialization_Consumer_Legality_Pass1166 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Predicate_Dataflow_Initialization_Consumer_Legality_Pass1166");
   end Name;
