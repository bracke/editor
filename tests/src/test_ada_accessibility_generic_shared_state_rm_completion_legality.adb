...
package body Test_Ada_Accessibility_Generic_Shared_State_RM_Completion_Legality is
...
end Test_Ada_Accessibility_Generic_Shared_State_RM_Completion_Legality;
