...
package body Test_Ada_Final_Semantic_Recheck_Convergence_Legality_Pass1207 is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Recheck_Convergence_Legality_Pass1207");
   end Name;
...
end Test_Ada_Final_Semantic_Recheck_Convergence_Legality_Pass1207;
