...
with Editor.Ada_RM_Remediation.Calls.Expression_Function_Contracts;

package body Test_Ada_RM_Remediation.Calls.Expression_Function_Contracts is

   package Audit renames Editor.Ada_RM_Remediation.Calls.Expression_Function_Contracts;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Calls.Expression_Function_Contracts");
      Row.Candidate_Case := To_Unbounded_String ("Case 1397");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1397 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1397 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1397 should close the expression function contract return gap");
...
end Test_Ada_RM_Remediation.Calls.Expression_Function_Contracts;
