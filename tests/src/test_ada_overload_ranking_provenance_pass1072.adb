...
package body Test_Ada_Overload_Ranking_Provenance_Pass1072 is

   function Name (T : Test_Case) return AUnit.Message_String is
      pragma Unreferenced (T);
   begin
      return AUnit.Format ("Test_Ada_Overload_Ranking_Provenance_Pass1072");
   end Name;
...
end Test_Ada_Overload_Ranking_Provenance_Pass1072;
