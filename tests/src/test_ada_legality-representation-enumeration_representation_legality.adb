...
with Editor.Ada_Legality.Representation.Enumeration_Representation_Legality;

package body Test_Ada_Legality.Representation.Enumeration_Representation_Legality is

   package ER renames Editor.Ada_Legality.Representation.Enumeration_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Enumeration_Representation_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Enumeration_Representation_Legality;
