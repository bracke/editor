...
package body Test_Ada_Generic_Shared_State_RM_Completion_Recheck_Convergence_Legality is
...
end Test_Ada_Generic_Shared_State_RM_Completion_Recheck_Convergence_Legality;
