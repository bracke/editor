...
package body Test_Ada_RM_Remediation.Elaboration.Imported_Subprogram_Preelaboration is
...
end Test_Ada_RM_Remediation.Elaboration.Imported_Subprogram_Preelaboration;
