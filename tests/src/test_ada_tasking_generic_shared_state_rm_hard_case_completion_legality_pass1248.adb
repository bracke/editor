...
package body Test_Ada_Tasking_Generic_Shared_State_RM_Hard_Case_Completion_Legality_Pass1248 is
   ...
   begin
      return AUnit.Format ("Ada tasking generic shared-state RM hard-case completion legality pass1248");
   end Name;
