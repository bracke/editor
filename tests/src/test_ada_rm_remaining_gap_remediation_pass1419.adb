...
package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1419 is
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1419");
   end Name;
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1419;
