...
package body Test_Ada_Accessibility_Scope_Graph_Legality_Pass1143 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Accessibility_Scope_Graph_Legality_Pass1143");
   end Name;
...
end Test_Ada_Accessibility_Scope_Graph_Legality_Pass1143;
