...
package body Test_Ada_Legality.Expressions.Integrated_Closure_Semantic_Chain is
   ...
   package Bridge renames Editor.Ada_Integrated_Semantic_Closure.Chain;
   ...
   package GRR renames Editor.Ada_Legality.Representation.Generic_Replay_Representation_Contract_Predicate_Dataflow_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Integrated_Closure_Semantic_Chain");
   end Name;
...
end Test_Ada_Legality.Expressions.Integrated_Closure_Semantic_Chain;
