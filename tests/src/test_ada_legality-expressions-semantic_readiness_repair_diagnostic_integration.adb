...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Integration is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Integration");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Integration;
