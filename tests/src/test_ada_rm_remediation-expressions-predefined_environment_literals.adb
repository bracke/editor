...
package body Test_Ada_RM_Remediation.Expressions.Predefined_Environment_Literals is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1358 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1358 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Expressions.Predefined_Environment_Literals;
