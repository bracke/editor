...
package body Test_Ada_Discriminant_Dependent_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Discriminant_Dependent_Legality");
   end Name;
...
end Test_Ada_Discriminant_Dependent_Legality;
