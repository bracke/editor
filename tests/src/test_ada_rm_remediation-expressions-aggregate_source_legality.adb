...
with Editor.Ada_RM_Remediation.Expressions.Aggregate_Source_Legality;

package body Test_Ada_RM_Remediation.Expressions.Aggregate_Source_Legality is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Aggregate_Source_Legality;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Aggregate_Source_Legality");
...
end Test_Ada_RM_Remediation.Expressions.Aggregate_Source_Legality;
