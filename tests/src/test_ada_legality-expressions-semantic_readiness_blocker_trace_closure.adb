...
package body Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure is
   ...
   begin
      return Format ("Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure");
   end Name;
...
end Test_Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure;
