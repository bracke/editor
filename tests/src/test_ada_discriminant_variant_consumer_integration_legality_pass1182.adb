...
package body Test_Ada_Discriminant_Variant_Consumer_Integration_Legality_Pass1182 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Discriminant_Variant_Consumer_Integration_Legality_Pass1182");
   end Name;
...
end Test_Ada_Discriminant_Variant_Consumer_Integration_Legality_Pass1182;
