...
with Editor.Ada_Legality.Expressions.Exception_Finalization_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Exception_Finalization_Legality is

   package EF renames Editor.Ada_Legality.Expressions.Exception_Finalization_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Exception_Finalization_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Exception_Finalization_Legality;
