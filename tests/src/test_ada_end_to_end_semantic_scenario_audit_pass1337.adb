...
package body Test_Ada_End_To_End_Semantic_Scenario_Audit_Pass1337 is
   ...
   begin
      return AUnit.Format ("Test_Ada_End_To_End_Semantic_Scenario_Audit_Pass1337");
   end Name;
...
end Test_Ada_End_To_End_Semantic_Scenario_Audit_Pass1337;
