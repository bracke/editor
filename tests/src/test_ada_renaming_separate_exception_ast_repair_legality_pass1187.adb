...
package body Test_Ada_Renaming_Separate_Exception_AST_Repair_Legality_Pass1187 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Renaming_Separate_Exception_AST_Repair_Legality_Pass1187");
   end Name;
...
end Test_Ada_Renaming_Separate_Exception_AST_Repair_Legality_Pass1187;
