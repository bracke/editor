...
with Editor.Ada_Phase579_Diagnostic_Quality_Validation_Pass1435;

package body Test_Ada_Phase579_Diagnostic_Quality_Validation_Pass1435 is
   package Diag renames Editor.Ada_Phase579_Diagnostic_Quality_Validation_Pass1435;
   ...
   begin
      return AUnit.Format ("Test_Ada_Phase579_Diagnostic_Quality_Validation_Pass1435");
   end Name;
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1435 diagnostic status");
      Assert (Item.Result_Class = Result_Class,
              "unexpected pass1435 diagnostic result class");
   ...
   begin
      ...
      Assert (Model.Accepted_Count = 6, "all quality scenarios accepted");
   ...
   begin
      Register_Routine (T, Test_Diagnostic_Quality_Scenarios_Accepted'Access,
                        "pass1435 accepts precise diagnostic quality scenarios");
      Register_Routine (T, Test_Source_Span_Blocker_Severity_And_Duplicate_Rejections'Access,
                        "pass1435 rejects source span, family, severity, and duplicate defects");
      Register_Routine (T, Test_Final_State_Consumer_And_Gap_Rejections'Access,
                        "pass1435 rejects misleading final state, consumer, and gap defects");
      Register_Routine (T, Test_Stale_And_Missing_Evidence_Rejections'Access,
                        "pass1435 rejects stale or missing diagnostic evidence");
   end Register_Tests;

end Test_Ada_Phase579_Diagnostic_Quality_Validation_Pass1435;
