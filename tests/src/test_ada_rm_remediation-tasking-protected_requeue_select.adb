...
with Editor.Ada_RM_Remediation.Tasking.Protected_Requeue_Select;

package body Test_Ada_RM_Remediation.Tasking.Protected_Requeue_Select is

   package Audit renames Editor.Ada_RM_Remediation.Tasking.Protected_Requeue_Select;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Tasking.Protected_Requeue_Select");
      Row.Candidate_Case := To_Unbounded_String ("Case 1380");
      Row.Blocker_Family :=
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1380 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1380 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1380 should close the selected protected/requeue/select gap");
...
end Test_Ada_RM_Remediation.Tasking.Protected_Requeue_Select;
