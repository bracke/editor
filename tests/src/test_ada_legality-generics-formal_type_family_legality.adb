...
with Editor.Ada_Legality.Generics.Formal_Type_Family_Legality;

package body Test_Ada_Legality.Generics.Formal_Type_Family_Legality is

   package GF renames Editor.Ada_Legality.Generics.Formal_Type_Family_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Generics.Formal_Type_Family_Legality");
   end Name;
   ...
   begin
      ...
      Add_Actual (Actuals, 2, 2, GF.Actual_Tagged, "Untagged_Private");
...
end Test_Ada_Legality.Generics.Formal_Type_Family_Legality;
