...
package body Test_Ada_Legality.Tasking.RM_Closure_Closure_Legality is

   package R renames Editor.Ada_Legality.Tasking.Repair_RM_Closure_Closure;
   ...
   begin
      return AUnit.Format ("Ada tasking/protected RM-completion closure consumer");
   end Name;
...
end Test_Ada_Legality.Tasking.RM_Closure_Closure_Legality;
