...
package body Test_Ada_Legality.Dataflow.Flow_Refinement_Integration_Legality is
   ...
   package Consumer renames Editor.Ada_Legality.Dataflow.Flow_Refinement_Integration_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Dataflow.Flow_Refinement_Integration_Legality");
   end Name;
...
end Test_Ada_Legality.Dataflow.Flow_Refinement_Integration_Legality;
