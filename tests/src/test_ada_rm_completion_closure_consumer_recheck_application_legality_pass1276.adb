...
package body Test_Ada_RM_Completion_Closure_Consumer_Recheck_Application_Legality_Pass1276 is
   ...
   begin
      return AUnit.Format ("Ada RM-completion closure consumer recheck application pass1276");
   end Name;
...
end Test_Ada_RM_Completion_Closure_Consumer_Recheck_Application_Legality_Pass1276;
