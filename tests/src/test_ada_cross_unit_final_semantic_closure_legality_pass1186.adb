...
package body Test_Ada_Cross_Unit_Final_Semantic_Closure_Legality_Pass1186 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Cross_Unit_Final_Semantic_Closure_Legality_Pass1186");
   end Name;
...
end Test_Ada_Cross_Unit_Final_Semantic_Closure_Legality_Pass1186;
