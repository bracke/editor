...
package body Test_Ada_RM_Remediation.Calls.Anonymous_Access_Result_Profile is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1412 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1412 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1412 should close the anonymous access return profile gap");
