...
package body Test_Ada_Canonical_Semantic_Model_Agreement_Audit_Pass1336 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Canonical_Semantic_Model_Agreement_Audit_Pass1336");
   end Name;
...
end Test_Ada_Canonical_Semantic_Model_Agreement_Audit_Pass1336;
