...
with Editor.Ada_RM_Remediation.Expressions.Numeric_Model_Predefined_Operations;

package body Test_Ada_RM_Remediation.Expressions.Numeric_Model_Predefined_Operations is

   package Audit renames Editor.Ada_RM_Remediation.Expressions.Numeric_Model_Predefined_Operations;
   ...
   begin
      ...
      Row.Name := To_Unbounded_String
        ("case 1357 source-shaped predefined operation numeric row");
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Expressions.Numeric_Model_Predefined_Operations");
      return Row;
   end Base_Row;
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1357 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1357 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Expressions.Numeric_Model_Predefined_Operations;
