...
package body Test_Ada_Coverage_Proven_RM_Completion_AST_Repair_Legality_Pass1258 is
   ...
   begin
      return AUnit.Format ("Ada coverage-proven RM-completion AST repair legality pass1258");
   end Name;
...
end Test_Ada_Coverage_Proven_RM_Completion_AST_Repair_Legality_Pass1258;
