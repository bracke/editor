...
package body Test_Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality is
   ...
   package Disc_Consumer renames Editor.Ada_Legality.Representation.Discriminant_Variant_Integration_Legality;
   ...
   package Elab_Final renames Editor.Ada_Legality.Elaboration.Graph_Final_Legality;
   ...
   package Final_Rep renames Editor.Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality;
   ...
   package Rep_CPD renames Editor.Ada_Legality.Tasking.Representation_Tasking_Contract_Predicate_Dataflow_Legality;
   ...
   package Task_Final renames Editor.Ada_Legality.Tasking.Repair_Protected_Final_Effects;
   ...
   begin
      return Format ("Test_Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality;
