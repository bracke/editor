...
with Editor.Ada_Legality.Expressions.Aggregate_Legality;

package body Test_Ada_Legality.Expressions.Aggregate_Legality is

   package AL renames Editor.Ada_Legality.Expressions.Aggregate_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Aggregate_Legality");
   end Name;
...
end Test_Ada_Legality.Expressions.Aggregate_Legality;
