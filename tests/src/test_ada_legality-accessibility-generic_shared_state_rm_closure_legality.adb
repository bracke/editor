...
package body Test_Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality is

   package Registration renames AUnit.Test_Cases.Registration;
   package C renames Editor.Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality;
   ...
   begin
      return AUnit.Format ("Ada accessibility generic shared-state RM completion legality");
   end Name;
...
end Test_Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality;
