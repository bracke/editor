...
package body Test_Ada_Coverage_Gated_Semantic_Results_Pass1136 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Coverage_Gated_Semantic_Results_Pass1136");
   end Name;
...
end Test_Ada_Coverage_Gated_Semantic_Results_Pass1136;
