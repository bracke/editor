...
package body Test_Ada_Elaboration_Dependence_Legality_Pass1113 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Elaboration_Dependence_Legality_Pass1113");
   end Name;
...
end Test_Ada_Elaboration_Dependence_Legality_Pass1113;
