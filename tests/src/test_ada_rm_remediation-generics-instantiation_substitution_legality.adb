...
with Editor.Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality;

package body Test_Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality is

   package Audit renames Editor.Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality");
...
end Test_Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality;
