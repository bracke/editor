...
procedure Ada_Parser_Outline_Tests is
   use type AUnit.Status;

   function Runner is new AUnit.Run.Test_Runner_With_Status (Ada_Parser_Outline_Suite.Suite);
