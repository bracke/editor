...
package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Stabilization_Gate_Legality is
   ...
   begin
      return AUnit.Format ("Ada generic shared-state RM completion stabilization gate");
   end Name;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Stabilization_Gate_Legality;
