...
package body Test_Ada_Callable_Profile_Conformance_Vertical_Slice_Legality_Pass1325 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Callable_Profile_Conformance_Vertical_Slice_Legality_Pass1325");
   end Name;
...
end Test_Ada_Callable_Profile_Conformance_Vertical_Slice_Legality_Pass1325;
