...
package body Test_Ada_RM_Remediation.Tagged_Types.Dispatching_Interface is
   ...
   begin
      Assert (Item.Status = Status, "unexpected case 1382 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected case 1382 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "case 1382 should close the selected dispatching/interface/effect gap");
...
end Test_Ada_RM_Remediation.Tagged_Types.Dispatching_Interface;
