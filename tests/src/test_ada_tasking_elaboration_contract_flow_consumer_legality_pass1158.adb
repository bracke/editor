...
package body Test_Ada_Tasking_Elaboration_Contract_Flow_Consumer_Legality_Pass1158 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Elaboration_Contract_Flow_Consumer_Legality_Pass1158");
   end Name;
...
end Test_Ada_Tasking_Elaboration_Contract_Flow_Consumer_Legality_Pass1158;
