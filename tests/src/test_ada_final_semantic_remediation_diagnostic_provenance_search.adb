...
package body Test_Ada_Final_Semantic_Remediation_Diagnostic_Provenance_Search is
   ...
   begin
      return Format ("Test_Ada_Final_Semantic_Remediation_Diagnostic_Provenance_Search");
   end Name;
...
end Test_Ada_Final_Semantic_Remediation_Diagnostic_Provenance_Search;
