...
package body Test_Ada_Renaming_Generic_Shared_State_Final_Legality_Pass1236 is
   ...
   begin
      return AUnit.Format ("Ada renaming generic shared-state final legality pass1236");
   end Name;
...
end Test_Ada_Renaming_Generic_Shared_State_Final_Legality_Pass1236;
