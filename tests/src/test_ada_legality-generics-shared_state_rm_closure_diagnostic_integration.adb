...
package body Test_Ada_Legality.Generics.Shared_State_RM_Closure_Diagnostic_Integration is
   ...
   package I renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
...
end Test_Ada_Legality.Generics.Shared_State_RM_Closure_Diagnostic_Integration;
