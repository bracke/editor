...
package body Test_Ada_Legality.Representation.Discriminant_Generic_Representation_Legality is
   ...
   package DG renames Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Representation.Discriminant_Generic_Representation_Legality");
   end Name;
...
end Test_Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
