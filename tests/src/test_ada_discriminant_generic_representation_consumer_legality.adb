...
package body Test_Ada_Discriminant_Generic_Representation_Consumer_Legality is
   ...
   begin
      return AUnit.Format ("Test_Ada_Discriminant_Generic_Representation_Consumer_Legality");
   end Name;
...
end Test_Ada_Discriminant_Generic_Representation_Consumer_Legality;
