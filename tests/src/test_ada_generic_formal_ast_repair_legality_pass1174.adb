...
package body Test_Ada_Generic_Formal_AST_Repair_Legality_Pass1174 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Generic_Formal_AST_Repair_Legality_Pass1174");
   end Name;
...
end Test_Ada_Generic_Formal_AST_Repair_Legality_Pass1174;
