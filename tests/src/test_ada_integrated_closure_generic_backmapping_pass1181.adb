...
package body Test_Ada_Integrated_Closure_Generic_Backmapping_Pass1181 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Integrated_Closure_Generic_Backmapping_Pass1181");
   end Name;
...
end Test_Ada_Integrated_Closure_Generic_Backmapping_Pass1181;
