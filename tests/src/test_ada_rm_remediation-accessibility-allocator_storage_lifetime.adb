...
package body Test_Ada_RM_Remediation.Accessibility.Allocator_Storage_Lifetime is
   ...
   begin
      Assert (Feed_Item.Status = Status, "unexpected case 1353 status");
      Assert (Audit.Expected_For_Status (Feed_Item.Status) = Expected,
              "unexpected case 1353 classification");
   end Expect_Status;
...
end Test_Ada_RM_Remediation.Accessibility.Allocator_Storage_Lifetime;
