...
with Editor.Ada_RM_Remaining_Gap_Remediation_Pass1420;

package body Test_Ada_RM_Remaining_Gap_Remediation_Pass1420 is
   package Audit renames Editor.Ada_RM_Remaining_Gap_Remediation_Pass1420;
   ...
   begin
      return AUnit.Format ("Test_Ada_RM_Remaining_Gap_Remediation_Pass1420");
   end Name;
   ...
   begin
      ...
      Row.Candidate_Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remaining_Gap_Remediation_Pass1420");
      Row.Candidate_Pass := To_Unbounded_String ("Pass1420");
   ...
   begin
      Assert (Item.Status = Status, "unexpected pass1420 status");
      Assert (Audit.Expected_For_Status (Item.Status) = Expected,
              "unexpected pass1420 precision classification");
   end Expect_Status;
   ...
   begin
      ...
      Assert (Audit.Gap_Remediated (Results),
              "pass1420 should close the volatile atomic representation clause gap");
...
end Test_Ada_RM_Remaining_Gap_Remediation_Pass1420;
