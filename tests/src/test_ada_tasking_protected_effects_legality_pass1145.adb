...
package body Test_Ada_Tasking_Protected_Effects_Legality_Pass1145 is
   ...
   begin
      return AUnit.Format ("Test_Ada_Tasking_Protected_Effects_Legality_Pass1145");
   end Name;
...
end Test_Ada_Tasking_Protected_Effects_Legality_Pass1145;
