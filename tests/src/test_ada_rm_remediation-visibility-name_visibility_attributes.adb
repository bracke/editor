...
with Editor.Ada_RM_Remediation.Visibility.Name_Visibility_Attributes;

package body Test_Ada_RM_Remediation.Visibility.Name_Visibility_Attributes is

   package Audit renames Editor.Ada_RM_Remediation.Visibility.Name_Visibility_Attributes;
   ...
   begin
      ...
      Row.Implementing_Package :=
        To_Unbounded_String ("Editor.Ada_RM_Remediation.Visibility.Name_Visibility_Attributes");
...
end Test_Ada_RM_Remediation.Visibility.Name_Visibility_Attributes;
