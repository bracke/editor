...
with Editor.Ada_Legality.Expressions.Membership_Case_Choice_Legality;
with Editor.Ada_Syntax_Tree;

package body Test_Ada_Legality.Expressions.Membership_Case_Choice_Legality is

   package MC renames Editor.Ada_Legality.Expressions.Membership_Case_Choice_Legality;
   ...
   begin
      return AUnit.Format ("Test_Ada_Legality.Expressions.Membership_Case_Choice_Legality");
   end Name;
   ...
   begin
      Add_Check (Model, 1, MC.Choice_Membership_Test,
                 ...
                 Choice => MC.Discrete_Not_Discrete,
      ...
      Assert
        (MC.Count_Status (Results, MC.Legality_Subject_Not_Discrete) = 1,
...
end Test_Ada_Legality.Expressions.Membership_Case_Choice_Legality;
