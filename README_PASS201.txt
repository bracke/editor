Editor Phase 579 IDE-grade Outline/Semantic Language Model — Pass 201
...
- Added AUnit regression marker/test:
  Test_Phase579_Declaration_Navigation_Availability_Rejects_Stale_Target
- Extended tools/phase579_language_validation_check.adb to require that test.
