...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Convergence is
   ...
   package Apply renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Application;
...
end Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Convergence;
