package body Editor.Ada_RM_Remediation.Finalization.Control_Flow_Exception_Closure is
...
end Editor.Ada_RM_Remediation.Finalization.Control_Flow_Exception_Closure;
