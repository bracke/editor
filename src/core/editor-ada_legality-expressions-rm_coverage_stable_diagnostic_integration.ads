...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Diagnostic_Integration is
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Diagnostic_Integration;
