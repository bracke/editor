...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Review_Application_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Review_Application_Legality;
