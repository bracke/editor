...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Stabilization is
   ...
   package Conv renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Convergence;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Stabilization;
