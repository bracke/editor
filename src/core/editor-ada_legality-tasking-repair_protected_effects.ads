...
package Editor.Ada_Legality.Tasking.Repair_Protected_Effects is
   ...
   package Precision renames Editor.Ada_Legality.Tasking.Repair_Protected_Precision;
...
end Editor.Ada_Legality.Tasking.Repair_Protected_Effects;
