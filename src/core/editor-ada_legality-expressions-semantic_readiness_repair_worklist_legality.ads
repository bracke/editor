...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Worklist_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Worklist_Legality;
