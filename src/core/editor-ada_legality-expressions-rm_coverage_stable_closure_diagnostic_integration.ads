...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Diagnostic_Integration is
   ...
   package Closure renames Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Legality_2;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Diagnostic_Integration;
