...
package Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality is
   ...
   package Contract_Pred renames Editor.Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality;
...
end Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
