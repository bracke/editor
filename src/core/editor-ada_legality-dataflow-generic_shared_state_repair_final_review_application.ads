...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Application is
   ...
   package Recheck renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Eligibility;
...
end Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Application;
