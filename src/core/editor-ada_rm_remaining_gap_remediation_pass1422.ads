...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1422 is

   --  Pass1422 remediates a concrete remaining gap extracted by the frozen
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1422;
