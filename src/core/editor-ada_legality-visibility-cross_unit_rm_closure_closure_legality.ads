...
package Editor.Ada_Legality.Visibility.Cross_Unit_RM_Closure_Closure_Legality is
   ...
   package Prior renames Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
...
end Editor.Ada_Legality.Visibility.Cross_Unit_RM_Closure_Closure_Legality;
