...
package Editor.Ada_RM_Remediation.Tasking.Entry_Family_Barrier is

   --  Case 1418 remediates a concrete remaining gap extracted by the final
   --  inventory: entry-family declarations and protected-entry barriers must
   --  be checked with entry index subtype evidence, barrier Boolean evidence,
   --  queue/requeue evidence, protected-action effect evidence, and diagnostic
   --  consumer agreement as one legality result.  The closure preserves
   --  runtime barrier checks, warning-only queue diagnostics, stale entry-queue
   --  evidence rejection, and one stable blocker family.
   ...
   type Remediated_Gap_Family is
     (Remaining_Entry_Family_Barrier_Index_Edge,
      Remaining_Gap_Unknown);

   type Entry_Family_Barrier_Closure is
     (Closure_Entry_Family_Index_Evidence,
      Closure_Barrier_Boolean_Evidence,
      Closure_Entry_Queue_Requeue_Evidence,
      Closure_Protected_Action_Consumer,
      Closure_Unknown);

   type Entry_Family_Barrier_Form is
     (Form_Entry_Family_Barrier_Index_Resolved,
      Form_Entry_Queue_Requeue_Target_Resolved,
      Form_Runtime_Barrier_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Non_Discrete_Entry_Family_Index,
      Form_Illegal_Barrier_Not_Boolean,
      Form_Illegal_Index_Constraint_Mismatch,
      Form_Illegal_Requeue_Target_Index_Mismatch,
      Form_Illegal_Queue_Policy_Conflict,
      Form_Indeterminate_Private_Protected_View,
      Form_Indeterminate_Missing_Entry_Family_Evidence,
      Form_Indeterminate_Missing_Barrier_Evidence,
      Form_Indeterminate_Stale_Entry_Queue_Evidence,
      Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
      Status_Gap_Remediated,
      Status_Entry_Family_Barrier_Index_Resolved,
      Status_Entry_Queue_Requeue_Target_Resolved,
      Status_Runtime_Barrier_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Non_Discrete_Entry_Family_Index,
      Status_Illegal_Barrier_Not_Boolean,
      Status_Illegal_Index_Constraint_Mismatch,
      Status_Illegal_Requeue_Target_Index_Mismatch,
      Status_Illegal_Queue_Policy_Conflict,
      Status_Indeterminate_Private_Protected_View,
      Status_Indeterminate_Missing_Entry_Family_Evidence,
      Status_Indeterminate_Missing_Barrier_Evidence,
      Status_Indeterminate_Stale_Entry_Queue_Evidence,
      ...
      Status_Entry_Family_Fingerprint_Mismatch,
      Status_Barrier_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Entry_Family_Barrier_Closure := Closure_Entry_Family_Index_Evidence;
      Form : Entry_Family_Barrier_Form :=
        Form_Entry_Family_Barrier_Index_Resolved;
      ...
      Complete_Entry_Family_Evidence : Boolean := True;
      Complete_Barrier_Evidence : Boolean := True;
      Consumer_Entry_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Entry_Family_Evidence : Boolean := False;
      Missing_Barrier_Evidence : Boolean := False;
      Stale_Entry_Queue_Evidence : Boolean := False;
      Non_Discrete_Entry_Family_Index : Boolean := False;
      Barrier_Not_Boolean : Boolean := False;
      Index_Constraint_Mismatch : Boolean := False;
      Requeue_Target_Index_Mismatch : Boolean := False;
      Queue_Policy_Conflict : Boolean := False;
      Runtime_Barrier_Check_Preserved : Boolean := False;
      ...
      Entry_Family_Fingerprint : Natural := 0;
      Expected_Entry_Family_Fingerprint : Natural := 0;
      Barrier_Fingerprint : Natural := 0;
      Expected_Barrier_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Tasking.Entry_Family_Barrier;
