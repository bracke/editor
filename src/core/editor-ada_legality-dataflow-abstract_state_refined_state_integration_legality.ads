...
package Editor.Ada_Legality.Dataflow.Abstract_State_Refined_State_Integration_Legality is
   ...
   package Stabilized_State renames Editor.Ada_Legality.Dataflow.State_Stable_Closure_Legality;
...
end Editor.Ada_Legality.Dataflow.Abstract_State_Refined_State_Integration_Legality;
