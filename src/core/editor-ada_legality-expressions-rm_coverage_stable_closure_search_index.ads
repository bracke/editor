...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Search_Index is
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Search_Index;
