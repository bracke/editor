package body Editor.Ada_RM_Remediation.Final_Readiness.Bounded_Work_Cancellation is
...
end Editor.Ada_RM_Remediation.Final_Readiness.Bounded_Work_Cancellation;
