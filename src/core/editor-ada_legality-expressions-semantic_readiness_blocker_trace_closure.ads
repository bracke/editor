...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Trace_Closure;
