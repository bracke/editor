...
package Editor.Ada_Legality.Dataflow.State_Review_Eligibility_Legality is
   ...
   package Worklist renames Editor.Ada_Legality.Dataflow.State_Repair_Worklist_Legality;
...
end Editor.Ada_Legality.Dataflow.State_Review_Eligibility_Legality;
