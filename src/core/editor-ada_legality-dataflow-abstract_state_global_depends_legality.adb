...
package body Editor.Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality is
...
end Editor.Ada_Legality.Dataflow.Abstract_State_Global_Depends_Legality;
