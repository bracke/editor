...
package Editor.Ada_Integrated_Semantic_Closure.Chain is
   ...
   package GRR renames
     Editor.Ada_Legality.Representation.Generic_Replay_Representation_Contract_Predicate_Dataflow_Legality;
...
end Editor.Ada_Integrated_Semantic_Closure.Chain;
