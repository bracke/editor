...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Eligibility is
   ...
   package Worklist renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Eligibility;
