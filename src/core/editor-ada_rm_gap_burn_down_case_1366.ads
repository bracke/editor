...
package Editor.Ada_RM_Gap_Burn_Down_Case_1366 is
   ...
   package Final_Gate renames Editor.Ada_RM_Gap_Burn_Down_Case_1365;
...
end Editor.Ada_RM_Gap_Burn_Down_Case_1366;
