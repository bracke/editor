...
with Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
with Editor.Ada_Legality.Elaboration.Generic_Shared_State_RM_Closure_Legality;
with Editor.Ada_Legality.Accessibility.Repair;
with Editor.Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality;
with Editor.Ada_Legality.Generics.Exception_Finalization_Generic_Shared_State_RM_Closure_Legality;
with Editor.Ada_Legality.Dataflow.Predicate_Generic_Shared_State_RM_Closure_Legality;
with Editor.Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
with Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist;
with Editor.Ada_Overload_Generic_Shared_State_RM_Edge_Completion_Legality;
with Editor.Ada_Legality.Representation.Generic_Shared_State_RM_Edge_Case_Legality;
with Editor.Ada_Semantic_Coverage_Gates;
with Editor.Ada_Syntax_Tree;
with Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure;

package Editor.Ada_Legality.Expressions.Proven_Coverage_RM_Closure_AST_Repair_Legality is
   ...
   --  prove that a real RM-completed generic/shared-state consumer is blocked by
   ...
   --  requires the RM-completed cross-unit closure, elaboration, accessibility,
   --  exception/finalization, predicate, dataflow, diagnostic/remediation
   --  worklist, and the final overload, representation/freezing, and
   ...
   package Closure renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Closure;
   package Overload_Edges renames Editor.Ada_Overload_Generic_Shared_State_RM_Edge_Completion_Legality;
   package Representation_Hard_Cases renames Editor.Ada_Legality.Representation.Generic_Shared_State_RM_Edge_Case_Legality;
   package Tasking_Hard_Cases renames Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure;

   package Cross_RM renames Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
   package Elaboration_RM renames Editor.Ada_Legality.Elaboration.Generic_Shared_State_RM_Closure_Legality;
   package Accessibility_RM renames Editor.Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality;
   package Exception_RM renames Editor.Ada_Legality.Generics.Exception_Finalization_Generic_Shared_State_RM_Closure_Legality;
   package Predicate_RM renames Editor.Ada_Legality.Dataflow.Predicate_Generic_Shared_State_RM_Closure_Legality;
   package Dataflow_RM renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
   package RM_Diagnostics renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
   package RM_Worklist renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist;
...
end Editor.Ada_Legality.Expressions.Proven_Coverage_RM_Closure_AST_Repair_Legality;
