...
package Editor.Ada_RM_Remediation.Expressions.Container_Aggregate_Indexing is

   --  Case 1390 remediates a concrete remaining gap extracted by the final
   --  inventory: container aggregate associations with generalized indexing, iterator profiles,
   --  aggregates must preserve indexing, container indexing, iterator-profile,
   --  range/predicate, private-view, and consumer evidence as one canonical
   --  result instead of allowing aggregate, iterator, indexing, assignment, and diagnostic consumers to
   --  classify the same update independently.
   ...
   type Remediated_Gap_Family is
     (Remaining_Container_Aggregate_Indexing_Profile_Edge,
      Remaining_Container_Aggregate_Element_Association_Edge,
      Remaining_Gap_Unknown);

   type Container_Closure is
     (Closure_Container_Aggregate,
      Closure_Container_Element,
      Closure_Array_Component,
      Closure_Indexing,
      Closure_Variant,
      Closure_Unknown);

   type Container_Form is
     (Form_Container_Element_Association_Resolved,
      Form_Runtime_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Iterator_Profile_Overlap,
      Form_Illegal_Container_Key_Dependent_Association,
      Form_Illegal_Controlled_Element_Association,
      Form_Indeterminate_Private_View,
      Form_Indeterminate_Stale_Container_Evidence,
      Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
      Status_Gap_Remediated,
      Status_Container_Element_Association_Resolved,
      Status_Runtime_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Iterator_Profile_Overlap,
      Status_Illegal_Container_Key_Dependent_Association,
      Status_Illegal_Controlled_Element_Association,
      Status_Indeterminate_Private_View,
      Status_Indeterminate_Stale_Container_Evidence,
      ...
      Status_Container_Fingerprint_Mismatch,
      Status_Indexing_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Container_Closure := Closure_Container_Aggregate;
      Form : Container_Form := Form_Container_Element_Association_Resolved;
      ...
      Iterator_Profile_Overlap : Boolean := False;
      Container_Key_Dependent_Association : Boolean := False;
      Controlled_Element_Association : Boolean := False;
      Stale_Container_Evidence : Boolean := False;
      ...
      Complete_Container_Evidence : Boolean := True;
      Consumer_Container_State_Agrees : Boolean := True;
      ...
      Container_Fingerprint : Natural := 0;
      Expected_Container_Fingerprint : Natural := 0;
      Indexing_Fingerprint : Natural := 0;
      Expected_Indexing_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Expressions.Container_Aggregate_Indexing;
