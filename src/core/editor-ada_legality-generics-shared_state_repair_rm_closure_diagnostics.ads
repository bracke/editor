...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics is
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
