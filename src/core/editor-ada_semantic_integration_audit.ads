...
package Editor.Ada_Semantic_Integration_Audit is

   --  Semantic integration audit starts the post vertical-slice integration
   --  audit campaign.
...
end Editor.Ada_Semantic_Integration_Audit;
