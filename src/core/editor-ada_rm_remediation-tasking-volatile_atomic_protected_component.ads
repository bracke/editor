...
package Editor.Ada_RM_Remediation.Tasking.Volatile_Atomic_Protected_Component is

   --  Case 1417 remediates a concrete remaining gap extracted by the final
   --  inventory: volatile and atomic component semantics inside protected or
   --  otherwise synchronized objects must be checked with component evidence,
   --  aspect evidence, protected-operation access evidence, shared-update
   --  effect evidence, and diagnostic consumer agreement as one legality
   --  result.  The closure preserves runtime synchronization checks,
   --  warning-only diagnostics, stale synchronization evidence rejection, and
   ...
   type Remediated_Gap_Family is
     (Remaining_Volatile_Atomic_Protected_Component_Edge,
      Remaining_Gap_Unknown);

   type Volatile_Atomic_Protected_Closure is
     (Closure_Protected_Component_Evidence,
      Closure_Volatile_Atomic_Aspect,
      Closure_Protected_Operation_Access,
      Closure_Concurrent_Effect_Consumer,
      Closure_Unknown);

   type Volatile_Atomic_Protected_Form is
     (Form_Volatile_Atomic_Protected_Component_Resolved,
      Form_Protected_Operation_Component_Access_Resolved,
      Form_Runtime_Synchronization_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Atomic_Component_By_Copy,
      Form_Illegal_Volatile_Atomic_Aspect_Conflict,
      Form_Illegal_Protected_Component_Discriminant_Conflict,
      Form_Illegal_Nonvolatile_Shared_Update,
      Form_Illegal_Component_Mode_Conflict,
      Form_Indeterminate_Private_Protected_View,
      Form_Indeterminate_Missing_Component_Evidence,
      Form_Indeterminate_Missing_Aspect_Evidence,
      Form_Indeterminate_Stale_Synchronization_Evidence,
      Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
      Status_Gap_Remediated,
      Status_Volatile_Atomic_Protected_Component_Resolved,
      Status_Protected_Operation_Component_Access_Resolved,
      Status_Runtime_Synchronization_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Atomic_Component_By_Copy,
      Status_Illegal_Volatile_Atomic_Aspect_Conflict,
      Status_Illegal_Protected_Component_Discriminant_Conflict,
      Status_Illegal_Nonvolatile_Shared_Update,
      Status_Illegal_Component_Mode_Conflict,
      Status_Indeterminate_Private_Protected_View,
      Status_Indeterminate_Missing_Component_Evidence,
      Status_Indeterminate_Missing_Aspect_Evidence,
      Status_Indeterminate_Stale_Synchronization_Evidence,
      ...
      Status_Component_Fingerprint_Mismatch,
      Status_Aspect_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Volatile_Atomic_Protected_Closure := Closure_Protected_Component_Evidence;
      Form : Volatile_Atomic_Protected_Form :=
        Form_Volatile_Atomic_Protected_Component_Resolved;
      ...
      Complete_Component_Evidence : Boolean := True;
      Complete_Aspect_Evidence : Boolean := True;
      Consumer_Concurrent_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Component_Evidence : Boolean := False;
      Missing_Aspect_Evidence : Boolean := False;
      Stale_Synchronization_Evidence : Boolean := False;
      Atomic_Component_By_Copy : Boolean := False;
      Volatile_Atomic_Aspect_Conflict : Boolean := False;
      Protected_Component_Discriminant_Conflict : Boolean := False;
      Nonvolatile_Shared_Update : Boolean := False;
      Component_Mode_Conflict : Boolean := False;
      Runtime_Synchronization_Check_Preserved : Boolean := False;
      ...
      Component_Fingerprint : Natural := 0;
      Expected_Component_Fingerprint : Natural := 0;
      Aspect_Fingerprint : Natural := 0;
      Expected_Aspect_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Tasking.Volatile_Atomic_Protected_Component;
