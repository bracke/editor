...
package Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality is
...
end Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
