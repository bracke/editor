...
package Editor.Ada_RM_Remediation.Tasking.Protected_Requeue_Select is

   --  Case 1380 remediates a concrete remaining gap extracted by the final
   --  inventory: protected entry requeue/select/finalization evidence must be
   --  preserved through tasking/protected legality, flow effects,
   --  abort/finalization, runtime queue checks, and semantic consumers as one
   --  canonical result.
   ...
   type Remediated_Gap_Family is
     (Remaining_Protected_Requeue_Select_Finalization_Edge,
      Remaining_Tasking_Consumer_Surface_Edge,
      Remaining_Gap_Unknown);

   type Tasking_Context is
     (Context_Protected_Entry,
      Context_Requeue,
      Context_Select_Alternative,
      Context_Abortable_Select,
      Context_Task_Termination,
      Context_Unknown);

   type Tasking_Form is
     (Tasking_Protected_Requeue_Select_Compatible,
      Tasking_Missing_Effect_Evidence,
      Tasking_Illegal_Protected_Barrier_Side_Effect,
      Tasking_Illegal_Requeue_Target_Profile,
      Tasking_Illegal_Select_Coverage,
      Tasking_Illegal_Terminate_Dependency,
      Tasking_Illegal_Abort_Finalization_Hazard,
      Tasking_Runtime_Entry_Queue_Check,
      Tasking_Private_View_Indeterminate,
      Tasking_Stale_Effect_Evidence,
      Tasking_Consumer_Disagreement,
      Tasking_Unknown);
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Runtime_Entry_Queue_Check_Preserved,
   ...
   type Remediation_Row is record
      ...
      Context : Tasking_Context := Context_Protected_Entry;
      Form : Tasking_Form := Tasking_Protected_Requeue_Select_Compatible;
      ...
      Effect_Evidence_Present : Boolean := True;
      Private_Full_View_Available : Boolean := True;
      Protected_Barrier_Side_Effect : Boolean := False;
      Requeue_Target_Profile_Mismatch : Boolean := False;
      Select_Coverage_Missing : Boolean := False;
      Terminate_Dependency_Unsafe : Boolean := False;
      Abort_Finalization_Hazard : Boolean := False;
      Runtime_Entry_Queue_Check : Boolean := False;
      Consumer_Surface_Agrees : Boolean := True;
      Stale_Effect_Evidence : Boolean := False;
