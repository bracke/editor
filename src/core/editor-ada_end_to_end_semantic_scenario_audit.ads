...
package Editor.Ada_End_To_End_Semantic_Scenario_Audit is

   --  End-to-end semantic scenario audit is part of the post vertical-slice
...
end Editor.Ada_End_To_End_Semantic_Scenario_Audit;
