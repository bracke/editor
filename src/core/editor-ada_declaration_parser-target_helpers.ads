package Editor.Ada_Declaration_Parser.Target_Helpers is
   ...
   function Declaration_Target_From_Line_Start (Line : String) return String;
   ...
   function Subtype_Target_From_Line_Start (Line : String) return String;

   function Derived_Target_From_Line_Start (Line : String) return String;

   function Access_Subprogram_Profile (Line : String) return String;

   function Access_Object_Target (Line : String) return String;

   function Access_Target_From_Line_Start (Line : String) return String;

   function Array_Target_From_Line (Line : String) return String;

   function Object_Target_After_Colon (Line : String) return String;

   function Object_Target_From_Line_Start (Line : String) return String;

   function Separate_Parent_Name (Line : String) return String;
