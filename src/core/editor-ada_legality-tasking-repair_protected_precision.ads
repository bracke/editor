...
package Editor.Ada_Legality.Tasking.Repair_Protected_Precision is
   ...
   subtype Tasking_Legality_Status is
     Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Legality_Status;
   subtype Tasking_Context_Kind is
     Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Context_Kind;
   ...
   type Tasking_Precision_Context_Info is record
      ...
      Base_Kind                  : Tasking_Context_Kind := Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Context_Unknown;
      ...
      Base_Tasking_Status        : Tasking_Legality_Status := Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Legality_Not_Checked;
