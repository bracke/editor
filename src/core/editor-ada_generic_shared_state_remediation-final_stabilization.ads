...
package Editor.Ada_Generic_Shared_State_Remediation.Final_Stabilization is
   ...
   package Conv renames Editor.Ada_Generic_Shared_State_Remediation.Final_Recheck_Convergence;
