...
package body Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master is
   ...
   use type Consumers.Semantic_Consumer;
         ...
         return Status_Lifetime_Fingerprint_Mismatch;
         ...
         return Status_Consumer_Fingerprint_Mismatch;
           ...
           begin
              ...
              elsif not Row.Consumer_Reached or else not Row.Consumer_Lifetime_State_Agrees then
         ...
         return Status_Indeterminate_Stale_Lifetime_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_View;
      elsif Row.Missing_Master_Evidence or else not Row.Complete_Master_Evidence then
         return Status_Indeterminate_Missing_Master_Evidence;
         ...
         return Status_Illegal_Null_Exclusion_Violation;
      elsif Row.Storage_Pool_Mismatch then
         return Status_Illegal_Storage_Pool_Mismatch;
      elsif Row.Unchecked_Deallocation_Hazard then
         return Status_Illegal_Unchecked_Deallocation_Hazard;
      elsif Row.Controlled_Allocation_Finalization_Hazard then
         return Status_Illegal_Controlled_Allocation_Finalization_Hazard;
      ...
      elsif Row.Gap = Remaining_Access_Parameter_Allocator_Master_Edge then
         return Status_Access_Parameter_Allocator_Master_Resolved;
              else
           ...
           begin
              return Row.Id * 47
                ...
                + Access_Parameter_Allocator_Master_Form'Pos (Row.Form) * 7
