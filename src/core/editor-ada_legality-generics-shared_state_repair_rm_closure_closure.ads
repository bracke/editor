...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Closure is

   --  Case 1263 generic/shared-state RM-completion stabilized closure legality.
   --
   --  This package consumes Case 1262 generic/shared-state RM-completion stabilization
   ...
   package Gate renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Stabilization;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Closure;
