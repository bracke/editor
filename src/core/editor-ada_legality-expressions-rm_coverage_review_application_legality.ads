...
package Editor.Ada_Legality.Expressions.RM_Coverage_Review_Application_Legality is
   ...
   package Recheck renames Editor.Ada_Legality.Expressions.RM_Coverage_Review_Eligibility_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Review_Application_Legality;
