...
package Editor.Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit is

   --  RM coverage gap remediation audit is part of the post vertical-slice
   --  integration audit campaign.  It turns the RM coverage matrix into an actionable gap
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Gap_Repair_Audit;
