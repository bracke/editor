...
package body Editor.Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate is
...
end Editor.Ada_RM_Remediation.Generics.Discriminated_Private_Aggregate;
