...
package Editor.Ada_Legality.Representation.Generic_Replay_Representation_Contract_Predicate_Dataflow_Legality is
   ...
   type Generic_Replay_Representation_Status is
     (Generic_Replay_Representation_Not_Checked,
      ...
      Generic_Replay_Representation_Missing_Representation_CPD_Row,
      Generic_Replay_Representation_Base_Representation_CPD_Error,
      ...
      Generic_Replay_Representation_Multiple_Representation_CPD_Blockers,
      Generic_Replay_Representation_Representation_CPD_Indeterminate,
