...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1421 is

   --  Pass1421 remediates a concrete remaining gap extracted by the frozen
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1421;
