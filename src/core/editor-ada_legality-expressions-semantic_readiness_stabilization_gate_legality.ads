...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Stabilization_Gate_Legality;
