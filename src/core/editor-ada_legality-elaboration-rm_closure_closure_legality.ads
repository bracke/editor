...
package Editor.Ada_Legality.Elaboration.RM_Closure_Closure_Legality is
   ...
   package Prior renames Editor.Ada_Legality.Elaboration.Generic_Shared_State_RM_Closure_Legality;
