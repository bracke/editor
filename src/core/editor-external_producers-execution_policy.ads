...
package Editor.External_Producers.Execution_Policy is
   ...
   subtype Native_Process_Control_Backend is
     Editor.External_Producers.Build_Types.Native_Process_Control_Backend;
   ...
   subtype Process_Output_Stream is
     Editor.External_Producers.Build_Types.Process_Output_Stream;
   ...
   function Build_Timeout_Policy_Is_Bounded
     (Policy : Editor.External_Producers.Build_Types.Process_Execution_Policy) return Boolean;
   ...
   function Build_Test_Fixture_Execution_Gate
     (Allow_Diagnostics_Ingestion : Boolean := True;
      ...
      Consent                     : Editor.External_Producers.Build_Types.Build_Execution_Consent :=
   ...
   function Select_Process_Runner_Mode
     (Gate   : Editor.External_Producers.Build_Types.Build_Execution_Gate;
      Policy : Editor.External_Producers.Build_Types.Process_Execution_Policy)
      return Editor.External_Producers.Build_Types.Process_Execution_Mode;
