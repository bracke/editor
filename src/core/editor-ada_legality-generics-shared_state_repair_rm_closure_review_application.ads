...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Application is
   ...
   package Recheck renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Eligibility;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Application;
