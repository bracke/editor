...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Search_Index;
