...
package Editor.Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality is
   ...
   package Flow_Init renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Legality;
...
end Editor.Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality;
