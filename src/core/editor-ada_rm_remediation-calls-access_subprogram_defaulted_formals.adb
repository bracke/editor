...
package body Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Defaulted_Formals is
   ...
   begin
      case Status is
         ...
         when Status_Illegal_Convention_Mismatch
   ...
   begin
      ...
      elsif not Row.Consumer_Reached or else not Row.Consumer_Profile_State_Agrees then
   ...
   begin
      if Status /= Status_Not_Checked then
        ...
        or else Row.Missing_Profile_Evidence
      ...
      elsif Row.Default_Null_Exclusion then
         return Status_Illegal_Default_Null_Exclusion;
      elsif Row.Default_Profile_Mismatch then
         return Status_Illegal_Default_Profile_Mismatch;
      elsif Row.Protected_Access_Profile_Mismatch then
         return Status_Illegal_Protected_Access_Profile_Mismatch;
      ...
      elsif Row.Gap = Remaining_Access_Subprogram_Convention_Default_Edge then
         return Status_Access_Subprogram_Convention_Default_Resolved;
      else
   ...
   begin
      return Row.Id * 43
        ...
        + Access_Subprogram_Convention_Default_Form'Pos (Row.Form) * 7
