...
package body Editor.Ada_RM_Remediation.Tagged_Types.Private_Extension_Primitives is
   ...
   begin
      case Status is
         ...
         when Status_Runtime_Dispatching_Check_Preserved =>
            return Precision.Class_Legal_With_Runtime_Check;
         when Status_Illegal_Hidden_Abstract_Primitive_Not_Overridden
         ...
         when Status_Indeterminate_Private_Extension_Full_View
   ...
   begin
      ...
      elsif Row.Inherited_Primitive_Fingerprint /= Row.Expected_Inherited_Primitive_Fingerprint then
         return Status_Inherited_Primitive_Fingerprint_Mismatch;
      elsif Row.Hiding_Fingerprint /= Row.Expected_Hiding_Fingerprint then
         return Status_Hiding_Fingerprint_Mismatch;
   ...
   begin
      if Status /= Status_Not_Checked then
         return Status;
      elsif Row.Stale_Primitive_Hiding_Evidence then
         return Status_Indeterminate_Stale_Primitive_Hiding_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_Extension_Full_View;
      elsif Row.Missing_Inherited_Primitive_Evidence
        or else not Row.Complete_Inherited_Primitive_Evidence
      then
         return Status_Indeterminate_Missing_Inherited_Primitive_Evidence;
      elsif Row.Missing_Hiding_Evidence
        or else not Row.Complete_Hiding_Evidence
      then
         return Status_Indeterminate_Missing_Hiding_Evidence;
      elsif Row.Hidden_Abstract_Primitive_Not_Overridden then
         return Status_Illegal_Hidden_Abstract_Primitive_Not_Overridden;
      elsif Row.Private_Extension_View_Mismatch then
         return Status_Illegal_Private_Extension_View_Mismatch;
      elsif Row.Inherited_Primitive_Profile_Mismatch then
         return Status_Illegal_Inherited_Primitive_Profile_Mismatch;
      elsif Row.Interface_Primitive_Hiding_Conflict then
         return Status_Illegal_Interface_Primitive_Hiding_Conflict;
      elsif Row.Dispatching_Candidate_Hidden then
         return Status_Illegal_Dispatching_Candidate_Hidden;
      elsif Row.Runtime_Dispatching_Check_Preserved
        or else Row.Form = Form_Runtime_Dispatching_Check_Preserved
      then
         return Status_Runtime_Dispatching_Check_Preserved;
      elsif Row.Warning_Only_Preserved
        or else Row.Form = Form_Warning_Only_Preserved
      then
         return Status_Warning_Only_Preserved;
      elsif Row.Form = Form_Primitive_Hiding_Resolved then
         return Status_Primitive_Hiding_Resolved;
      elsif Row.Gap = Remaining_Inherited_Private_Extension_Primitive_Hiding_Edge then
         return Status_Inherited_Private_Extension_Primitive_Resolved;
      else
   ...
   begin
      return Row.Id * 79
        ...
        + Inherited_Private_Extension_Primitive_Hiding_Form'Pos (Row.Form) * 13
        + Row.Source_Fingerprint
        + Row.AST_Fingerprint
        + Row.Type_Fingerprint
        + Row.Profile_Fingerprint
        + Row.Inherited_Primitive_Fingerprint
        + Row.Hiding_Fingerprint
