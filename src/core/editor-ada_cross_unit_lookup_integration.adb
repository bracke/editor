...
package body Editor.Ada_Cross_Unit_Lookup_Integration is
   ...
   begin
      ...
      Model.Local_Precedence_Total := 0;
   ...
   function Local_Precedence_Count (Model : Cross_Unit_Lookup_Model) return Natural is
   begin
      return Model.Local_Precedence_Total;
   end Local_Precedence_Count;
