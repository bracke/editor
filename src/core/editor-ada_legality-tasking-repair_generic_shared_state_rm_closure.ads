...
package Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure is
   ...
   package Previous renames Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_Final;
...
end Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure;
