...
with Editor.Ada_Token_Cursor.Expressions;
...
package body Editor.Ada_Token_Cursor is
   ...
   function At_Iterator_Filter_Condition_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Iterator_Filter_Condition_Boundary (Position);
   ...
   function At_Case_Statement_Selector_Reserved_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Case_Statement_Selector_Reserved_Boundary (Position);
   ...
   function At_Loop_Domain_Reserved_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Loop_Domain_Reserved_Boundary (Position);
   ...
   function At_Iterated_Component_Expression_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Iterated_Component_Expression_Boundary (Position);
   end At_Iterated_Component_Expression_Boundary;

   function At_Aggregate_Component_Expression_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Aggregate_Component_Expression_Boundary (Position);
   ...
   function At_Conditional_Expression_Dependent_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Conditional_Expression_Dependent_Boundary
        (Position);
   ...
   function At_Case_Expression_Selector_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Case_Expression_Selector_Boundary (Position);
   ...
   function At_Quantified_Predicate_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Quantified_Predicate_Boundary (Position);
   end At_Quantified_Predicate_Boundary;

   function At_Declare_Expression_Body_Boundary
     (Position : Cursor) return Boolean is
   begin
      return Expressions.At_Declare_Expression_Body_Boundary (Position);
   ...
   begin
      return Expressions.Parenthesized_Constraint_Has_Arrow (Position);
   ...
   function Has_Top_Level_Arrow_Before_Constraint_Association_End
     (Position : Cursor) return Boolean is
   begin
      return Expressions.Has_Top_Level_Arrow_Before_Constraint_Association_End
        (Position);
   ...
   begin
      return Expressions.Parenthesized_Name_Suffix_Is_Slice (Position);
