...
package Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Defaulted_Formals is

   --  Case 1404 remediates a concrete remaining gap extracted by the final
   --  inventory: access-to-subprogram calls and defaulted access formals must preserve
   --  canonical callable profile, convention, null-exclusion, accessibility,
   --  protected access, generic substitution, and consumer evidence.
   ...
   type Remediated_Gap_Family is
     (Remaining_Access_Subprogram_Convention_Default_Edge,
      Remaining_Gap_Unknown);

   type Access_Subprogram_Convention_Default_Closure is
     (Closure_Access_Subprogram_Convention_Default,
      Closure_Access_Subprogram_Convention_Default_Actual,
      Closure_Callable_Profile,
      Closure_Dispatching_Effect,
      Closure_Unknown);

   type Access_Subprogram_Convention_Default_Form is
     (Form_Access_Subprogram_Convention_Default_Resolved,
      Form_Runtime_Accessibility_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Convention_Mismatch,
      Form_Illegal_Default_Null_Exclusion,
      Form_Illegal_Default_Profile_Mismatch,
      Form_Illegal_Protected_Access_Profile_Mismatch,
      Form_Illegal_Static_Accessibility_Escape,
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Access_Subprogram_Convention_Default_Resolved,
      Status_Runtime_Accessibility_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Convention_Mismatch,
      Status_Illegal_Default_Null_Exclusion,
      Status_Illegal_Default_Profile_Mismatch,
      Status_Illegal_Protected_Access_Profile_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Access_Subprogram_Convention_Default_Closure := Closure_Access_Subprogram_Convention_Default;
      Form : Access_Subprogram_Convention_Default_Form := Form_Access_Subprogram_Convention_Default_Resolved;
      ...
      Default_Null_Exclusion : Boolean := False;
      Default_Profile_Mismatch : Boolean := False;
      Protected_Access_Profile_Mismatch : Boolean := False;
...
end Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Defaulted_Formals;
