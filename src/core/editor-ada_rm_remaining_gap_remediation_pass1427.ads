...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1427 is

   --  Pass1427 remediates a concrete remaining gap extracted by the frozen
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1427;
