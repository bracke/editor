...
package body Editor.Ada_Representation_Freezing_Precision_Legality is
   ...
   begin
      return Status not in
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Not_Checked |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Task_Activation |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Task_Body |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Protected_Function |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Protected_Procedure |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Protected_Entry |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Entry_Barrier |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Entry_Family_Index |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Accept |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Requeue |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Select_Alternative |
        Editor.Ada_Legality.Tasking.Repair_Protected_Precision.Tasking_Precision_Legal_Queued_Entry_Call;
   end Tasking_Error;
