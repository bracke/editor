...
package Editor.Ada_Diagnostic_Quality_Validation is

   --  Project-scale diagnostic quality validation.  It does not add new
   --  diagnostic infrastructure and does not reopen the finite Remaining_*
   --  remediation inventory; it verifies that existing diagnostics are useful,
   --  stable, source-shaped, and consumer-consistent.
...
end Editor.Ada_Diagnostic_Quality_Validation;
