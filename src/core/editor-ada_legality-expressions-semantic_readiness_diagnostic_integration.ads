...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Integration is
   ...
   package Discriminant_Final renames Editor.Ada_Legality.Representation.Discriminant_Variant_Integration_Legality;
   ...
   package Overload_Final renames Editor.Ada_Legality.Expressions.Overload_Type_Final_RM_Legality;
   package Representation_Final renames Editor.Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality;
   package Tasking_Final renames Editor.Ada_Legality.Tasking.Repair_Protected_Deep_Edge;
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Diagnostic_Integration;
