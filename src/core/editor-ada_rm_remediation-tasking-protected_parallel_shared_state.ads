...
package Editor.Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State is

   --  Case 1348 is the sixth RM gap burn-down case.  It closes a concrete
...
end Editor.Ada_RM_Remediation.Tasking.Protected_Parallel_Shared_State;
