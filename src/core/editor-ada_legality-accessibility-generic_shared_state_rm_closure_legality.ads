...
package Editor.Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality is

   --  Case 1252 accessibility/lifetime legality over the completed
   ...
   package Prior_Access renames Editor.Ada_Legality.Accessibility.Repair.Generic_Shared_State_Final;
...
end Editor.Ada_Legality.Accessibility.Generic_Shared_State_RM_Closure_Legality;
