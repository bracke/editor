...
package Editor.Ada_Project_Scale_Closure is

   --  Project-scale closure gate.  It freezes the post-remediation validation
   --  campaign after the seven project-scale release items and rejects
   --  speculative continuation unless a real corpus failure, source-shaped
   --  regression, or concrete RM contradiction is attached as evidence.
   ...
   function Project_Scale_Closed (Model : Closure_Model) return Boolean;

end Editor.Ada_Project_Scale_Closure;
