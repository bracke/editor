...
package Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality is
   ...
   package Stabilized renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Closure;
...
end Editor.Ada_Legality.Visibility.Cross_Unit_Generic_Shared_State_RM_Closure_Closure_Legality;
