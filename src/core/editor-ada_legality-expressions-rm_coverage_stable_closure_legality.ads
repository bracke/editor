...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Legality is
   ...
   package Closure renames Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Closure_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Legality;
