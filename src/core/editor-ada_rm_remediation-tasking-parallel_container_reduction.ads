...
package Editor.Ada_RM_Remediation.Tasking.Parallel_Container_Reduction is

   --  Case 1370 remediates a concrete remaining gap extracted by the final
...
end Editor.Ada_RM_Remediation.Tasking.Parallel_Container_Reduction;
