...
package Editor.Ada_Legality.Expressions.RM_Coverage_Repair_Worklist_Legality is
   ...
   package Diagnostics renames Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Diagnostic_Integration;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Repair_Worklist_Legality;
