...
package Editor.Ada_Legality.Expressions.RM_Coverage_Review_Convergence_Legality is
   ...
   package Apply renames Editor.Ada_Legality.Expressions.RM_Coverage_Review_Application_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Review_Convergence_Legality;
