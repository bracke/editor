...
package Editor.Ada_RM_Remediation.Expressions.Loop_Range_Iterator is

   --  Case 1405 remediates a concrete remaining gap extracted by the final
   --  inventory: discrete loop ranges and iterator domains must share one
   --  canonical subtype/range/iterator result across loop legality,
   --  parallel/reduction consumers, assignments, contracts, and diagnostics.
   ...
   type Discrete_Loop_Iterator_Closure is
     (Closure_Discrete_Subtype_Loop_Range,
      Closure_Iterator_Domain,
      Closure_Parallel_Reduction_Consumer,
      Closure_Loop_Assignment_Consumer,
      Closure_Unknown);

   type Discrete_Loop_Iterator_Form is
     (Form_Discrete_Loop_Iterator_Resolved,
      Form_Runtime_Bounds_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Non_Discrete_Loop_Range,
      Form_Illegal_Reversed_Static_Range,
      Form_Illegal_Loop_Parameter_Assignment,
      Form_Illegal_Iterator_Element_Type_Mismatch,
      Form_Illegal_Parallel_Shared_State_Write,
      Form_Indeterminate_Private_View,
      Form_Indeterminate_Missing_Subtype_Evidence,
      Form_Indeterminate_Stale_Iterator_Evidence,
      Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
      Status_Gap_Remediated,
      Status_Discrete_Loop_Iterator_Resolved,
      Status_Runtime_Bounds_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Non_Discrete_Loop_Range,
      Status_Illegal_Reversed_Static_Range,
      Status_Illegal_Loop_Parameter_Assignment,
      Status_Illegal_Iterator_Element_Type_Mismatch,
      Status_Illegal_Parallel_Shared_State_Write,
      Status_Indeterminate_Private_View,
      Status_Indeterminate_Missing_Subtype_Evidence,
      Status_Indeterminate_Stale_Iterator_Evidence,
   ...
   type Remediation_Row is record
      ...
      Closure : Discrete_Loop_Iterator_Closure := Closure_Discrete_Subtype_Loop_Range;
      Form : Discrete_Loop_Iterator_Form := Form_Discrete_Loop_Iterator_Resolved;
      ...
      Non_Discrete_Loop_Range : Boolean := False;
      Reversed_Static_Range : Boolean := False;
      Loop_Parameter_Assignment : Boolean := False;
      Iterator_Element_Type_Mismatch : Boolean := False;
      Parallel_Shared_State_Write : Boolean := False;
      Stale_Iterator_Evidence : Boolean := False;
      Missing_Full_View : Boolean := False;
      Missing_Subtype_Evidence : Boolean := False;
      Runtime_Bounds_Check_Preserved : Boolean := False;
      Warning_Only_Preserved : Boolean := False;
      Complete_Iterator_Evidence : Boolean := True;
      Consumer_Iterator_State_Agrees : Boolean := True;
...
end Editor.Ada_RM_Remediation.Expressions.Loop_Range_Iterator;
