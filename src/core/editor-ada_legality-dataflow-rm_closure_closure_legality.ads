...
package Editor.Ada_Legality.Dataflow.RM_Closure_Closure_Legality is
   ...
   package Prior renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_RM_Closure_Legality;
...
end Editor.Ada_Legality.Dataflow.RM_Closure_Closure_Legality;
