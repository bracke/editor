...
package Editor.Ada_RM_Remediation.Representation.Volatile_Atomic_Representation is

   --  Case 1420 remediates a concrete remaining gap extracted by the frozen
   --  inventory: volatile and atomic representation clauses, size/alignment
   --  evidence, full-access and independent-addressability evidence,
   --  freezing, runtime representation checks, warning diagnostics, stale
   --  representation evidence, and semantic consumers must be checked as
   ...
   type Volatile_Atomic_Representation_Closure is
     (Closure_Atomic_Size_Alignment_Evidence,
     Closure_Volatile_Representation_Evidence,
     Closure_Freezing_Representation_Evidence,
     Closure_Representation_Consumer,
     Closure_Unknown);

   type Volatile_Atomic_Representation_Form is
     (Form_Volatile_Atomic_Representation_Resolved,
     Form_Atomic_Size_Alignment_Resolved,
     Form_Runtime_Representation_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Atomic_Size_Too_Small,
     Form_Illegal_Atomic_Alignment_Conflict,
     Form_Illegal_Volatile_Full_Access_Conflict,
     Form_Illegal_Late_Representation_After_Freezing,
     Form_Illegal_Independent_Addressability_Conflict,
     Form_Indeterminate_Private_Object_View,
     Form_Indeterminate_Missing_Representation_Evidence,
     Form_Indeterminate_Missing_Freezing_Evidence,
     Form_Indeterminate_Stale_Representation_Evidence,
     Form_Unknown);
   ...
   type Remediation_Status is
     ...
     Status_Runtime_Representation_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Atomic_Size_Too_Small,
     ...
     Status_Indeterminate_Private_Object_View,
   ...
   type Remediation_Row is record
      ...
      Owner : Implementing_Slice := Matrix.Slice_Freezing_Representation;
      ...
      Closure : Volatile_Atomic_Representation_Closure := Closure_Atomic_Size_Alignment_Evidence;
      Form : Volatile_Atomic_Representation_Form := Form_Volatile_Atomic_Representation_Resolved;
      ...
      Complete_Representation_Evidence : Boolean := True;
      Complete_Freezing_Evidence : Boolean := True;
      Consumer_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Representation_Evidence : Boolean := False;
      Missing_Freezing_Evidence : Boolean := False;
      Stale_Representation_Evidence : Boolean := False;
      Atomic_Size_Too_Small : Boolean := False;
      Atomic_Alignment_Conflict : Boolean := False;
      Volatile_Full_Access_Conflict : Boolean := False;
      Late_Representation_After_Freezing : Boolean := False;
      Independent_Addressability_Conflict : Boolean := False;
      Runtime_Representation_Check_Preserved : Boolean := False;
...
end Editor.Ada_RM_Remediation.Representation.Volatile_Atomic_Representation;
