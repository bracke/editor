package body Editor.Ada_RM_Remediation.Accessibility.Allocator_Storage_Lifetime is
...
end Editor.Ada_RM_Remediation.Accessibility.Allocator_Storage_Lifetime;
