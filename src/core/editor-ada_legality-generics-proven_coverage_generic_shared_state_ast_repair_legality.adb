...
package body Editor.Ada_Legality.Generics.Proven_Coverage_Generic_Shared_State_AST_Repair_Legality is
   ...
   begin
      return To_Unbounded_String ("coverage-proven generic/shared-state AST repair legality " & Coverage_Proven_AST_Repair_Status'Image (Status) & " kind=" & Coverage_Proven_AST_Repair_Kind'Image (Kind) & " blocker=" & Coverage_Proven_AST_Repair_Blocker_Family'Image (Family));
   end Message_For;
