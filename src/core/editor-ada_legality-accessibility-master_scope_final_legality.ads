...
package Editor.Ada_Legality.Accessibility.Master_Scope_Final_Legality is
   ...
   package Scope_Consumer renames Editor.Ada_Legality.Accessibility.Scope_Legality;
...
end Editor.Ada_Legality.Accessibility.Master_Scope_Final_Legality;
