...
package Editor.Ada_RM_Remediation.Final_Readiness.Remaining_Gap_Inventory is

   --  Case 1366 is the twenty-fourth RM gap burn-down case.  It uses the
   --  final semantic readiness gate from Case_1365 to extract the remaining
   ...
   package Final_Gate renames Editor.Ada_RM_Remediation.Final_Readiness.Readiness_Gate;
...
end Editor.Ada_RM_Remediation.Final_Readiness.Remaining_Gap_Inventory;
