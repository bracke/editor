...
package Editor.Ada_RM_Remediation.Visibility.Renamed_Primitive_Visibility is

   --  Case 1425 remediates a concrete remaining gap extracted by the frozen
   --  inventory: renamed primitive visibility, homograph/use-clause
   --  interactions, private primitive views, profile agreement, runtime
   --  dispatching checks, warning diagnostics, stale renaming evidence, and
   --  semantic consumers must be checked as one source-shaped Ada legality
   --  result. The closure preserves legal, illegal, runtime-check, warning-
   --  only, indeterminate, consumer, final-gate, and fingerprint freshness
   --  outcomes under one stable blocker family.
   ...
   type Renamed_Primitive_Visibility_Closure is
     (Closure_Renaming_View_Evidence,
     Closure_Primitive_Visibility_Evidence,
     Closure_Overload_Homograph_Evidence,
     Closure_Visibility_Consumer,
     Closure_Unknown);

   type Renamed_Primitive_Visibility_Form is
     (Form_Renamed_Primitive_Visibility_Resolved,
     Form_Renamed_Primitive_Overload_Resolved,
     Form_Runtime_Tag_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Renamed_Primitive_Not_Visible,
     Form_Illegal_Homograph_Hides_Renamed_Primitive,
     Form_Illegal_Private_Primitive_View_Mismatch,
     Form_Illegal_Renaming_Mode_Profile_Mismatch,
     Form_Illegal_Use_Clause_Ambiguity,
     Form_Indeterminate_Private_Primitive_View,
     Form_Indeterminate_Missing_Renaming_Evidence,
     Form_Indeterminate_Missing_Visibility_Evidence,
     Form_Indeterminate_Stale_Renaming_Evidence,
     Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
     Status_Gap_Remediated,
     Status_Renamed_Primitive_Visibility_Resolved,
     Status_Renamed_Primitive_Overload_Resolved,
     Status_Runtime_Tag_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Renamed_Primitive_Not_Visible,
     Status_Illegal_Homograph_Hides_Renamed_Primitive,
     Status_Illegal_Private_Primitive_View_Mismatch,
     Status_Illegal_Renaming_Mode_Profile_Mismatch,
     Status_Illegal_Use_Clause_Ambiguity,
     Status_Indeterminate_Private_Primitive_View,
     Status_Indeterminate_Missing_Renaming_Evidence,
     Status_Indeterminate_Missing_Visibility_Evidence,
     Status_Indeterminate_Stale_Renaming_Evidence,
     ...
     Status_Renaming_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Renamed_Primitive_Visibility_Closure := Closure_Renaming_View_Evidence;
      Form : Renamed_Primitive_Visibility_Form := Form_Renamed_Primitive_Visibility_Resolved;
      ...
      Complete_Renaming_Evidence : Boolean := True;
      Complete_Visibility_Evidence : Boolean := True;
      Consumer_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Renaming_Evidence : Boolean := False;
      Missing_Visibility_Evidence : Boolean := False;
      Stale_Renaming_Evidence : Boolean := False;
      Renamed_Primitive_Not_Visible : Boolean := False;
      Homograph_Hides_Renamed_Primitive : Boolean := False;
      Private_Primitive_View_Mismatch : Boolean := False;
      Renaming_Mode_Profile_Mismatch : Boolean := False;
      Use_Clause_Ambiguity : Boolean := False;
      ...
      Renaming_Fingerprint : Natural := 0;
      Expected_Renaming_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Visibility.Renamed_Primitive_Visibility;
