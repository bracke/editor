...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1426 is

   --  Pass1426 remediates a concrete remaining gap extracted by the frozen
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1426;
