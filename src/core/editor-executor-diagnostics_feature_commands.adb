   ...
   begin
      case Id is
         when Editor.Command_Ids.Command_Diagnostics_Show =>
            ...
            if Editor.Feature_Diagnostics.Row_Count (S.Panel.Feature_Diagnostics) = 0 then
               Report_Info (S, Editor.Feature_Diagnostics.Message_No_Diagnostics);
            else
         ...
         when Editor.Command_Ids.Command_Diagnostics_Clear =>
            if Editor.Feature_Diagnostics.Row_Count (S.Panel.Feature_Diagnostics) = 0 then
               Editor.Feature_Diagnostics.Show_All (S.Panel.Feature_Diagnostics);
         ...
         when Editor.Command_Ids.Command_Diagnostics_Toggle_Warnings =>
            Editor.Feature_Diagnostics.Toggle_Warnings_Visible (S.Panel.Feature_Diagnostics);
            Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
              (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
            if Editor.Feature_Diagnostics.Severity_Is_Visible
         ...
         when Editor.Command_Ids.Command_Diagnostics_Clear_Filter =>
            if not Editor.Feature_Diagnostics.Filter_Active (S.Panel.Feature_Diagnostics) then
         ...
         when Editor.Command_Ids.Command_Diagnostics_Filter_Info_Notes =>
            Editor.Feature_Diagnostics.Filter_Info_And_Notes_Only (S.Panel.Feature_Diagnostics);
            Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
              (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
         ...
         when Editor.Command_Ids.Command_Diagnostics_Filter_Source =>
            ...
            begin
               ...
               Editor.Feature_Diagnostics.Filter_Source_Label
                 (S.Panel.Feature_Diagnostics, Source_Label);
               Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
                 (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
         ...
         when Editor.Command_Ids.Command_Diagnostics_Clear_Build =>
            ...
            begin
               Removed := Editor.Feature_Diagnostics.Clear_Build_Diagnostics
                 (S.Panel.Feature_Diagnostics);
               Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Row_Change
                 (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel, Previous_Id, Previous_Source);
               Editor.Render_Cache.Invalidate_All;
               if Removed > 0 then
            ...
            declare
               ...
               Result : Editor.Command_Execution.Command_Execution_Result :=
                 Editor.Executor.Diagnostics_Navigation_Commands.Execute_Diagnostic_Row_Activation
                   (S, Row, Editor.Feature_Panel.Projection_Generation (S.Panel.Feature_Panel));
            begin
         ...
         when Editor.Command_Ids.Command_Diagnostics_Toggle_File_Source =>
            Editor.Feature_Diagnostics.Toggle_Source_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.File_Diagnostic_Source);
            Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
              (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
            if Editor.Feature_Diagnostics.Source_Is_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.File_Diagnostic_Source)
         ...
         when Editor.Command_Ids.Command_Diagnostics_Toggle_Project_Source =>
            Editor.Feature_Diagnostics.Toggle_Source_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.Project_Diagnostic_Source);
            Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
              (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
            if Editor.Feature_Diagnostics.Source_Is_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.Project_Diagnostic_Source)
         ...
         when Editor.Command_Ids.Command_Diagnostics_Toggle_Unknown_Source =>
            Editor.Feature_Diagnostics.Toggle_Source_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.Unknown_Diagnostic_Source);
            Editor.Feature_Diagnostics.Reconcile_Diagnostics_After_Filter_Change
              (S.Panel.Feature_Diagnostics, S.Panel.Feature_Panel);
            if Editor.Feature_Diagnostics.Source_Is_Visible
              (S.Panel.Feature_Diagnostics, Editor.Feature_Diagnostics.Unknown_Diagnostic_Source)
