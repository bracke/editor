...
package Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Effects is

   --  Case 1423 remediates a concrete remaining gap extracted by the frozen
   --  inventory: access-to-subprogram profile and convention matching,
   --  null-exclusion/accessibility rules, Global/Depends effect agreement,
   --  runtime accessibility checks, warning diagnostics, stale access-
   --  subprogram evidence, and semantic consumers must be checked as one
   --  source-shaped Ada legality result. The closure preserves legal,
   ...
   type Access_Subprogram_Effect_Profile_Closure is
     (Closure_Access_Subprogram_Profile,
     Closure_Convention_Effect_Evidence,
     Closure_Accessibility_Evidence,
     Closure_Effect_Consumer,
     Closure_Unknown);

   type Access_Subprogram_Effect_Profile_Form is
     (Form_Access_Subprogram_Effect_Profile_Resolved,
     Form_Access_Subprogram_Convention_Resolved,
     Form_Runtime_Accessibility_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Access_Subprogram_Mode_Mismatch,
     Form_Illegal_Convention_Mismatch,
     Form_Illegal_Global_Effect_Mismatch,
     Form_Illegal_Null_Exclusion_Profile_Mismatch,
     Form_Illegal_Accessibility_Level_Escape,
     Form_Indeterminate_Private_Access_Profile_View,
     Form_Indeterminate_Missing_Profile_Evidence,
     Form_Indeterminate_Missing_Effect_Evidence,
     Form_Indeterminate_Stale_Access_Subprogram_Evidence,
     Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
     Status_Gap_Remediated,
     Status_Access_Subprogram_Effect_Profile_Resolved,
     Status_Access_Subprogram_Convention_Resolved,
     Status_Runtime_Accessibility_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Access_Subprogram_Mode_Mismatch,
     Status_Illegal_Convention_Mismatch,
     Status_Illegal_Global_Effect_Mismatch,
     Status_Illegal_Null_Exclusion_Profile_Mismatch,
     Status_Illegal_Accessibility_Level_Escape,
     Status_Indeterminate_Private_Access_Profile_View,
     Status_Indeterminate_Missing_Profile_Evidence,
     Status_Indeterminate_Missing_Effect_Evidence,
     Status_Indeterminate_Stale_Access_Subprogram_Evidence,
     ...
     Status_Access_Subprogram_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Family : RM_Family := Matrix.Family_Access_Types_Accessibility;
      Owner : Implementing_Slice := Matrix.Slice_Access_Type_Access_Subprogram;
      ...
      Closure : Access_Subprogram_Effect_Profile_Closure := Closure_Access_Subprogram_Profile;
      Form : Access_Subprogram_Effect_Profile_Form := Form_Access_Subprogram_Effect_Profile_Resolved;
      ...
      Complete_Profile_Evidence : Boolean := True;
      Complete_Effect_Evidence : Boolean := True;
      ...
      Stale_Access_Subprogram_Evidence : Boolean := False;
      Access_Subprogram_Mode_Mismatch : Boolean := False;
      Convention_Mismatch : Boolean := False;
      Global_Effect_Mismatch : Boolean := False;
      Null_Exclusion_Profile_Mismatch : Boolean := False;
      Accessibility_Level_Escape : Boolean := False;
      Runtime_Accessibility_Check_Preserved : Boolean := False;
      ...
      Access_Subprogram_Fingerprint : Natural := 0;
      Expected_Access_Subprogram_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Effects;
