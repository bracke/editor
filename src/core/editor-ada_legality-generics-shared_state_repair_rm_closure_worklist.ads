...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist is
   ...
   package Diagnostics renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Diagnostics;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Worklist;
