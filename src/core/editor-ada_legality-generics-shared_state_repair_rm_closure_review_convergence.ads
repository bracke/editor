...
package Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Convergence is
   ...
   package Apply renames Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Application;
...
end Editor.Ada_Legality.Generics.Shared_State_Repair_RM_Closure_Review_Convergence;
