...
package Editor.Ada_Legality.Tasking.Repair_Protected_Final_Effects is
   ...
   package Tasking_CPD renames Editor.Ada_Legality.Tasking.Repair_Contract_Predicate_Dataflow;
...
end Editor.Ada_Legality.Tasking.Repair_Protected_Final_Effects;
