...
package body Editor.Executor.Buffer_Switcher_Pending_Mark_Review_Commands is
   ...
   begin
      ...
      Editor.Buffer_Switcher.Show_Pending_Marked_Review (S.Surface.Buffer_Switcher);
   ...
   is
   begin
      Editor.Buffer_Switcher.Hide_Pending_Marked_Review (S.Surface.Buffer_Switcher);
      Recompute_Buffer_Switcher_After_Selected_Action
        (S,
         Editor.Buffers.No_Buffer,
         Editor.Buffer_Switcher.Selected_Row_Index (S.Surface.Buffer_Switcher));
   ...
   is
   begin
      if Editor.Buffer_Switcher.Has_Pending_Marked_Review (S.Surface.Buffer_Switcher) then
   ...
   begin
      ...
      Pruned_Count := Editor.Buffer_Switcher.Pruned_Pending_Marked_Close_Target_Count (S.Surface.Buffer_Switcher);
   ...
   is
   begin
      Editor.Buffer_Switcher.Show_Pruned_Pending_Marked_Review (S.Surface.Buffer_Switcher);
   ...
   is
   begin
      Editor.Buffer_Switcher.Hide_Pruned_Pending_Marked_Review (S.Surface.Buffer_Switcher);
      Recompute_Buffer_Switcher (S);
      Normalize_Switcher_Preview_Target (S);
   ...
   begin
      ...
      then
         Report_Info (S, "No pending marked action");
      elsif Editor.Buffer_Switcher.Select_Next_Pending_Marked_Buffer (S.Surface.Buffer_Switcher) then
         Normalize_Switcher_Preview_Target (S);
   ...
   begin
      ...
      then
         Report_Info (S, "No pending marked action");
      elsif Editor.Buffer_Switcher.Select_Previous_Pending_Marked_Buffer (S.Surface.Buffer_Switcher) then
         Normalize_Switcher_Preview_Target (S);
   ...
   begin
      ...
      if not Editor.Buffer_Switcher.Has_Pruned_Pending_Marked_Close_Targets (S.Surface.Buffer_Switcher) then
         Report_Info (S, "No pruned pending close targets");
         return;
      end if;
      ...
      if not Restored then
         if Length (Name) = 0 then
            Name := To_Unbounded_String
              (Editor.Buffer_Switcher.Last_Pruned_Pending_Marked_Close_Target_Name (S.Surface.Buffer_Switcher));
         end if;
