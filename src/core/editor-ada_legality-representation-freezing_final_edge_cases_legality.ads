...
package Editor.Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality is
...
end Editor.Ada_Legality.Representation.Freezing_Final_Edge_Cases_Legality;
