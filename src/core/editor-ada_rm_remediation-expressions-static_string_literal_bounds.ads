...
package Editor.Ada_RM_Remediation.Expressions.Static_String_Literal_Bounds is

   --  Case 1374 remediates a concrete remaining gap extracted by the final
...
end Editor.Ada_RM_Remediation.Expressions.Static_String_Literal_Bounds;
