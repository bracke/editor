...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Closure is
   ...
   package Gate renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Stabilization;
...
end Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Closure;
