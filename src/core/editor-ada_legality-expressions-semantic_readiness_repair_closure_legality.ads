...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Closure_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Closure_Legality;
