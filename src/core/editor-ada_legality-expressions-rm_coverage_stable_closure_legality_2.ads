...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Legality_2 is
   ...
   package Gate renames Editor.Ada_Legality.Expressions.RM_Coverage_Stabilization_Gate_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Legality_2;
