...
package Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults is

      --  Case 1410 remediates a concrete remaining gap extracted by the final
      --  inventory: generic formal object defaults, subtype predicates,
      --  null exclusions, and generic contract consumers.
      ...
      type Remediated_Gap_Family is
        (Remaining_Generic_Default_Object_Predicate_Edge,
         Remaining_Gap_Unknown);

      type Generic_Default_Object_Predicate_Closure is
        (Closure_Generic_Formal_Object,
Closure_Default_Expression_Type,
Closure_Predicate_Consumer,
Closure_Unknown);

      type Generic_Default_Object_Predicate_Form is
        (Form_Generic_Default_Object_Predicate_Resolved,
Form_Runtime_Predicate_Check_Preserved,
Form_Warning_Only_Preserved,
Form_Illegal_Default_Type_Mismatch,
Form_Illegal_Static_Predicate_Failure,
Form_Illegal_Null_Exclusion_Default,
Form_Illegal_Limited_View_Default_Copy,
Form_Illegal_Generic_Default_Mode_Mismatch,
Form_Indeterminate_Private_View,
Form_Indeterminate_Missing_Predicate_Evidence,
Form_Indeterminate_Stale_Generic_Default_Evidence,
Form_Unknown);
...
Status_Illegal_Default_Type_Mismatch,
...
Status_Indeterminate);
      ...
      type Remediation_Row is record
         ...
         Closure : Generic_Default_Object_Predicate_Closure := Closure_Generic_Formal_Object;
         Form : Generic_Default_Object_Predicate_Form := Form_Generic_Default_Object_Predicate_Resolved;
         ...
         Default_Type_Mismatch : Boolean := False;
 Static_Predicate_Failure : Boolean := False;
 Null_Exclusion_Default : Boolean := False;
 Limited_View_Default_Copy : Boolean := False;
 Generic_Default_Mode_Mismatch : Boolean := False;
 Stale_Generic_Default_Evidence : Boolean := False;
 Missing_Full_View : Boolean := False;
 Missing_Predicate_Evidence : Boolean := False;
 Runtime_Predicate_Check_Preserved : Boolean := False;
 Warning_Only_Preserved : Boolean := False;
         Complete_Generic_Default_Evidence : Boolean := True;
 Consumer_Predicate_State_Agrees : Boolean := True;
