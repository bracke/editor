...
package Editor.Ada_RM_Coverage_Matrix_Audit_Pass1338 is

   --  Pass1338 is the fourth post vertical-slice integration/audit pass.
...
end Editor.Ada_RM_Coverage_Matrix_Audit_Pass1338;
