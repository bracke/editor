...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Stable_Closure_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Stable_Closure_Legality;
