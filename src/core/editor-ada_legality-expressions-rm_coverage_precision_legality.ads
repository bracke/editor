...
package Editor.Ada_Legality.Expressions.RM_Coverage_Precision_Legality is
   ...
   package Application renames Editor.Ada_Legality.Expressions.RM_Closure_Closure_Review_Application_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Precision_Legality;
