...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Review_Eligibility_Legality is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Review_Eligibility_Legality;
