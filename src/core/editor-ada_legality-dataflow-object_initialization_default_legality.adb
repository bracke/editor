...
package body Editor.Ada_Legality.Dataflow.Object_Initialization_Default_Legality is
...
end Editor.Ada_Legality.Dataflow.Object_Initialization_Default_Legality;
