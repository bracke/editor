...
package Editor.Ada_RM_Gap_Burn_Down_Case_1344 is

   --  Case 1344 is the second RM gap burn-down case.  It closes a concrete
...
end Editor.Ada_RM_Gap_Burn_Down_Case_1344;
