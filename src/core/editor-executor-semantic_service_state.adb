...
package body Editor.Executor.Semantic_Service_State is
   ...
   is
      Service_Status : constant Editor.Ada_Language_Service.Index_Status :=
        Editor.Ada_Language_Service.Status (S.Semantic.Language_Service);
   ...
   begin
      ...
      then
         return S.Semantic.Language_Service;
      end if;

      return Editor.Ada_Language_Service.From_Index (S.Semantic.Language_Index);
