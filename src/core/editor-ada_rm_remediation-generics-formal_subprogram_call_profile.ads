...
package Editor.Ada_RM_Remediation.Generics.Formal_Subprogram_Call_Profile is

   --  Case 1422 remediates a concrete remaining gap extracted by the frozen
   --  inventory: generic formal subprogram actual/default calls, profile
   --  and mode conformance, null-exclusion contracts, substitution
   --  evidence, runtime profile checks, warning diagnostics, stale generic-
   --  call evidence, and semantic consumers must be checked as one source-
   --  shaped Ada legality result. The closure preserves legal, illegal,
   --  runtime-check, warning-only, indeterminate, consumer, final-gate, and
   ...
   type Generic_Formal_Subprogram_Call_Closure is
     (Closure_Formal_Subprogram_Profile,
     Closure_Generic_Instance_Substitution,
     Closure_Default_Subprogram_Evidence,
     Closure_Generic_Call_Consumer,
     Closure_Unknown);

   type Generic_Formal_Subprogram_Call_Form is
     (Form_Generic_Formal_Subprogram_Call_Resolved,
     Form_Default_Subprogram_Call_Resolved,
     Form_Runtime_Profile_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Missing_Formal_Subprogram_Actual,
     Form_Illegal_Default_Subprogram_Profile_Mismatch,
     Form_Illegal_Mode_Conformance_Mismatch,
     Form_Illegal_Null_Exclusion_Actual_Mismatch,
     Form_Illegal_Abstract_Subprogram_Actual,
     Form_Indeterminate_Private_Formal_View,
     Form_Indeterminate_Missing_Profile_Evidence,
     Form_Indeterminate_Missing_Substitution_Evidence,
     Form_Indeterminate_Stale_Generic_Call_Evidence,
     Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
     Status_Gap_Remediated,
     Status_Generic_Formal_Subprogram_Call_Resolved,
     Status_Default_Subprogram_Call_Resolved,
     Status_Runtime_Profile_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Missing_Formal_Subprogram_Actual,
     Status_Illegal_Default_Subprogram_Profile_Mismatch,
     Status_Illegal_Mode_Conformance_Mismatch,
     Status_Illegal_Null_Exclusion_Actual_Mismatch,
     Status_Illegal_Abstract_Subprogram_Actual,
     Status_Indeterminate_Private_Formal_View,
     Status_Indeterminate_Missing_Profile_Evidence,
     Status_Indeterminate_Missing_Substitution_Evidence,
     Status_Indeterminate_Stale_Generic_Call_Evidence,
     ...
     Status_Formal_Subprogram_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Owner : Implementing_Slice := Matrix.Slice_Generic_Contract_Body;
      ...
      Closure : Generic_Formal_Subprogram_Call_Closure := Closure_Formal_Subprogram_Profile;
      Form : Generic_Formal_Subprogram_Call_Form := Form_Generic_Formal_Subprogram_Call_Resolved;
      ...
      Complete_Substitution_Evidence : Boolean := True;
      ...
      Stale_Generic_Call_Evidence : Boolean := False;
      Missing_Formal_Subprogram_Actual : Boolean := False;
      Default_Subprogram_Profile_Mismatch : Boolean := False;
      Mode_Conformance_Mismatch : Boolean := False;
      Null_Exclusion_Actual_Mismatch : Boolean := False;
      Abstract_Subprogram_Actual : Boolean := False;
      Runtime_Profile_Check_Preserved : Boolean := False;
      ...
      Formal_Subprogram_Fingerprint : Natural := 0;
      Expected_Formal_Subprogram_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Generics.Formal_Subprogram_Call_Profile;
