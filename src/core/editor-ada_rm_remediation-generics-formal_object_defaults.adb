...
package body Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults is
   ...
   use type Consumers.Semantic_Consumer;
           ...
           begin
              case Status is
                 when Status_Gap_Remediated
                    | Status_Generic_Default_Object_Predicate_Resolved
                 ...
                 when Status_Illegal_Default_Type_Mismatch
            | Status_Illegal_Static_Predicate_Failure
            | Status_Illegal_Null_Exclusion_Default
            | Status_Illegal_Limited_View_Default_Copy
            | Status_Illegal_Generic_Default_Mode_Mismatch =>
                    return Precision.Class_Illegal;
                 when Status_Indeterminate_Private_View
            | Status_Indeterminate_Missing_Predicate_Evidence
            | Status_Indeterminate_Stale_Generic_Default_Evidence
      ...
      elsif Row.Generic_Fingerprint /= Row.Expected_Generic_Fingerprint then
         return Status_Generic_Fingerprint_Mismatch;
      elsif Row.Predicate_Fingerprint /= Row.Expected_Predicate_Fingerprint then
         return Status_Predicate_Fingerprint_Mismatch;
         ...
         return Status_Consumer_Fingerprint_Mismatch;
           ...
           begin
              ...
              elsif not Row.Consumer_Reached or else not Row.Consumer_Predicate_State_Agrees then
           ...
           begin
              if Status /= Status_Not_Checked then
                 return Status;
              elsif Row.Stale_Generic_Default_Evidence then
         return Status_Indeterminate_Stale_Generic_Default_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_View;
      elsif Row.Missing_Predicate_Evidence or else not Row.Complete_Generic_Default_Evidence then
         return Status_Indeterminate_Missing_Predicate_Evidence;
      elsif Row.Default_Type_Mismatch then
         return Status_Illegal_Default_Type_Mismatch;
      elsif Row.Static_Predicate_Failure then
         return Status_Illegal_Static_Predicate_Failure;
      elsif Row.Null_Exclusion_Default then
         return Status_Illegal_Null_Exclusion_Default;
      elsif Row.Limited_View_Default_Copy then
         return Status_Illegal_Limited_View_Default_Copy;
      elsif Row.Generic_Default_Mode_Mismatch then
         return Status_Illegal_Generic_Default_Mode_Mismatch;
      elsif Row.Runtime_Predicate_Check_Preserved
        or else Row.Form = Form_Runtime_Predicate_Check_Preserved
      then
      ...
      elsif Row.Gap = Remaining_Generic_Default_Object_Predicate_Edge then
         return Status_Generic_Default_Object_Predicate_Resolved;
              else
           ...
           begin
              return Row.Id * 47
                + Remediation_Status'Pos (Status) * 19
                + Remediated_Gap_Family'Pos (Row.Gap) * 13
                + Generic_Default_Object_Predicate_Form'Pos (Row.Form) * 7
                + Row.Source_Fingerprint
                + Row.AST_Fingerprint
                + Row.Type_Fingerprint
                + Row.Generic_Fingerprint
...
end Editor.Ada_RM_Remediation.Generics.Formal_Object_Defaults;
