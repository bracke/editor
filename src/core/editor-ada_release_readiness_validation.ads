...
package Editor.Ada_Release_Readiness_Validation is

   --  Project-scale release-readiness validation after real Ada corpus
   --  validation.  It verifies that the final validation surface is coherent:
   --  packages, tests, documentation, suite registration, finite remaining-gap
   --  closure, and release documentation must agree.

   type Readiness_Surface is
     (Surface_Source_Package,
      Surface_Test_Package,
      Surface_Readme,
      Surface_Suite_Registration,
   ...
   type Readiness_Row is record
      ...
      Duplicate_Suite_Registration : Boolean := False;
