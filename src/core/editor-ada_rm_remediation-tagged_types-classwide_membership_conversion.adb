...
package body Editor.Ada_RM_Remediation.Tagged_Types.Classwide_Membership_Conversion is
   ...
   use type Consumers.Semantic_Consumer;
           ...
           begin
              case Status is
                 ...
                 when Status_Illegal_Tagged_Root_Incompatible
      ...
      elsif Row.Tag_Fingerprint /= Row.Expected_Tag_Fingerprint then
         return Status_Tag_Fingerprint_Mismatch;
      elsif Row.Dispatch_Fingerprint /= Row.Expected_Dispatch_Fingerprint then
         return Status_Dispatch_Fingerprint_Mismatch;
         ...
         return Status_Consumer_Fingerprint_Mismatch;
           ...
           begin
              ...
              elsif not Row.Consumer_Reached or else not Row.Consumer_Dispatching_State_Agrees then
           ...
           begin
              if Status /= Status_Not_Checked then
                 return Status;
              elsif Row.Stale_Dispatch_Tag_Evidence then
         return Status_Indeterminate_Stale_Dispatch_Tag_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_View;
      elsif Row.Missing_Dispatch_Evidence or else not Row.Complete_Dispatch_Tag_Evidence then
         return Status_Indeterminate_Missing_Dispatch_Evidence;
      elsif Row.Tagged_Root_Incompatible then
         return Status_Illegal_Tagged_Root_Incompatible;
      elsif Row.Interface_Membership_Incompatible then
         return Status_Illegal_Interface_Membership_Incompatible;
      elsif Row.Controlling_Operand_Mismatch then
         return Status_Illegal_Controlling_Operand_Mismatch;
      elsif Row.Dispatching_Candidate_Set_Disagrees then
         return Status_Illegal_Dispatching_Candidate_Set_Disagrees;
      elsif Row.Abstract_Primitive_Unavailable then
         return Status_Illegal_Abstract_Primitive_Unavailable;
      ...
      elsif Row.Gap = Remaining_Class_Wide_Membership_Dispatching_Edge then
         return Status_Class_Wide_Membership_Dispatching_Resolved;
              else
           ...
           begin
              return Row.Id * 47
                ...
                + Class_Wide_Membership_Dispatch_Form'Pos (Row.Form) * 7
...
end Editor.Ada_RM_Remediation.Tagged_Types.Classwide_Membership_Conversion;
