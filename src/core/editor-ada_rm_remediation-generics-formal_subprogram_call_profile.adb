...
package body Editor.Ada_RM_Remediation.Generics.Formal_Subprogram_Call_Profile is
   ...
   begin
      case Status is
         ...
         when Status_Runtime_Profile_Check_Preserved =>
            return Precision.Class_Legal_With_Runtime_Check;
         when Status_Illegal_Missing_Formal_Subprogram_Actual
         ...
         when Status_Indeterminate_Private_Formal_View
   ...
   begin
      ...
      elsif Row.Formal_Subprogram_Fingerprint /= Row.Expected_Formal_Subprogram_Fingerprint then
         return Status_Formal_Subprogram_Fingerprint_Mismatch;
      elsif Row.Substitution_Fingerprint /= Row.Expected_Substitution_Fingerprint then
         return Status_Substitution_Fingerprint_Mismatch;
   ...
   begin
      if Status /= Status_Not_Checked then
         return Status;
      elsif Row.Stale_Generic_Call_Evidence then
         return Status_Indeterminate_Stale_Generic_Call_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_Formal_View;
      elsif Row.Missing_Profile_Evidence
        or else not Row.Complete_Profile_Evidence
      then
         return Status_Indeterminate_Missing_Profile_Evidence;
      elsif Row.Missing_Substitution_Evidence
        or else not Row.Complete_Substitution_Evidence
      then
         return Status_Indeterminate_Missing_Substitution_Evidence;
      elsif Row.Missing_Formal_Subprogram_Actual then
         return Status_Illegal_Missing_Formal_Subprogram_Actual;
      elsif Row.Default_Subprogram_Profile_Mismatch then
         return Status_Illegal_Default_Subprogram_Profile_Mismatch;
      elsif Row.Mode_Conformance_Mismatch then
         return Status_Illegal_Mode_Conformance_Mismatch;
      elsif Row.Null_Exclusion_Actual_Mismatch then
         return Status_Illegal_Null_Exclusion_Actual_Mismatch;
      elsif Row.Abstract_Subprogram_Actual then
         return Status_Illegal_Abstract_Subprogram_Actual;
      elsif Row.Runtime_Profile_Check_Preserved
        or else Row.Form = Form_Runtime_Profile_Check_Preserved
      then
         return Status_Runtime_Profile_Check_Preserved;
      elsif Row.Warning_Only_Preserved
        or else Row.Form = Form_Warning_Only_Preserved
      then
         return Status_Warning_Only_Preserved;
      elsif Row.Form = Form_Default_Subprogram_Call_Resolved then
         return Status_Default_Subprogram_Call_Resolved;
      elsif Row.Gap = Remaining_Generic_Formal_Subprogram_Call_Edge then
         return Status_Generic_Formal_Subprogram_Call_Resolved;
      else
   ...
   begin
      return Row.Id * 79
        ...
        + Generic_Formal_Subprogram_Call_Form'Pos (Row.Form) * 13
        + Row.Source_Fingerprint
        + Row.AST_Fingerprint
        + Row.Type_Fingerprint
        + Row.Profile_Fingerprint
        + Row.Formal_Subprogram_Fingerprint
