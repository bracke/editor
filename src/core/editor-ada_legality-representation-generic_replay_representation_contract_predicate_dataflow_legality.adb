...
package body Editor.Ada_Legality.Representation.Generic_Replay_Representation_Contract_Predicate_Dataflow_Legality is
   ...
   function Mix (Left, Right : Natural) return Natural is
      Hash : constant Long_Long_Integer :=
        (Long_Long_Integer (Left) * 16_777_619 +
         Long_Long_Integer (Right) +
   ...
   function Status_From_Representation_CPD
     (Status : Rep_CPD.Representation_Tasking_CPD_Status) return Generic_Replay_Representation_Status is
   begin
      case Status is
         when Rep_CPD.Representation_Tasking_CPD_Base_Freezing_Error |
              Rep_CPD.Representation_Tasking_CPD_Representation_Freezing_Blocker =>
            return Generic_Replay_Representation_Base_Freezing_Error;
         when Rep_CPD.Representation_Tasking_CPD_Missing_Tasking_CPD_Row |
              Rep_CPD.Representation_Tasking_CPD_Missing_Elaboration_Predicate_Row |
              Rep_CPD.Representation_Tasking_CPD_Missing_Contract_Predicate_Row |
              Rep_CPD.Representation_Tasking_CPD_Not_Checked =>
            return Generic_Replay_Representation_Missing_Representation_CPD_Row;
         when Rep_CPD.Representation_Tasking_CPD_Base_Contract_Error =>
            return Generic_Replay_Representation_Base_Contract_Flow_Error;
         when Rep_CPD.Representation_Tasking_CPD_Base_Elaboration_Error =>
            return Generic_Replay_Representation_Base_Elaboration_Error;
         when Rep_CPD.Representation_Tasking_CPD_Base_Tasking_Effect_Error =>
            return Generic_Replay_Representation_Base_Tasking_Effect_Error;
         when Rep_CPD.Representation_Tasking_CPD_Predicate_Propagation_Blocker =>
            return Generic_Replay_Representation_Replay_Predicate_Error;
         when Rep_CPD.Representation_Tasking_CPD_Read_Before_Write_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Component_Read_Before_Write_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Partial_Initialization_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Missing_Out_Assignment_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Conditional_In_Out_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Return_Object_Initialization_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Branch_Loop_Merge_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Exception_Finalization_Path_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Use_After_Finalization_Blocker =>
            return Generic_Replay_Representation_Linked_Flow_Graph_Error;
         when Rep_CPD.Representation_Tasking_CPD_Lifetime_Accessibility_Blocker =>
            return Generic_Replay_Representation_Replay_Accessibility_Error;
         when Rep_CPD.Representation_Tasking_CPD_Discriminant_Variant_Blocker =>
            return Generic_Replay_Representation_Base_Representation_CPD_Error;
         when Rep_CPD.Representation_Tasking_CPD_Global_Depends_Blocker =>
            return Generic_Replay_Representation_Base_Contract_Flow_Error;
         when Rep_CPD.Representation_Tasking_CPD_Call_Propagation_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Generic_Flow_Blocker |
              Rep_CPD.Representation_Tasking_CPD_Tasking_Protected_Flow_Blocker =>
            return Generic_Replay_Representation_Call_Effect_Not_Propagated;
         when Rep_CPD.Representation_Tasking_CPD_Coverage_Blocker =>
            return Generic_Replay_Representation_Coverage_Feedback_Blocker;
         when Rep_CPD.Representation_Tasking_CPD_Multiple_Tasking_CPD_Blockers =>
            return Generic_Replay_Representation_Multiple_Representation_CPD_Blockers;
         when Rep_CPD.Representation_Tasking_CPD_Tasking_CPD_Indeterminate |
              Rep_CPD.Representation_Tasking_CPD_Indeterminate =>
            return Generic_Replay_Representation_Representation_CPD_Indeterminate;
         when others =>
            return Generic_Replay_Representation_Base_Representation_CPD_Error;
      end case;
   end Status_From_Representation_CPD;
   ...
   begin
      ...
      elsif Info.Representation_CPD_Matches > 1 then
         return Generic_Replay_Representation_Multiple_Representation_CPD_Blockers;
      elsif Info.Representation_CPD_Row = Rep_CPD.No_Representation_Tasking_CPD_Row then
         return Generic_Replay_Representation_Missing_Representation_CPD_Row;
      elsif Rep_CPD.Is_Legal (Info.Representation_CPD_Status) then
         return Legal_Status_For_Kind (Info.Kind);
      else
         return Status_From_Representation_CPD (Info.Representation_CPD_Status);
      end if;
   end Status_For;
   ...
   begin
      ...
      H := Mix (H, Info.Representation_CPD_Matches + 1);
   ...
   begin
      case Status is
         when Generic_Replay_Representation_Base_Replay_Error =>
            return To_Unbounded_String ("generic body replay legality failed before representation contract-predicate-dataflow consumption");
         ...
         when Generic_Replay_Representation_Missing_Representation_CPD_Row =>
         ...
         when Generic_Replay_Representation_Multiple_Representation_CPD_Blockers =>
            return To_Unbounded_String ("generic body replay has multiple matching representation contract-predicate-dataflow blockers");
         when Generic_Replay_Representation_Representation_CPD_Indeterminate |
              Generic_Replay_Representation_Indeterminate =>
            return To_Unbounded_String ("generic body replay representation contract-predicate-dataflow result is indeterminate");
         when others =>
            if Is_Legal (Status) then
               return To_Unbounded_String ("generic body replay representation contract-predicate-dataflow consumer accepted");
            else
               return To_Unbounded_String ("generic body replay representation contract-predicate-dataflow blocker");
            end if;
      end case;
   end Message_For;
         ...
         begin
            ...
            Row :=
              (Id => Generic_Replay_Representation_Row_Id (I),
               ...
               Representation_CPD_Status => C.Representation_CPD_Status,
               Representation_CPD_Matches => C.Representation_CPD_Matches,
            ...
            if Status in Generic_Replay_Representation_Base_Representation_CPD_Error |
                         Generic_Replay_Representation_Base_Freezing_Error |
                         Generic_Replay_Representation_Missing_Representation_CPD_Row then
            ...
            if Status in Generic_Replay_Representation_Representation_CPD_Indeterminate |
...
end Editor.Ada_Legality.Representation.Generic_Replay_Representation_Contract_Predicate_Dataflow_Legality;
