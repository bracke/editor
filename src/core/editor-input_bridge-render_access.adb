...
package body Editor.Input_Bridge.Render_Access is
   ...
   begin
      ...
      return Editor.Problems.Visible_Snapshot (Full, S.Panel.Problems_View, Rows);
   ...
   begin
      return Editor.Panel_Focus.Bottom_Panel_Has_Focus (S.Panel.Panel_Focus)
   ...
   begin
      return S.Panel.Feature_Panel;
   end Feature_Panel_For_Render;

   function Feature_Panel_Focused_For_Render
     (S : Editor.State.State_Type) return Boolean is
   begin
      return Editor.Feature_Panel.Is_Focused (S.Panel.Feature_Panel);
   ...
   begin
      if S.Panel.Active_Diagnostic.Has_Active then
         return S.Panel.Active_Diagnostic.Index;
      else
