...
package body Editor.Ada_Legality.Representation.Discriminant_Variant_Record_Legality is
...
end Editor.Ada_Legality.Representation.Discriminant_Variant_Record_Legality;
