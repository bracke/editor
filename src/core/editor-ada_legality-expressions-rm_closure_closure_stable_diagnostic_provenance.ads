...
package Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Diagnostic_Provenance is
   ...
   package Diag renames Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Diagnostic_Integration;
...
end Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Diagnostic_Provenance;
