...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Diagnostic_Provenance is
   ...
   package Diagnostics renames Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Diagnostic_Integration;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stable_Closure_Diagnostic_Provenance;
