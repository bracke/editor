...
package Editor.Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality is
   ...
   package Tasking_Flow renames Editor.Ada_Legality.Tasking.Repair_Elaboration_Contract_Flow;
...
end Editor.Ada_Legality.Tasking.Representation_Tasking_Elaboration_Flow_Legality;
