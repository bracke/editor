...
package Editor.Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration is
   ...
   package Predicate renames Editor.Ada_Legality.Dataflow.Predicate_RM_Closure_Closure_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration;
