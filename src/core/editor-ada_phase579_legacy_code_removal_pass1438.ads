...
package Editor.Ada_Phase579_Legacy_Code_Removal_Pass1438 is

   --  Pass1438 performs the second destructive legacy-code removal after the
   --  Phase 579 project-scale closure.  It removes the obsolete diagnostic
   --  recovery render final status leaf, which is superseded by the final
   --  diagnostic quality and project-scale closure gates.  Like pass1437,
