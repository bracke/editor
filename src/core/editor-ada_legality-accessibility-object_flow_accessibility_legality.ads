...
package Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality is
   ...
   package Access_Consumers renames Editor.Ada_Legality.Accessibility.Scope_Legality;
...
end Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
