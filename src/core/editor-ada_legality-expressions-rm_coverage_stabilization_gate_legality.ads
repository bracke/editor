...
package Editor.Ada_Legality.Expressions.RM_Coverage_Stabilization_Gate_Legality is
   ...
   package Conv renames Editor.Ada_Legality.Expressions.RM_Coverage_Review_Convergence_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Stabilization_Gate_Legality;
