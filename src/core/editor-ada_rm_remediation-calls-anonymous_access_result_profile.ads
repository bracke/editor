...
package Editor.Ada_RM_Remediation.Calls.Anonymous_Access_Result_Profile is

   --  Case 1412 remediates a concrete remaining gap extracted by the final
   --  inventory: anonymous access result profiles must be checked as one
   --  callable-profile and accessibility result, including null exclusions,
   --  access-to-subprogram conventions, runtime accessibility checks, and
   --  consumer-visible blocker identity.
   ...
   type Anonymous_Access_Return_Closure is
     (Closure_Return_Profile,
      Closure_Accessibility_Master,
      Closure_Null_Exclusion,
      Closure_Consumer,
      Closure_Unknown);

   type Anonymous_Access_Return_Form is
     (Form_Anonymous_Access_Return_Profile_Resolved,
      Form_Runtime_Accessibility_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Result_Profile_Mode_Mismatch,
      Form_Illegal_Return_Object_Accessibility_Escape,
      Form_Illegal_Null_Exclusion_Default_Null,
      Form_Illegal_Access_To_Subprogram_Convention_Mismatch,
      Form_Illegal_Anonymous_Access_Discriminant_Profile,
      Form_Indeterminate_Private_View,
      Form_Indeterminate_Missing_Profile_Evidence,
      Form_Indeterminate_Missing_Accessibility_Evidence,
      Form_Indeterminate_Stale_Profile_Evidence,
      Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
      Status_Gap_Remediated,
      Status_Anonymous_Access_Return_Profile_Resolved,
      Status_Runtime_Accessibility_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Result_Profile_Mode_Mismatch,
      Status_Illegal_Return_Object_Accessibility_Escape,
      Status_Illegal_Null_Exclusion_Default_Null,
      Status_Illegal_Access_To_Subprogram_Convention_Mismatch,
      Status_Illegal_Anonymous_Access_Discriminant_Profile,
      ...
      Status_Indeterminate_Stale_Profile_Evidence,
   ...
   type Remediation_Row is record
      ...
      Closure : Anonymous_Access_Return_Closure := Closure_Return_Profile;
      Form : Anonymous_Access_Return_Form := Form_Anonymous_Access_Return_Profile_Resolved;
      ...
      Complete_Return_Profile_Evidence : Boolean := True;
      Complete_Accessibility_Evidence : Boolean := True;
      Consumer_Profile_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Profile_Evidence : Boolean := False;
      Missing_Accessibility_Evidence : Boolean := False;
      Stale_Profile_Evidence : Boolean := False;
      Result_Profile_Mode_Mismatch : Boolean := False;
      Return_Object_Accessibility_Escape : Boolean := False;
      Null_Exclusion_Default_Null : Boolean := False;
      Access_To_Subprogram_Convention_Mismatch : Boolean := False;
      Anonymous_Access_Discriminant_Profile : Boolean := False;
...
end Editor.Ada_RM_Remediation.Calls.Anonymous_Access_Result_Profile;
