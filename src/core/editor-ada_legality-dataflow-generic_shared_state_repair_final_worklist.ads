...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Worklist is
   ...
   package Diagnostics renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Diagnostics;
...
end Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Worklist;
