...
package Editor.Ada_Legality.Elaboration.Generic_Shared_State_RM_Closure_Legality is
...
end Editor.Ada_Legality.Elaboration.Generic_Shared_State_RM_Closure_Legality;
