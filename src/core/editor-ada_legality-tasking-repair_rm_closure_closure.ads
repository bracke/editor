...
package Editor.Ada_Legality.Tasking.Repair_RM_Closure_Closure is
   ...
   package Prior renames Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_RM_Closure;
...
end Editor.Ada_Legality.Tasking.Repair_RM_Closure_Closure;
