...
package Editor.Ada_Legality.Representation.Generic_Shared_State_RM_Edge_Case_Legality is
...
end Editor.Ada_Legality.Representation.Generic_Shared_State_RM_Edge_Case_Legality;
