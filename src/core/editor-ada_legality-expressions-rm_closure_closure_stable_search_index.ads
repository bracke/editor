...
package Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Search_Index is
...
end Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Search_Index;
