...
package Editor.Ada_Canonical_Semantic_Model_Agreement_Audit is

   --  Canonical semantic model agreement audit is part of the post
...
end Editor.Ada_Canonical_Semantic_Model_Agreement_Audit;
