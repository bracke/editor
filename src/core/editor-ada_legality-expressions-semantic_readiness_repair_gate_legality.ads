...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Gate_Legality is
   ...
   package Remediation renames Editor.Ada_Legality.Expressions.Semantic_Readiness_Blocker_Repair_Order;
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Gate_Legality;
