...
package Editor.Ada_RM_Remediation.Representation.Discriminant_Variant_Representation is

   --  Case 1389 remediates a concrete remaining gap extracted by the final
   --  inventory: discriminant variant record representations over discriminated records and array-like
   --  aggregates must preserve discriminant, variant, controlled-component,
   --  range/predicate, private-view, and consumer evidence as one canonical
   --  result instead of allowing representation, aggregate, layout, and diagnostic consumers to
   ...
   type Remediated_Gap_Family is
     (Remaining_Record_Layout_Variant_Component_Edge,
      Remaining_Record_Rep_Component_Clause_Edge,
      Remaining_Gap_Unknown);

   type Representation_Closure is
     (Closure_Record_Representation,
      Closure_Record_Component,
      Closure_Array_Component,
      Closure_Discriminant,
      Closure_Variant,
      Closure_Unknown);

   type Representation_Form is
     (Form_Record_Component_Layout_Resolved,
      Form_Runtime_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Variant_Component_Overlap,
      Form_Illegal_Discriminant_Dependent_Layout,
      Form_Illegal_Controlled_Component_Layout,
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Record_Component_Layout_Resolved,
      Status_Runtime_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Variant_Component_Overlap,
      Status_Illegal_Discriminant_Dependent_Layout,
      Status_Illegal_Controlled_Component_Layout,
   ...
   type Remediation_Row is record
      ...
      Owner : Implementing_Slice := Matrix.Slice_Record_Layout_Representation;
      ...
      Closure : Representation_Closure := Closure_Record_Representation;
      Form : Representation_Form := Form_Record_Component_Layout_Resolved;
      ...
      Variant_Component_Overlap : Boolean := False;
      Discriminant_Dependent_Layout : Boolean := False;
      Controlled_Component_Layout : Boolean := False;
      ...
      Consumer_Representation_State_Agrees : Boolean := True;
...
end Editor.Ada_RM_Remediation.Representation.Discriminant_Variant_Representation;
