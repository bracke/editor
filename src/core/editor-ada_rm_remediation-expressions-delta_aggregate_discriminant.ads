...
package Editor.Ada_RM_Remediation.Expressions.Delta_Aggregate_Discriminant is

   --  Case 1388 remediates a concrete remaining gap extracted by the final
   --  inventory: delta aggregates over discriminated records and array-like
   ...
   --  result instead of allowing aggregate, assignment, and predicate slices to
   ...
   type Remediated_Gap_Family is
     (Remaining_Delta_Aggregate_Discriminant_Update_Edge,
      Remaining_Aggregate_Component_Update_Edge,
      Remaining_Gap_Unknown);

   type Aggregate_Closure is
     (Closure_Delta_Aggregate,
   ...
   type Aggregate_Form is
     (Form_Current_Delta_Update_Resolved,
      Form_Runtime_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Inactive_Variant_Update,
      Form_Illegal_Discriminant_Mismatch,
      Form_Illegal_Controlled_Component_Update,
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Illegal_Inactive_Variant_Update,
   ...
   type Remediation_Row is record
      ...
      Closure : Aggregate_Closure := Closure_Delta_Aggregate;
      Form : Aggregate_Form := Form_Current_Delta_Update_Resolved;
      ...
      Inactive_Variant_Update : Boolean := False;
      Discriminant_Mismatch : Boolean := False;
      Controlled_Component_Update : Boolean := False;
