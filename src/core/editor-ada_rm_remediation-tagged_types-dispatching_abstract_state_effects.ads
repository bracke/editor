...
package Editor.Ada_RM_Remediation.Tagged_Types.Dispatching_Abstract_State_Effects is

   --  Case 1427 remediates a concrete remaining gap extracted by the frozen
   --  inventory: dispatching calls with abstract-state, Global and Depends
   --  effects, overriding effect conformance, class-wide effect conflicts,
   --  runtime dispatching/effect checks, warning diagnostics, stale
   --  abstract-state evidence, and semantic consumers must be checked as
   --  one source-shaped Ada legality result. The closure preserves legal,
   --  illegal, runtime-check, warning-only, indeterminate, consumer, final-
   --  gate, and fingerprint freshness outcomes under one stable blocker
   --  family.
   ...
   type Dispatching_Abstract_State_Effect_Closure is
     (Closure_Dispatching_Target_Evidence,
     Closure_Abstract_State_Evidence,
     Closure_Global_Depends_Effect,
     Closure_Contract_Consumer,
     Closure_Unknown);

   type Dispatching_Abstract_State_Effect_Form is
     (Form_Dispatching_Abstract_State_Effect_Resolved,
     Form_Global_Depends_Dispatching_Resolved,
     Form_Runtime_Dispatching_Effect_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Abstract_State_Refinement_Mismatch,
     Form_Illegal_Dispatching_Global_Effect_Mismatch,
     Form_Illegal_Depends_Coverage_Missing,
     Form_Illegal_Overriding_Effect_Weakening,
     Form_Illegal_Class_Wide_Effect_Conflict,
     Form_Indeterminate_Private_State_View,
     Form_Indeterminate_Missing_Abstract_State_Evidence,
     Form_Indeterminate_Missing_Dispatching_Effect_Evidence,
     Form_Indeterminate_Stale_Abstract_State_Evidence,
     Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
     Status_Gap_Remediated,
     Status_Dispatching_Abstract_State_Effect_Resolved,
     Status_Global_Depends_Dispatching_Resolved,
     Status_Runtime_Dispatching_Effect_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Abstract_State_Refinement_Mismatch,
     Status_Illegal_Dispatching_Global_Effect_Mismatch,
     Status_Illegal_Depends_Coverage_Missing,
     Status_Illegal_Overriding_Effect_Weakening,
     Status_Illegal_Class_Wide_Effect_Conflict,
     Status_Indeterminate_Private_State_View,
     Status_Indeterminate_Missing_Abstract_State_Evidence,
     Status_Indeterminate_Missing_Dispatching_Effect_Evidence,
     Status_Indeterminate_Stale_Abstract_State_Evidence,
     ...
     Status_Abstract_State_Fingerprint_Mismatch,
     Status_Dispatching_Effect_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Family : RM_Family := Matrix.Family_Contracts_Global_Depends_Flow;
      Owner : Implementing_Slice := Matrix.Slice_Abstract_State_Global_Depends;
      ...
      Closure : Dispatching_Abstract_State_Effect_Closure := Closure_Dispatching_Target_Evidence;
      Form : Dispatching_Abstract_State_Effect_Form := Form_Dispatching_Abstract_State_Effect_Resolved;
      ...
      Complete_Abstract_State_Evidence : Boolean := True;
      Complete_Dispatching_Effect_Evidence : Boolean := True;
      Consumer_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Abstract_State_Evidence : Boolean := False;
      Missing_Dispatching_Effect_Evidence : Boolean := False;
      Stale_Abstract_State_Evidence : Boolean := False;
      Abstract_State_Refinement_Mismatch : Boolean := False;
      Dispatching_Global_Effect_Mismatch : Boolean := False;
      Depends_Coverage_Missing : Boolean := False;
      Overriding_Effect_Weakening : Boolean := False;
      Class_Wide_Effect_Conflict : Boolean := False;
      Runtime_Dispatching_Effect_Check_Preserved : Boolean := False;
      ...
      Abstract_State_Fingerprint : Natural := 0;
      Expected_Abstract_State_Fingerprint : Natural := 0;
      Dispatching_Effect_Fingerprint : Natural := 0;
      Expected_Dispatching_Effect_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Tagged_Types.Dispatching_Abstract_State_Effects;
