...
package Editor.Ada_RM_Remediation.Expressions.Aggregate_Source_Legality is

   --  Case 1343 is the first RM gap burn-down case after the integration
...
end Editor.Ada_RM_Remediation.Expressions.Aggregate_Source_Legality;
