package body Editor.Ada_RM_Remediation.Visibility.Declaration_Scope_Completion is
...
end Editor.Ada_RM_Remediation.Visibility.Declaration_Scope_Completion;
