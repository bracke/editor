...
package Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality is
...
end Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
