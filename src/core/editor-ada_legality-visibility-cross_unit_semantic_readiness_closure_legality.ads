...
with Editor.Ada_Integrated_Semantic_Closure.Chain;
...
package Editor.Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality is
   ...
   package Consumer_Chain renames Editor.Ada_Integrated_Semantic_Closure.Chain;
   ...
   package Tasking_Final renames Editor.Ada_Legality.Tasking.Repair_Protected_Final_Effects;
...
end Editor.Ada_Legality.Visibility.Cross_Unit_Semantic_Readiness_Closure_Legality;
