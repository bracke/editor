...
package Editor.Ada_Legality.Representation.RM_Closure_Closure_Legality is

   --  Case 1265 representation RM-completion closure consumer legality.
   --
   ...
   package Prior renames Editor.Ada_Legality.Representation.Generic_Shared_State_RM_Edge_Case_Legality;
...
end Editor.Ada_Legality.Representation.RM_Closure_Closure_Legality;
