...
package Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master is

      --  Case 1409 remediates a concrete remaining gap extracted by the final
      ...
      type Remediated_Gap_Family is
        (Remaining_Access_Parameter_Allocator_Master_Edge,
         Remaining_Gap_Unknown);

      type Access_Parameter_Allocator_Master_Closure is
        (Closure_Access_Parameter_Association,
Closure_Allocator_Master_Lifetime,
Closure_Storage_Pool_Consumer,
Closure_Unknown);

      type Access_Parameter_Allocator_Master_Form is
        (Form_Access_Parameter_Allocator_Master_Resolved,
Form_Runtime_Accessibility_Check_Preserved,
Form_Warning_Only_Preserved,
Form_Illegal_Static_Accessibility_Escape,
Form_Illegal_Null_Exclusion_Violation,
Form_Illegal_Storage_Pool_Mismatch,
Form_Illegal_Unchecked_Deallocation_Hazard,
Form_Illegal_Controlled_Allocation_Finalization_Hazard,
Form_Indeterminate_Private_View,
Form_Indeterminate_Missing_Master_Evidence,
Form_Indeterminate_Stale_Lifetime_Evidence,
Form_Unknown);

      type Remediation_Status is
        (Status_Not_Checked,
Status_Gap_Remediated,
Status_Access_Parameter_Allocator_Master_Resolved,
...
Status_Illegal_Storage_Pool_Mismatch,
Status_Illegal_Unchecked_Deallocation_Hazard,
Status_Illegal_Controlled_Allocation_Finalization_Hazard,
...
Status_Indeterminate);
      ...
      type Remediation_Row is record
         ...
         Closure : Access_Parameter_Allocator_Master_Closure := Closure_Access_Parameter_Association;
         Form : Access_Parameter_Allocator_Master_Form := Form_Access_Parameter_Allocator_Master_Resolved;
 ...
 Storage_Pool_Mismatch : Boolean := False;
 Unchecked_Deallocation_Hazard : Boolean := False;
 Controlled_Allocation_Finalization_Hazard : Boolean := False;
 ...
 Warning_Only_Preserved : Boolean := False;
         Complete_Master_Evidence : Boolean := True;
 Consumer_Lifetime_State_Agrees : Boolean := True;
...
end Editor.Ada_RM_Remediation.Accessibility.Access_Parameter_Allocator_Master;
