...
package Editor.Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality is
   ...
   package Pred_Flow renames Editor.Ada_Legality.Dataflow.Predicate_Dataflow_Initialization_Legality;
...
end Editor.Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality;
