...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Stabilization is
   ...
   package Conv renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Convergence;
...
end Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Stabilization;
