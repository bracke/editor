      ...
      then
         case Chord.Key is
            when Editor.Keybindings.Key_Up =>
               Execute (Editor.Command_Ids.Command_Terminal_Select_Previous_Task);
            when Editor.Keybindings.Key_Down =>
               Execute (Editor.Command_Ids.Command_Terminal_Select_Next_Task);
            when Editor.Keybindings.Key_Enter =>
               Execute (Editor.Command_Ids.Command_Terminal_Run_Selected_Task);
            when Editor.Keybindings.Key_Escape =>
               Execute (Editor.Command_Ids.Command_Focus_Editor_Text);
            when Editor.Keybindings.Key_Delete =>
               Execute (Editor.Command_Ids.Command_Terminal_Clear_Output);
            when others =>
               return False;
         end case;
         Notify_Input;
         ...
         case Chord.Key is
            ...
            when Editor.Keybindings.Key_Down =>
               Execute (Editor.Command_Ids.Command_Select_Next_Recent_Project);
            when Editor.Keybindings.Key_Enter =>
               Execute (Editor.Command_Ids.Command_Open_Selected_Recent_Project);
            when Editor.Keybindings.Key_Escape =>
               Execute (Editor.Command_Ids.Command_Focus_Editor_Text);
            when Editor.Keybindings.Key_Delete =>
               Execute (Editor.Command_Ids.Command_Remove_Selected_Recent_Project);
            when others =>
               return False;
         end case;
         Notify_Input;
         ...
         then
            case Chord.Key is
               when Editor.Keybindings.Key_Up =>
                  Execute (Editor.Command_Ids.Command_Search_Results_Move_Up);
               when Editor.Keybindings.Key_Down =>
                  Execute (Editor.Command_Ids.Command_Search_Results_Move_Down);
               when Editor.Keybindings.Key_Page_Up =>
                  Execute (Editor.Command_Ids.Command_Search_Results_Page_Up);
               when Editor.Keybindings.Key_Page_Down =>
                  Execute (Editor.Command_Ids.Command_Search_Results_Page_Down);
               when Editor.Keybindings.Key_Enter =>
                  Execute (Editor.Command_Ids.Command_Search_Results_Open_Selected);
               when Editor.Keybindings.Key_Escape =>
                  Execute (Editor.Command_Ids.Command_Focus_Editor_Text);
               when others =>
                  return False;
         ...
         then
            case Chord.Key is
               when Editor.Keybindings.Key_Up =>
                  Execute (Editor.Command_Ids.Command_Problems_Move_Up);
               when Editor.Keybindings.Key_Down =>
                  Execute (Editor.Command_Ids.Command_Problems_Move_Down);
               when Editor.Keybindings.Key_Page_Up =>
                  Execute (Editor.Command_Ids.Command_Problems_Page_Up);
               when Editor.Keybindings.Key_Page_Down =>
                  Execute (Editor.Command_Ids.Command_Problems_Page_Down);
               when Editor.Keybindings.Key_Enter =>
                  Execute (Editor.Command_Ids.Command_Problems_Open_Selected);
               when Editor.Keybindings.Key_Escape =>
                  Execute (Editor.Command_Ids.Command_Problems_Focus_Editor);
               when others =>
                  return False;
            end case;
            Notify_Input;
