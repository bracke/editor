...
package Editor.Ada_RM_Remediation.Finalization.Controlled_Discriminant_Finalization is

   --  Case 1421 remediates a concrete remaining gap extracted by the frozen
   --  inventory: controlled components governed by discriminants, finalized
   ...
   type Controlled_Finalized_Discriminant_Closure is
     (Closure_Controlled_Component_Evidence,
     Closure_Discriminant_Default_Evidence,
     Closure_Finalization_Order_Evidence,
     Closure_Finalization_Consumer,
     Closure_Unknown);

   type Controlled_Finalized_Discriminant_Form is
     (Form_Controlled_Discriminant_Component_Resolved,
     Form_Finalization_Order_Resolved,
     Form_Runtime_Finalization_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Controlled_Component_Depends_On_Mutable_Discriminant,
     Form_Illegal_Discriminant_Default_Finalized_Object,
     Form_Illegal_Limited_Controlled_Discriminant_Copy,
     Form_Illegal_Premature_Finalization_During_Assignment,
     Form_Illegal_Component_Finalization_Order_Conflict,
     Form_Indeterminate_Private_Controlled_View,
     Form_Indeterminate_Missing_Discriminant_Evidence,
     Form_Indeterminate_Missing_Finalization_Evidence,
     Form_Indeterminate_Stale_Finalization_Evidence,
     Form_Unknown);
   ...
   type Remediation_Status is
     ...
     Status_Illegal_Controlled_Component_Depends_On_Mutable_Discriminant,
     ...
     Status_Indeterminate_Private_Controlled_View,
   ...
   type Remediation_Row is record
      ...
      Closure : Controlled_Finalized_Discriminant_Closure := Closure_Controlled_Component_Evidence;
      Form : Controlled_Finalized_Discriminant_Form := Form_Controlled_Discriminant_Component_Resolved;
      ...
      Complete_Discriminant_Evidence : Boolean := True;
      Complete_Finalization_Evidence : Boolean := True;
      Consumer_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Discriminant_Evidence : Boolean := False;
      Missing_Finalization_Evidence : Boolean := False;
      Stale_Finalization_Evidence : Boolean := False;
      Controlled_Component_Depends_On_Mutable_Discriminant : Boolean := False;
      Discriminant_Default_Finalized_Object : Boolean := False;
      Limited_Controlled_Discriminant_Copy : Boolean := False;
      Premature_Finalization_During_Assignment : Boolean := False;
      Component_Finalization_Order_Conflict : Boolean := False;
      Runtime_Finalization_Check_Preserved : Boolean := False;
      ...
      Discriminant_Fingerprint : Natural := 0;
      Expected_Discriminant_Fingerprint : Natural := 0;
