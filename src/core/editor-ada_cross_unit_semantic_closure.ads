...
package Editor.Ada_Cross_Unit_Semantic_Closure is
   ...
   type Cross_Unit_Semantic_Context_Info is record
      ...
      Linked_Tasking     : Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Context_Id :=
        Editor.Ada_Legality.Tasking.Repair_Protected_Legality.No_Tasking_Context;
   ...
   type Cross_Unit_Semantic_Info is record
      ...
      Linked_Tasking_Status : Editor.Ada_Legality.Tasking.Repair_Protected_Legality.Tasking_Legality_Status :=
