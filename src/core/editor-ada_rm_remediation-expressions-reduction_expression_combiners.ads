...
package Editor.Ada_RM_Remediation.Expressions.Reduction_Expression_Combiners is

   --  Case 1394 remediates a concrete remaining gap extracted by the final
   --  inventory: reduction expression combiner/profile and combiner evidence must agree with
   --  reduction domain resolution, static combiner evaluation,
   --  side-effect ordering, contract guards, control-flow guards,
   ...
   type Remediated_Gap_Family is
     (Remaining_Reduction_Expression_Combiner_Profile_Edge,
      Remaining_Reduction_Profile_Seed_Effect_Order_Edge,
      Remaining_Gap_Unknown);

   type Reduction_Closure is
     (Closure_Reduction_Expression,
      Closure_Reduction_Reduction,
      Closure_Reduction_Combiner,
      Closure_Contract_Reduction,
      Closure_Control_Flow_Reduction,
      Closure_Unknown);

   type Reduction_Form is
     (Form_Reduction_Combiner_Resolved,
      Form_Runtime_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Non_Reducible_Domain,
      Form_Illegal_Seed_Type_Mismatch,
      Form_Illegal_Combiner_Profile_Mismatch,
      Form_Indeterminate_Private_View,
      Form_Indeterminate_Stale_Reduction_Evidence,
      Form_Unknown);
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Illegal_Non_Reducible_Domain,
   ...
   type Remediation_Row is record
      ...
      Closure : Reduction_Closure := Closure_Reduction_Expression;
      Form : Reduction_Form := Form_Reduction_Combiner_Resolved;
      ...
      Non_Reducible_Domain : Boolean := False;
      Seed_Type_Mismatch : Boolean := False;
      Combiner_Profile_Mismatch : Boolean := False;
      Stale_Reduction_Evidence : Boolean := False;
      ...
      Complete_Reduction_Evidence : Boolean := True;
      Consumer_Reduction_State_Agrees : Boolean := True;
      ...
      Combiner_Fingerprint : Natural := 0;
      Expected_Combiner_Fingerprint : Natural := 0;
