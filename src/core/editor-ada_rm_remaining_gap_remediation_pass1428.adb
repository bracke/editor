...
package body Editor.Ada_RM_Remaining_Gap_Remediation_Pass1428 is
   ...
   begin
      ...
      elsif not Row.Core_Suite_Registration_Present then
         return Status_Missing_Core_Suite_Registration;
