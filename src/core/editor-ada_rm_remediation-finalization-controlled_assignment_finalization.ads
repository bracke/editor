...
package Editor.Ada_RM_Remediation.Finalization.Controlled_Assignment_Finalization is

   --  Case 1381 remediates a concrete remaining gap extracted by the final
