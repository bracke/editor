...
with Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
with Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
with Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
...
with Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
with Editor.Ada_Syntax_Tree;
with Editor.Ada_Legality.Tasking.Repair_Protected_Effects;

package Editor.Ada_Legality.Tasking.Repair_Contract_Predicate_Dataflow is
   ...
   package Task_Effects renames Editor.Ada_Legality.Tasking.Repair_Protected_Effects;
   package Elab_Predicate renames Editor.Ada_Legality.Elaboration.Contract_Predicate_Dataflow_Legality;
   package Contract_Predicate renames Editor.Ada_Legality.Dataflow.Contract_Predicate_Dataflow_Legality;
   package Dataflow_Init renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Legality;
   package Init_Object_Flow renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
   package Discriminant_Representation renames Editor.Ada_Legality.Representation.Discriminant_Generic_Representation_Legality;
   package Object_Flow renames Editor.Ada_Legality.Accessibility.Object_Flow_Accessibility_Legality;
...
end Editor.Ada_Legality.Tasking.Repair_Contract_Predicate_Dataflow;
