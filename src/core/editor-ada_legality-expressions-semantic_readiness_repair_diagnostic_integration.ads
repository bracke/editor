...
package Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Integration is
...
end Editor.Ada_Legality.Expressions.Semantic_Readiness_Repair_Diagnostic_Integration;
