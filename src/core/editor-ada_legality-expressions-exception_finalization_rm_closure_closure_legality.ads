...
package Editor.Ada_Legality.Expressions.Exception_Finalization_RM_Closure_Closure_Legality is
   ...
   package Prior renames Editor.Ada_Legality.Generics.Exception_Finalization_Generic_Shared_State_RM_Closure_Legality;
...
end Editor.Ada_Legality.Expressions.Exception_Finalization_RM_Closure_Closure_Legality;
