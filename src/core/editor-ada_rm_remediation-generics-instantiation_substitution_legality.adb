package body Editor.Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality is
...
end Editor.Ada_RM_Remediation.Generics.Instantiation_Substitution_Legality;
