...
package Editor.Ada_Generic_Shared_State_Remediation.RM_Completion_Recheck_Convergence is
   ...
   package Apply renames Editor.Ada_Generic_Shared_State_Remediation.RM_Completion_Recheck_Application;
...
end Editor.Ada_Generic_Shared_State_Remediation.RM_Completion_Recheck_Convergence;
