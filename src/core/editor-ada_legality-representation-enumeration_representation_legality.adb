...
package body Editor.Ada_Legality.Representation.Enumeration_Representation_Legality is
...
end Editor.Ada_Legality.Representation.Enumeration_Representation_Legality;
