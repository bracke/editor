package body Editor.Ada_RM_Remediation.Elaboration.Configuration_Restriction_Policy is
...
end Editor.Ada_RM_Remediation.Elaboration.Configuration_Restriction_Policy;
