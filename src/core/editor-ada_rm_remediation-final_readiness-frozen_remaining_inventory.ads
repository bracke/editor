...
package Editor.Ada_RM_Remediation.Final_Readiness.Frozen_Remaining_Inventory is

   --  Case 1428 freezes the finite remaining-gap inventory selected after
   --  case 1418.  It is deliberately not a broad new audit layer: it records
   --  the nine closed concrete edges, rejects reopened or newly-coined
   --  remaining edges, and checks package/test/README/suite-registration evidence plus
   ...
   type Closure_Row is record
      ...
      Suite_Registration_Present : Boolean := True;
...
end Editor.Ada_RM_Remediation.Final_Readiness.Frozen_Remaining_Inventory;
