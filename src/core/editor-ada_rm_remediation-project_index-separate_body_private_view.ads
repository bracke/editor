...
package Editor.Ada_RM_Remediation.Project_Index.Separate_Body_Private_View is

   --  Case 1373 remediates a concrete remaining gap extracted by the final
...
end Editor.Ada_RM_Remediation.Project_Index.Separate_Body_Private_View;
