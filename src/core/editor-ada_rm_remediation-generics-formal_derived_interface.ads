...
package Editor.Ada_RM_Remediation.Generics.Formal_Derived_Interface is

   --  Case 1403 remediates a concrete remaining gap extracted by the final
   --  inventory: formal derived types that implement interfaces through
   --  private/full views must preserve canonical generic, tagged/interface,
   --  dispatching, profile, contract/effect, and consumer evidence.
   ...
   type Formal_Derived_Interface_Closure is
     (Closure_Formal_Derived_Interface_Private_View,
      Closure_Formal_Derived_Interface_Actual,
      Closure_Interface_Primitive_Profile,
      Closure_Dispatching_Effect,
      Closure_Unknown);

   type Formal_Derived_Interface_Form is
     (Form_Formal_Derived_Interface_Resolved,
      Form_Runtime_Tag_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Formal_Derived_Parent_Mismatch,
      Form_Illegal_Interface_Primitive_Missing,
      Form_Illegal_Abstract_Primitive_Unimplemented,
      Form_Illegal_Private_View_Leak,
      Form_Illegal_Dispatching_Profile_Mismatch,
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Illegal_Formal_Derived_Parent_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Owner : Implementing_Slice := Matrix.Slice_Generic_Formal_Type_Family;
      ...
      Closure : Formal_Derived_Interface_Closure := Closure_Formal_Derived_Interface_Private_View;
      Form : Formal_Derived_Interface_Form := Form_Formal_Derived_Interface_Resolved;
      ...
      Formal_Derived_Parent_Mismatch : Boolean := False;
      Interface_Primitive_Missing : Boolean := False;
      Abstract_Primitive_Unimplemented : Boolean := False;
      Private_View_Leak : Boolean := False;
      Dispatching_Profile_Mismatch : Boolean := False;
