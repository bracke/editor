...
package Editor.Ada_Legality.Expressions.RM_Coverage_Review_Eligibility_Legality is
   ...
   package Worklist renames Editor.Ada_Legality.Expressions.RM_Coverage_Repair_Worklist_Legality;
...
end Editor.Ada_Legality.Expressions.RM_Coverage_Review_Eligibility_Legality;
