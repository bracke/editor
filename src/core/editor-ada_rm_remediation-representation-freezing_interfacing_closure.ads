...
package Editor.Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure is

   --  Case 1347 is the fifth RM gap burn-down case.  It closes a concrete
...
end Editor.Ada_RM_Remediation.Representation.Freezing_Interfacing_Closure;
