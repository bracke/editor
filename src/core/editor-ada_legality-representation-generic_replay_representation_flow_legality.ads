...
package Editor.Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality is
...
end Editor.Ada_Legality.Representation.Generic_Replay_Representation_Flow_Legality;
