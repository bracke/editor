...
package Editor.Ada_Legality.Expressions.RM_Closure_Closure_Repair_Worklist_Legality is
   ...
   package Diagnostics renames Editor.Ada_Legality.Expressions.RM_Closure_Closure_Diagnostic_Integration;
...
end Editor.Ada_Legality.Expressions.RM_Closure_Closure_Repair_Worklist_Legality;
