...
package Editor.Ada_Legality.Dataflow.Definite_Initialization_Legality is
   ...
   package Init_Obj renames Editor.Ada_Legality.Dataflow.Definite_Initialization_Object_Flow_Legality;
...
end Editor.Ada_Legality.Dataflow.Definite_Initialization_Legality;
