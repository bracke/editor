...
package body Editor.Ada_RM_Remediation.Visibility.Renamed_Primitive_Visibility is
   ...
   begin
      case Status is
         ...
         when Status_Runtime_Tag_Check_Preserved =>
            return Precision.Class_Legal_With_Runtime_Check;
         when Status_Illegal_Renamed_Primitive_Not_Visible
         ...
         when Status_Indeterminate_Private_Primitive_View
   ...
   begin
      ...
      elsif Row.Renaming_Fingerprint /= Row.Expected_Renaming_Fingerprint then
         return Status_Renaming_Fingerprint_Mismatch;
      elsif Row.Visibility_Fingerprint /= Row.Expected_Visibility_Fingerprint then
         return Status_Visibility_Fingerprint_Mismatch;
   ...
   begin
      if Status /= Status_Not_Checked then
         return Status;
      elsif Row.Stale_Renaming_Evidence then
         return Status_Indeterminate_Stale_Renaming_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_Primitive_View;
      elsif Row.Missing_Renaming_Evidence
        or else not Row.Complete_Renaming_Evidence
      then
         return Status_Indeterminate_Missing_Renaming_Evidence;
      elsif Row.Missing_Visibility_Evidence
        or else not Row.Complete_Visibility_Evidence
      then
         return Status_Indeterminate_Missing_Visibility_Evidence;
      elsif Row.Renamed_Primitive_Not_Visible then
         return Status_Illegal_Renamed_Primitive_Not_Visible;
      elsif Row.Homograph_Hides_Renamed_Primitive then
         return Status_Illegal_Homograph_Hides_Renamed_Primitive;
      elsif Row.Private_Primitive_View_Mismatch then
         return Status_Illegal_Private_Primitive_View_Mismatch;
      elsif Row.Renaming_Mode_Profile_Mismatch then
         return Status_Illegal_Renaming_Mode_Profile_Mismatch;
      elsif Row.Use_Clause_Ambiguity then
         return Status_Illegal_Use_Clause_Ambiguity;
      elsif Row.Runtime_Tag_Check_Preserved
        or else Row.Form = Form_Runtime_Tag_Check_Preserved
      then
         return Status_Runtime_Tag_Check_Preserved;
      elsif Row.Warning_Only_Preserved
        or else Row.Form = Form_Warning_Only_Preserved
      then
         return Status_Warning_Only_Preserved;
      elsif Row.Form = Form_Renamed_Primitive_Overload_Resolved then
         return Status_Renamed_Primitive_Overload_Resolved;
      elsif Row.Gap = Remaining_Renamed_Primitive_Visibility_Edge then
         return Status_Renamed_Primitive_Visibility_Resolved;
      else
   ...
   begin
      return Row.Id * 79
        ...
        + Renamed_Primitive_Visibility_Form'Pos (Row.Form) * 13
        + Row.Source_Fingerprint
        + Row.AST_Fingerprint
        + Row.Type_Fingerprint
        + Row.Profile_Fingerprint
        + Row.Renaming_Fingerprint
        + Row.Visibility_Fingerprint
