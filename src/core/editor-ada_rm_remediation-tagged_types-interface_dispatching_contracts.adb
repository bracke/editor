package body Editor.Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts is
...
end Editor.Ada_RM_Remediation.Tagged_Types.Interface_Dispatching_Contracts;
