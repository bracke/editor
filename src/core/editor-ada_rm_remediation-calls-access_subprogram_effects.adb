...
package body Editor.Ada_RM_Remediation.Calls.Access_Subprogram_Effects is
   ...
   begin
      case Status is
         ...
         when Status_Illegal_Access_Subprogram_Mode_Mismatch
         ...
         when Status_Indeterminate_Private_Access_Profile_View
   ...
   begin
      ...
      elsif Row.Access_Subprogram_Fingerprint /= Row.Expected_Access_Subprogram_Fingerprint then
         return Status_Access_Subprogram_Fingerprint_Mismatch;
      elsif Row.Convention_Fingerprint /= Row.Expected_Convention_Fingerprint then
         return Status_Convention_Fingerprint_Mismatch;
   ...
   begin
      if Status /= Status_Not_Checked then
         return Status;
      elsif Row.Stale_Access_Subprogram_Evidence then
         return Status_Indeterminate_Stale_Access_Subprogram_Evidence;
      elsif Row.Missing_Full_View then
         return Status_Indeterminate_Private_Access_Profile_View;
      ...
      elsif Row.Missing_Effect_Evidence
        or else not Row.Complete_Effect_Evidence
      then
         return Status_Indeterminate_Missing_Effect_Evidence;
      elsif Row.Access_Subprogram_Mode_Mismatch then
         return Status_Illegal_Access_Subprogram_Mode_Mismatch;
      elsif Row.Convention_Mismatch then
         return Status_Illegal_Convention_Mismatch;
      elsif Row.Global_Effect_Mismatch then
         return Status_Illegal_Global_Effect_Mismatch;
      elsif Row.Null_Exclusion_Profile_Mismatch then
         return Status_Illegal_Null_Exclusion_Profile_Mismatch;
      elsif Row.Accessibility_Level_Escape then
         return Status_Illegal_Accessibility_Level_Escape;
      elsif Row.Runtime_Accessibility_Check_Preserved
        or else Row.Form = Form_Runtime_Accessibility_Check_Preserved
      then
      ...
      elsif Row.Form = Form_Access_Subprogram_Convention_Resolved then
         return Status_Access_Subprogram_Convention_Resolved;
      elsif Row.Gap = Remaining_Access_Subprogram_Effect_Profile_Edge then
         return Status_Access_Subprogram_Effect_Profile_Resolved;
      else
   ...
   begin
      return Row.Id * 79
        ...
        + Access_Subprogram_Effect_Profile_Form'Pos (Row.Form) * 13
        + Row.Source_Fingerprint
        + Row.AST_Fingerprint
        + Row.Type_Fingerprint
        + Row.Profile_Fingerprint
        + Row.Access_Subprogram_Fingerprint
