...
package body Editor.Ada_Declaration_Parser.Semantic_Phases_Engine_Layers_Projection is
   ...
   is
   begin
      Editor.Ada_Declaration_Parser.Semantic_Phases_Engine_Layers_Projection_Worker.Project_Syntax_Tree_Into_Model
        (Analysis    => Analysis,
         Tree        => Tree,
