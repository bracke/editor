...
package Editor.Ada_RM_Remediation.Expressions.Aggregate_Box_Defaults is

   --  Case 1401 remediates a concrete remaining gap extracted by the final
   --  inventory: aggregate tests, range aggregate alternatives, subtype
   --  predicates, runtime aggregate checks, and semantic consumers must
   --  share one canonical aggregate/box/default result.
   ...
   type Null_Record_Aggregate_Closure is
     (Closure_Null_Record_Aggregate,
      Closure_Box_Default_Component,
      Closure_Discriminant_Default,
      Closure_Runtime_Default_Check,
      Closure_Unknown);

   type Null_Record_Aggregate_Form is
     (Form_Null_Record_Aggregate_Resolved,
      Form_Runtime_Default_Check_Preserved,
      Form_Warning_Only_Preserved,
      Form_Illegal_Null_Aggregate_Not_Allowed,
      Form_Illegal_Box_Default_Missing,
      Form_Illegal_Discriminant_Default_Mismatch,
      Form_Illegal_Limited_Component_Default_Missing,
      Form_Indeterminate_Private_View,
      Form_Indeterminate_Stale_Aggregate_Evidence,
      Form_Unknown);
   ...
   type Remediation_Status is
     (Status_Not_Checked,
      ...
      Status_Runtime_Default_Check_Preserved,
      Status_Warning_Only_Preserved,
      Status_Illegal_Null_Aggregate_Not_Allowed,
   ...
   type Remediation_Row is record
      ...
      Closure : Null_Record_Aggregate_Closure := Closure_Null_Record_Aggregate;
      Form : Null_Record_Aggregate_Form := Form_Null_Record_Aggregate_Resolved;
      ...
      Null_Aggregate_Not_Allowed : Boolean := False;
      Box_Default_Missing : Boolean := False;
      Discriminant_Default_Mismatch : Boolean := False;
      Limited_Component_Default_Missing : Boolean := False;
      Stale_Aggregate_Evidence : Boolean := False;
      Missing_Full_View : Boolean := False;
      Missing_Component_Default_Evidence : Boolean := False;
      Runtime_Default_Check_Preserved : Boolean := False;
      Warning_Only_Preserved : Boolean := False;
      Complete_Aggregate_Evidence : Boolean := True;
      Consumer_Aggregate_State_Agrees : Boolean := True;
      ...
      Default_Fingerprint : Natural := 0;
      Expected_Default_Fingerprint : Natural := 0;
