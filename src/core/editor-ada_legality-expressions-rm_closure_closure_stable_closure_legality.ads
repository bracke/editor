...
package Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Closure_Legality is

   --  Case 1280 stabilized closure for direct RM-completion closure consumers.
   --
   --  This package consumes Case 1279 stabilization-gate rows and turns stable
...
end Editor.Ada_Legality.Expressions.RM_Closure_Closure_Stable_Closure_Legality;
