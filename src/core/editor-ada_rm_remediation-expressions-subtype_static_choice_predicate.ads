...
package Editor.Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate is

   --  Case 1350 is the eighth RM gap burn-down case.  It closes a concrete
...
end Editor.Ada_RM_Remediation.Expressions.Subtype_Static_Choice_Predicate;
