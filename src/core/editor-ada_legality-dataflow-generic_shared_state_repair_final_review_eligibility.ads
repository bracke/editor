...
package Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Review_Eligibility is
   ...
   package Worklist renames Editor.Ada_Legality.Dataflow.Generic_Shared_State_Repair_Final_Worklist;
