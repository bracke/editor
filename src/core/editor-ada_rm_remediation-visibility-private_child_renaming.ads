...
package Editor.Ada_RM_Remediation.Visibility.Private_Child_Renaming is

   --  Case 1371 remediates a concrete remaining gap extracted by the final
   --  inventory: a private-child entity reached through a renaming or alias
   ...
   type Remediated_Gap_Family is
     (Remaining_Private_Child_Renaming_Visibility_Edge,
      Remaining_Renamed_Selected_Name_Consumer_Surface_Edge,
...
end Editor.Ada_RM_Remediation.Visibility.Private_Child_Renaming;
