...
package Editor.Ada_Legality.Representation.Discriminant_Variant_Integration_Legality is
...
end Editor.Ada_Legality.Representation.Discriminant_Variant_Integration_Legality;
