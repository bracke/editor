...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1369 is

   --  Pass1369 remediates a concrete remaining gap extracted by the final
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1369;
