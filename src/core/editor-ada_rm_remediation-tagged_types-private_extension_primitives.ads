...
package Editor.Ada_RM_Remediation.Tagged_Types.Private_Extension_Primitives is

   --  Case 1426 remediates a concrete remaining gap extracted by the frozen
   --  inventory: inherited primitives of private extensions, primitive
   --  hiding and overriding, interface primitive conflicts, dispatching
   --  candidate visibility, runtime dispatching checks, warning
   --  diagnostics, stale primitive-hiding evidence, and semantic consumers
   ...
   type Inherited_Private_Extension_Primitive_Hiding_Closure is
     (Closure_Private_Extension_View,
     Closure_Inherited_Primitive_Set,
     Closure_Primitive_Hiding_Evidence,
     Closure_Dispatching_Consumer,
     Closure_Unknown);

   type Inherited_Private_Extension_Primitive_Hiding_Form is
     (Form_Inherited_Private_Extension_Primitive_Resolved,
     Form_Primitive_Hiding_Resolved,
     Form_Runtime_Dispatching_Check_Preserved,
     Form_Warning_Only_Preserved,
     Form_Illegal_Hidden_Abstract_Primitive_Not_Overridden,
     Form_Illegal_Private_Extension_View_Mismatch,
     Form_Illegal_Inherited_Primitive_Profile_Mismatch,
     Form_Illegal_Interface_Primitive_Hiding_Conflict,
     Form_Illegal_Dispatching_Candidate_Hidden,
     Form_Indeterminate_Private_Extension_Full_View,
     Form_Indeterminate_Missing_Inherited_Primitive_Evidence,
     Form_Indeterminate_Missing_Hiding_Evidence,
     Form_Indeterminate_Stale_Primitive_Hiding_Evidence,
     Form_Unknown);

   type Remediation_Status is
     (Status_Not_Checked,
     Status_Gap_Remediated,
     Status_Inherited_Private_Extension_Primitive_Resolved,
     Status_Primitive_Hiding_Resolved,
     Status_Runtime_Dispatching_Check_Preserved,
     Status_Warning_Only_Preserved,
     Status_Illegal_Hidden_Abstract_Primitive_Not_Overridden,
     Status_Illegal_Private_Extension_View_Mismatch,
     Status_Illegal_Inherited_Primitive_Profile_Mismatch,
     Status_Illegal_Interface_Primitive_Hiding_Conflict,
     Status_Illegal_Dispatching_Candidate_Hidden,
     Status_Indeterminate_Private_Extension_Full_View,
     Status_Indeterminate_Missing_Inherited_Primitive_Evidence,
     Status_Indeterminate_Missing_Hiding_Evidence,
     Status_Indeterminate_Stale_Primitive_Hiding_Evidence,
     ...
     Status_Inherited_Primitive_Fingerprint_Mismatch,
     Status_Hiding_Fingerprint_Mismatch,
   ...
   type Remediation_Row is record
      ...
      Closure : Inherited_Private_Extension_Primitive_Hiding_Closure := Closure_Private_Extension_View;
      Form : Inherited_Private_Extension_Primitive_Hiding_Form := Form_Inherited_Private_Extension_Primitive_Resolved;
      ...
      Complete_Inherited_Primitive_Evidence : Boolean := True;
      Complete_Hiding_Evidence : Boolean := True;
      Consumer_State_Agrees : Boolean := True;
      Missing_Full_View : Boolean := False;
      Missing_Inherited_Primitive_Evidence : Boolean := False;
      Missing_Hiding_Evidence : Boolean := False;
      Stale_Primitive_Hiding_Evidence : Boolean := False;
      Hidden_Abstract_Primitive_Not_Overridden : Boolean := False;
      Private_Extension_View_Mismatch : Boolean := False;
      Inherited_Primitive_Profile_Mismatch : Boolean := False;
      Interface_Primitive_Hiding_Conflict : Boolean := False;
      Dispatching_Candidate_Hidden : Boolean := False;
      Runtime_Dispatching_Check_Preserved : Boolean := False;
      ...
      Inherited_Primitive_Fingerprint : Natural := 0;
      Expected_Inherited_Primitive_Fingerprint : Natural := 0;
      Hiding_Fingerprint : Natural := 0;
      Expected_Hiding_Fingerprint : Natural := 0;
...
end Editor.Ada_RM_Remediation.Tagged_Types.Private_Extension_Primitives;
