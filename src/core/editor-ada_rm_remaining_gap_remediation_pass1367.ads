...
package Editor.Ada_RM_Remaining_Gap_Remediation_Pass1367 is

   --  Pass1367 is the first remaining-gap remediation pass after the final
   --  Pass1366 inventory.  It closes one concrete inventory item instead of
...
end Editor.Ada_RM_Remaining_Gap_Remediation_Pass1367;
