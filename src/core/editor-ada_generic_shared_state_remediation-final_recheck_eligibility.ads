...
package Editor.Ada_Generic_Shared_State_Remediation.Final_Recheck_Eligibility is
   ...
   package Worklist renames Editor.Ada_Generic_Shared_State_Remediation.Final_Worklist;
