...
package Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_Final is

   --  Case 1230 tasking/generic/shared-state final legality.
   --
   ...
   package Tasking_Shared renames Editor.Ada_Legality.Tasking.Repair_Shared_State_Final;
...
end Editor.Ada_Legality.Tasking.Repair_Generic_Shared_State_Final;
