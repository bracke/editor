...
typedef enum Render_Layer {
    ...
    LAYER_BUILD_UI_BACKGROUND = 34,
    LAYER_BUILD_UI_HEADER = 35,
    LAYER_BUILD_UI_ROW = 36,
    LAYER_BUILD_UI_TEXT = 37,
    LAYER_STATUS_BAR_BACKGROUND = 38,
    LAYER_STATUS_BAR_TEXT = 39,
    LAYER_ACTIVE_FIND_PROMPT_BACKGROUND = 40,
    LAYER_ACTIVE_FIND_PROMPT_FIELD = 41,
    LAYER_ACTIVE_FIND_PROMPT_BUTTON = 42,
    LAYER_ACTIVE_FIND_PROMPT_TEXT = 43,
    LAYER_ACTIVE_FIND_PROMPT_CARET = 44,
    LAYER_SEMANTIC_POPUP_BACKGROUND = 45,
    LAYER_SEMANTIC_POPUP_ROW = 46,
    LAYER_SEMANTIC_POPUP_TEXT = 47,
    LAYER_QUICK_OPEN_BACKGROUND = 48,
    LAYER_QUICK_OPEN_FIELD = 49,
    LAYER_QUICK_OPEN_RESULT = 50,
    LAYER_QUICK_OPEN_SELECTED_RESULT = 51,
    LAYER_QUICK_OPEN_TEXT = 52,
    LAYER_QUICK_OPEN_CARET = 53,
    LAYER_PROJECT_SEARCH_BAR_BACKGROUND = 54,
    LAYER_PROJECT_SEARCH_BAR_FIELD = 55,
    LAYER_PROJECT_SEARCH_BAR_BUTTON = 56,
    LAYER_PROJECT_SEARCH_BAR_TEXT = 57,
    LAYER_PROJECT_SEARCH_BAR_CARET = 58,
    LAYER_PENDING_TRANSITION_BACKGROUND = 59,
    LAYER_PENDING_TRANSITION_TEXT = 60,
    LAYER_PENDING_TRANSITION_ACTION = 61,
    LAYER_MESSAGE_BACKGROUND = 62,
    LAYER_MESSAGE_TEXT = 63,
    LAYER_SETTINGS_BACKGROUND = 64,
    LAYER_SETTINGS_TEXT = 65,
    LAYER_PALETTE_BACKGROUND = 66,
    LAYER_PALETTE_SELECTION = 67,
    LAYER_PALETTE_TEXT = 68,
