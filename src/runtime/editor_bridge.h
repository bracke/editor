...
typedef enum Render_Layer {
    ...
    LAYER_QUICK_OPEN_BACKGROUND = 41,
    LAYER_QUICK_OPEN_FIELD = 42,
    LAYER_QUICK_OPEN_RESULT = 43,
    LAYER_QUICK_OPEN_SELECTED_RESULT = 44,
    LAYER_QUICK_OPEN_TEXT = 45,
    LAYER_QUICK_OPEN_CARET = 46,
    LAYER_PROJECT_SEARCH_BAR_BACKGROUND = 47,
    LAYER_PROJECT_SEARCH_BAR_FIELD = 48,
    LAYER_PROJECT_SEARCH_BAR_BUTTON = 49,
    LAYER_PROJECT_SEARCH_BAR_TEXT = 50,
    LAYER_PROJECT_SEARCH_BAR_CARET = 51,
    LAYER_PENDING_TRANSITION_BACKGROUND = 52,
    LAYER_PENDING_TRANSITION_TEXT = 53,
    LAYER_PENDING_TRANSITION_ACTION = 54,
    LAYER_MESSAGE_BACKGROUND = 55,
    LAYER_MESSAGE_TEXT = 56,
    LAYER_PALETTE_BACKGROUND = 57,
    LAYER_PALETTE_SELECTION = 58,
    LAYER_PALETTE_TEXT = 59,
